...
0080: 6D466F726D756C61 44696769746F4175 746F
.enddata
...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmFormulaDigitoAuto
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Fórmula para Cálculo do Dígito Verificador do Talão e do Auto de Infração
		Icon File:
		...
		Contents
			...
			Pushbutton: pbImprimir
				...
				Message Actions
					...
					On SAM_Click
						! If sSaida='I'
						Call SalReportPrint( hWndForm, 'FormulaDigito.qrp',
								'',
						...
						! Call SalSetWindowText( hWndReportView, 'Fórmula do Cálculo do Dígito Verificador' )
						! Call SalReportView( hWndForm, hWndReportView, 'FormulaDigito.qrp',
								'',
								'', nErro )
			Picture: pic2
				Class Child Ref Key: 0
...
.enddata
		...
		Message Actions
			! On SAM_ReportStart
				Call SalReportDlgOptions( SalNumberToWindowHandle( wParam ), 'Impressão', 'Imprimindo', 'Relatório de Cadastro de Autos', 'Relatório de Cadastro de Autos' )
				Return TRUE
			...
			! On SAM_ReportFinish
				...
				Call SalPostMsg( pbSair, SAM_Click, 0,0 )
			! On SAM_Destroy
				If hWndReportView != hWndNULL
					Call SalReportClose( hWndReportView )
					Call SalDestroyWindow( hWndReportView )
