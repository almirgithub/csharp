...
0080: 6D477275706F4D6F 7469766F43616E63 656C616D656E746F 4175746F0D436869
00A0: 6C642057696E646F 77730B7062506573 717569736172
.enddata
...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmGrupoMotivoCancelamentoAuto
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Grupo de Motivo de Cancelamento de Auto de Infração
		Icon File:
		...
		Contents
			Data Field: dfnCodigo
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Código do motivo de cancelamento'
			...
			Data Field: dfsDescricao
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Descrição do motivo de cancelamento'
						Set _sNroCamposIgnorados = 'NENHUM'
						!
...
.enddata
		...
		Message Actions
			On SAM_Create
				...
				!
				Set _sComandoPesquisa = 'exec GrupoMotivoCancelamentoAutoS 
									@GrupoMotivoCancelamentoAuto = :frmGrupoMotivoCancelamentoAuto.dfnCodigo'
				Set _sListaINTOPesquisa = ':frmGrupoMotivoCancelamentoAuto.dfnCodigo,  :frmGrupoMotivoCancelamentoAuto.dfsDescricao'
				!
				Set _bLimpaTelaAposInclusao = FALSE
				Set _sComandoInclusao = 'exec GrupoMotivoCancelamentoAutoI 
							@GrupoMotivoCancelamentoAuto = :frmGrupoMotivoCancelamentoAuto.dfnCodigo,
							@Descricao = :frmGrupoMotivoCancelamentoAuto.dfsDescricao'
				Set _sListaINTOInclusao = ':frmGrupoMotivoCancelamentoAuto.dfnCodigo'
				!
				Set _bLimpaTelaAposAtualizacao = FALSE
				Set _sComandoAtualizacao = 'exec GrupoMotivoCancelamentoAutoA 
								@GrupoMotivoCancelamentoAuto = :frmGrupoMotivoCancelamentoAuto.dfnCodigo,
								@Descricao = :frmGrupoMotivoCancelamentoAuto.dfsDescricao'
				Set _sListaINTOAtualizacao = ''
				!
				Set _bLimpaTelaAposRemocao = TRUE
				Set _sComandoRemocao = 'exec GrupoMotivoCancelamentoAutoE 
								@GrupoMotivoCancelamentoAuto = :frmGrupoMotivoCancelamentoAuto.dfnCodigo'
				Set _sListaINTORemocao = ''
				!
				Call SalSendClassMessage( SAM_Create, wParam, lParam )
				Set _sTextoStatusBar = 'Tela de cadastro de grupos de motivo de cancelamento dos autos'
