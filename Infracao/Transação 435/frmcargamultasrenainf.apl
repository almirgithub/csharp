...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmCargaMultasRENAINF
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Carga de Multas Eletrônicas do RENAINF
		Icon File:
		...
		Description: Tela de Carga de Multas Eletrônicas do RENAINF
		Named Menus
		Menu
		Tool Bar
			Display Settings
				...
				Message Actions
					On SAM_Click
						...
						! If cmbTipoArquivo = STRING_Null
							Call SalMessageBox( "Selecione um tipo de arquivo", "Mensagem", MB_IconExclamation )
							Return FALSE
			...
			Child Table: tblAutos
				...
				Message Actions
					On SAM_Create
						...
						Set _sComandoPesquisa = 'exec dbinfracao..RNFEnvioTransacaoEletrS @TipoArquivo = :frmCargaMultasRENAINF.cmbTipoArquivo'
						! coluna para o retorno
						Set _sIntoPesquisa = ':frmCargaMultasRENAINF.tblAutos.colnOrgaoAutuante,
								:frmCargaMultasRENAINF.tblAutos.colsNumAutoInfracao,
								:frmCargaMultasRENAINF.tblAutos.colnInfracao,
								:frmCargaMultasRENAINF.tblAutos.colnCodigoRENAINF,
								:frmCargaMultasRENAINF.tblAutos.coldDataLimiteDefesa,
								:frmCargaMultasRENAINF.tblAutos.colsSerie,
								:frmCargaMultasRENAINF.tblAutos.colnAuto,
								:frmCargaMultasRENAINF.tblAutos.colsTipoMovimento,:frmCargaMultasRENAINF.tblAutos.colnTransacao,
								:frmCargaMultasRENAINF.tblAutos.colsMensagem,
								:frmCargaMultasRENAINF.tblAutos.colsDescMovimento,
								:frmCargaMultasRENAINF.tblAutos.coldDataMovimento'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
					! On SAM_FetchRowDone
				...
				Actions
					! If sLimparInicio = 'S'
						...
						If Not SqlPrepareAndExecute( hSql, sCreate  )
							Return FALSE
					!
					Call SalTblReset(tblPlacas)
					Set bCancela = FALSE
					Set sValues = ''
					Set sInsertAnt = sInsert
					Set nTamanhoRegistro=336
					Set nRow = 1
					Loop
			...
			Function: fConsultaBin
				...
				Actions
					...
					Loop
						...
						Set strComando = 'Exec dbinfracao..RNFHisMultaI
								@CodConsulta = 902 ,@NumSeqTransacao = :tblPlacas.colNumSeqTransacao,
								@Placa = :tblPlacas.colPlaca,@Registro=:tblPlacas.colsRegistro,
								@Sequencial = :nSeq,@DescAgente=:cmbTipoArquivo,@Registro1 = :tblPlacas.colsRegistro1'
						Set bOk = fMPSPrepareProc(hSql,strComando ,':strErro')
						!
			...
			Function: fGeraArquivo
				...
				Actions
					...
					Loop
						...
						Set nRow = nRow + 1
					Call SalDestroyWindow( frmCargaMultasRENAINF )
