...
0020: 0000000000CE0000 002C000000020000 0003000000FFFFFF FFFFFFFFFFF8FFFF
...
0080: 6D52656C4D756C74 6173496D706C616E 7461646173
.enddata
...
.head 1 +  Form Window: frmRelMultasImplantadas
.head 2 -  Class: cQCK1Form
.head 2 -  Property Template:
.head 2 -  Class DLL Name:
.head 2 -  Title: Relatório de Multas Implantadas
.head 2 -  Icon File:
...
.head 6 -  Set _sConsultaFrmOpcoesCampo = 'exec dbinfracao..OrgaoAutuanteS_desc_Estan @Setor=:frmRelMultasImplantadas.nSetorUsuario'
...
.head 6 -  Set _sConsultaDescrição ='exec OrgaoAutuanteS_desc_sintRest @Cod = :frmRelMultasImplantadas.dfnOrgao, @SetorReduzido=:frmRelMultasImplantadas.nSetorReduzido'
...
.head 6 -  Set _sConsultaFrmOpcoesSQLOuSP = 'SP'
.head 6 -  Set _sConsultaFrmOpcoesCampo = 'exec dbinfracao..AgenteEquipS_desc_Estan @OrgaoAutuante = :frmRelMultasImplantadas.dfnOrgao, @Setor=:frmRelMultasImplantadas.nSetorUsuario'
...
.head 6 -  Set _bNuncaHabilitado = TRUE
.head 6 -  Set _bÉCampoDescrição = TRUE
.head 6 -  Set _sConsultaDescrição = 'exec dbinfracao..AgenteEquipS_desc_sint @Cod = :frmRelMultasImplantadas.dfnAgenteEquip,
                                             @OrgaoAutuante = :frmRelMultasImplantadas.dfnOrgao'
.head 6 -  Set _bÉDependente = TRUE
...
.head 6 -  Set _sConsultaFrmOpcoesSQLOuSP = 'SP'
.head 6 -  Set _sConsultaFrmOpcoesCampo = 'exec dbinfracao..MunicipioS_Descricao'
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
...
.head 6 -  Set _sConsultaDescrição = 'exec MunicipioS_descricao2  @Cod = :frmRelMultasImplantadas.dfnMunicipio'
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
...
.head 4 +  Message Actions
.head 5 +  On SAM_Create
.head 6 -  Set _sTextoStatusBar = 'Infração'
.head 6 -  !
.head 6 -  Set _bVisivel = TRUE
.head 6 -  Set _bPermiteNulos = TRUE
...
.head 6 -  Set _bSempreHabilitado = TRUE
.head 6 -  !
.head 6 -  Set _sNomeCampoCodigo = 'dfnInfracao'
.head 6 -  Set _sNroCamposIgnorados = 'NENHUM'
.head 6 -  !
.head 6 -  Set _sConsultaBD = 'exec dbinfracao..ConsultaInfracaoS @Situacao = "A"'
.head 6 -  !
.head 6 -  ! Set _sRefresh = 'Create'
.head 6 -  !
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  ! On SAM_Click
.head 6 +  ! If NOT SalIsNull(cmbTipoSetor)
.head 7 -  Set cmbTipoSetor = ''
...
.head 4 -  Text Color: Class Default
.head 4 -  Background Color: Class Default
.head 3 -  Background Text: Infração:
.data INHERITPROPS
0000: 0100
.enddata
.data CLASSPROPS
...
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  On SAM_Click
.head 6 -  ! Dados Obrigatórioss
.head 6 +  If SalIsNull( dfnOrgao)
.head 7 -  Call SalMessageBeep( MB_IconExclamation )
.head 7 -  Call SalMessageBox( 'O órgão deverá ser informado', 'Atenção', MB_IconExclamation | MB_Ok )
...
.head 7 -  Call SalSendMsg( hWndReport, SAM_Close, 0,0)
.head 6 -  !
.head 6 -  ! afs 27/02/2020
.head 6 +  ! If SalIsNull( cmbInfracao )
.head 7 -  Call SalMessageBeep( MB_IconExclamation )
.head 7 -  Call SalMessageBox( 'A infração deverá sert informada', 'Atenção', MB_IconExclamation | MB_Ok )
.head 7 -  Call SalSetFocus( cmbInfracao )
.head 7 -  Return FALSE
.head 6 -  Call SalTblReset( tblMultas )
.head 6 -  ! ! --- executa o _sComandoPesquisa da table
.head 6 -  Call SalSendMsg( tblMultas, MSG_PesquisaTabela, lParam, wParam )
.head 6 -  Call SalTblSetContext( tblMultas, 0 )
.head 6 -  !
.head 6 +  If tblMultas.colsInfracao = STRING_Null
.head 7 -  Call SalMessageBox( 'Dados não encontrados para o filtro informado', 'Atenção', MB_Ok | MB_IconInformation )
.head 7 -  Return FALSE
.head 6 -  !
.head 6 -  Set nErro = 0
.head 6 +  If SalIsButtonChecked(rbImpressora)
.head 7 -  ! Set nParamArray[RPT_PrintParamOptions] = RPT_PrintDraft
.head 7 -  ! Set nParamArray[RPT_PrintParamFirstPage] = 1
.head 7 -  ! Set nParamArray[RPT_PrintParamLastPage] = 1
.head 7 -  ! Set nParamArray[RPT_PrintParamCopies] = 1
.head 7 +  If dfsOrdenaInfra = 'S'
.head 8 -  Call SalReportTablePrint( tblMultas,  'MulImpl2.qrp',nParamArray, nErro )
.head 7 +  Else
.head 8 -  Call SalReportTablePrint( tblMultas,  'MulImpl.qrp',nParamArray, nErro )
.head 6 +  Else If SalIsButtonChecked(rbTela)
.head 7 +  If dfsOrdenaInfra = 'S'
.head 8 +  If hWndReport != hWndNULL
.head 9 -  Call SalSendMsg( hWndReport, SAM_Close, 0,0)
.head 8 -  Set hWndReport= SalCreateWindow( frmReportView, hWndForm )
.head 8 -  Call SalSetWindowText( hWndReport,  'Relatório de Notificações de Multa'  )
.head 8 -  Call SalReportTableView( tblMultas, hWndReport, 'MulImpl2.qrp', lParam )
.head 7 +  Else
.head 8 +  If hWndReport != hWndNULL
.head 9 -  Call SalSendMsg( hWndReport, SAM_Close, 0,0)
.head 8 -  Set hWndReport= SalCreateWindow( frmReportView, hWndForm )
.head 8 -  Call SalSetWindowText( hWndReport,  'Relatório de Notificações de Multa'  )
.head 8 -  Call SalReportTableView( tblMultas, hWndReport, 'MulImpl.qrp', lParam )
.head 6 +  ! Else
.head 7 +  If dfArquivo = ''
.head 8 -  Call SalMessageBox( 'O Nome do Arquivo Não Foi Informado', 'Atenção', MB_IconExclamation )
.head 8 -  Return FALSE
.head 7 +  Else 
.head 8 -  Call fMontaArquivo()
.head 6 +  If SalIsButtonChecked(rbArquivo)
.head 7 -  !
.head 7 -  Call GeraArquivoFromGridView( frmRelMultasImplantadas.tblMultas, 11,"MultasImplantadas")
.head 6 -  !
.head 6 -  ! Call SalSendMsg( hWndReport, SAM_Close, 0,0)
...
.head 4 -  Text Color: Class Default
.head 4 -  Background Color: Class Default
.head 3 +  Check Box: cbOrdenaInfra
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class: cQCK1CheckBox
.head 4 -  Property Template:
.head 4 -  Class DLL Name:
.head 4 -  Title: Ordenada por Infração 
.head 4 -  Window Location and Size
.head 5 -  Left: 4.288"
.head 5 -  Top: 1.531"
.head 5 -  Width:  2.1"
...
.head 4 +  Message Actions
.head 5 +  On SAM_Create
.head 6 -  Set _sTextoStatusBar = 'Marque para indicar que o usuário pode liberar requisição de documentos de segurança'
.head 6 -  !
.head 6 -  Set _bVisivel = TRUE
.head 6 -  Set _bNuncaHabilitado = FALSE
.head 6 -  Set _bSempreHabilitado = TRUE
...
.head 6 -  Set _sNomeCampoFonte = 'dfsOrdenaInfra'
.head 6 -  !
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 +  Data Field: dfsOrdenaInfra
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class: cQCK1DataField
.head 4 -  Property Template:
...
.head 5 -  Maximum Rows in Memory: 80000
.head 5 -  Discardable? No
.head 4 +  Contents
.head 5 +  Column: coldDataImplantacao
.head 6 -  Class Child Ref Key: 0
.head 6 -  Class ChildKey: 0
.head 6 -  Class: cQCK1Column
.head 6 -  Property Template:
.head 6 -  Class DLL Name:
.head 6 -  Title: Data Implantação
...
.head 8 -  Set _sTipoMsgNulo = 'PADRAO'
.head 8 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  Column: colnValorEmUfir
.head 6 -  Class Child Ref Key: 0
.head 6 -  Class ChildKey: 0
.head 6 -  Class: cQCK1Column
.head 6 -  Property Template:
.head 6 -  Class DLL Name:
.head 6 -  Title: Valr em Ufir
.head 6 -  Visible? Class Default
.head 6 -  Editable? Class Default
.head 6 -  Maximum Data Length: Class Default
...
.head 8 -  Set _sTipoMsgNulo = 'PADRAO'
.head 8 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  Column: colnValorDaUfir
.head 6 -  Class Child Ref Key: 0
.head 6 -  Class ChildKey: 0
.head 6 -  Class: cQCK1Column
.head 6 -  Property Template:
.head 6 -  Class DLL Name:
.head 6 -  Title: Valr Ufir
.head 6 -  Visible? Class Default
.head 6 -  Editable? Class Default
.head 6 -  Maximum Data Length: Class Default
.head 6 -  Data Type: Number
...
.head 8 -  Set _sTipoMsgNulo = 'PADRAO'
.head 8 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  Column: colnValorEmReal
.head 6 -  Class Child Ref Key: 0
.head 6 -  Class ChildKey: 0
.head 6 -  Class: cQCK1Column
.head 6 -  Property Template:
.head 6 -  Class DLL Name:
.head 6 -  Title: Valor em Real
.head 6 -  Visible? Class Default
.head 6 -  Editable? Class Default
.head 6 -  Maximum Data Length: Class Default
.head 6 -  Data Type: Number
...
.head 8 -  Set _sTipoMsgNulo = 'PADRAO'
.head 8 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  Column: colnValorComDesconto
.head 6 -  Class Child Ref Key: 0
.head 6 -  Class ChildKey: 0
.head 6 -  Class: cQCK1Column
.head 6 -  Property Template:
.head 6 -  Class DLL Name:
.head 6 -  Title: Valor com Desconto
.head 6 -  Visible? Class Default
.head 6 -  Editable? Class Default
.head 6 -  Maximum Data Length: Class Default
.head 6 -  Data Type: Number
...
.head 8 -  Set _sTipoMsgNulo = 'PADRAO'
.head 8 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  Column: colsAssunto
.head 6 -  Class Child Ref Key: 0
.head 6 -  Class ChildKey: 0
.head 6 -  Class: cQCK1Column
.head 6 -  Property Template:
.head 6 -  Class DLL Name:
.head 6 -  Title: Assunto
.head 6 -  Visible? Class Default
.head 6 -  Editable? Class Default
.head 6 -  Maximum Data Length: Class Default
.head 6 -  Data Type: String
...
.head 8 -  Set _sTipoMsgNulo = 'PADRAO'
.head 8 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  Column: colsDecisao
.head 6 -  Class Child Ref Key: 0
.head 6 -  Class ChildKey: 0
.head 6 -  Class: cQCK1Column
.head 6 -  Property Template:
.head 6 -  Class DLL Name:
.head 6 -  Title: Decisão
.head 6 -  Visible? Class Default
.head 6 -  Editable? Class Default
.head 6 -  Maximum Data Length: Class Default
.head 6 -  Data Type: String
...
.head 6 -  Set _bSempreHabilitado = TRUE
.head 6 -  ! Procedure's
.head 6 -  Set _sComandoPesquisa = 'exec dbinfracao..RelMultasImplantadas
	@OrgaoAutuante = :frmRelMultasImplantadas.dfnOrgao,
	@DataI = :frmRelMultasImplantadas.dfdInicial,  
	@DataF = :frmRelMultasImplantadas.dfdFinal,
	@Saida="",
	@AgenteEquip=:frmRelMultasImplantadas.dfnAgenteEquip,
	@Competencia = :frmRelMultasImplantadas.cmbCompetencia,
	@Municipio = :frmRelMultasImplantadas.dfnMunicipio,
	@Infracao = :frmRelMultasImplantadas.dfnInfracao'

.head 6 -  Set _sIntoPesquisa = '
	:frmRelMultasImplantadas.tblMultas.coldDataImplantacao,
	:frmRelMultasImplantadas.tblMultas.colsSerie,
	:frmRelMultasImplantadas.tblMultas.colsAuto, 
	:frmRelMultasImplantadas.tblMultas.colsInfracao,
	:frmRelMultasImplantadas.tblMultas.colnValorEmUfir,
	:frmRelMultasImplantadas.tblMultas.colnValorDaUfir ,	,
	:frmRelMultasImplantadas.tblMultas.colnValorEmReal, 
	:frmRelMultasImplantadas.tblMultas.colnValorComDesconto,
	:frmRelMultasImplantadas.tblMultas.colnProtocolo,
	:frmRelMultasImplantadas..tblMultas.colsAssunto,
	:frmRelMultasImplantadas..tblMultas.colsDecisao'
...
.head 7 -  ! Call SalReportSetStringVar( hWndReport, 'TipoArquivoSel','')
.head 7 -  ! Call SalReportSetDateTimeVar( hWndReport, 'CriacaoI', dCorrente )
.head 7 -  ! Call SalReportSetDateTimeVar( hWndReport, 'CriacaoF', dCorrente )
.head 7 -  ! Call SalReportSetStringVar( hWndReport, 'TipoArquivo','')
.head 7 -  Call SalReportSetStringVar( hWndReport, 'OrgaoAutuante',dfsOrgao)
.head 7 -  ! Call SalReportSetDateTimeVar( hWndReport, 'PeriodoIni', dPeriodoIni )
.head 7 -  ! Call SalReportSetDateTimeVar( hWndReport, 'PeriodoFin', dPeriodoFin )
.head 7 -  ! Call SalReportSetNumberVar( hWndReport, 'NumRegistro',0)
...
.head 7 -  Call SalReportSetDateTimeVar( hWndReport, 'DataI', dfdInicial )
.head 7 -  Call SalReportSetDateTimeVar( hWndReport, 'DataF', dfdFinal )
.head 7 -  Call SalReportSetStringVar( hWndReport, 'AgenteEquip', dfsAgenteEquip )
.head 7 -  Call SalReportSetStringVar( hWndReport, 'Competencia', cmbCompetencia )
.head 7 -  Call SalReportSetStringVar( hWndReport, 'Municipio', dfsMunicipio )
.head 7 -  !
.head 2 +  Functions
...
.head 5 -  Call fMPSPrepareProc( hSql, 'exec dbinfracao..RelMultasImplantadas @OrgaoAutuante = :frmRelMultasImplantadas.dfnOrgao,
@DataI = :frmRelMultasImplantadas.dfdInicial,  @AgenteEquip=:frmRelMultasImplantadas.dfnAgenteEquip,@DataF = :frmRelMultasImplantadas.dfdFinal,
@Saida="A",@Competencia = :frmRelMultasImplantadas.cmbCompetencia,@Municipio = :frmRelMultasImplantadas.dfnMunicipio',
':sTexto')
...
.head 6 -  Call SalReportView( frmRelMultasImplantadas, hWndReport, 'Mulimp.qrp',
...
.head 5 -  Call SalSendMsgToChildren( frmRelMultasImplantadas, MSG_Limpa,wParam,lParam )
.head 5 -  Return TRUE
...
.head 3 -  Window Handle: hWndReportImp
.head 3 -  Number: nSetorReduzido
.head 3 -  Number: nSetorUsuario
.head 3 -  String: sSetorUsuarioN
.head 3 -  Number: nProtocolo
.head 3 -  String: sAssunto
.head 3 -  String: sDecisao
.head 3 -  Number: nParamArray[*]
.head 3 -  Window Handle: hWndReportMultas
...
.head 4 +  If hWndReportMultas != hWndNULL
.head 5 -  Call SalSendMsg( hWndReportMultas, SAM_Close, 0,0)
...
.head 4 -  Call SqlImmediate( 'select getdate() into :frmRelMultasImplantadas.dCorrente' )
.head 4 -  Call SalSendClassMessage( SAM_CreateComplete, wParam, lParam )
.head 3 +  On UDM_AposPesquisa
.head 4 -  Call SqlGetResultSetCount( hWndReport, nErro )
.head 3 +  ! On SAM_ReportStart
.head 4 -  Call SalReportDlgOptions( SalNumberToWindowHandle( wParam ), 'Impressão', 'Imprimindo',
'Relatório de Multas Implantadas', 'Relatório de Multas Implantadas' )
.head 4 -  Return TRUE
.head 3 +  ! On SAM_ReportFetchInit
.head 4 -  Call SqlImmediate( 'select getdate() into :frmRelMultasImplantadas.dCorrente' )
.head 4 -  Call fMPSPrepareProc( hSql, 'exec dbinfracao..RelMultasImplantadas 
	@OrgaoAutuante = :frmRelMultasImplantadas.dfnOrgao,
	@DataI = :frmRelMultasImplantadas.dfdInicial,  
	@DataF = :frmRelMultasImplantadas.dfdFinal,
	@Saida="",
	...
	@Competencia = :frmRelMultasImplantadas.cmbCompetencia,
	@Municipio = :frmRelMultasImplantadas.dfnMunicipio',
':frmRelMultasImplantadas.dDataImplantacao, 
:frmRelMultasImplantadas.sSerie,
:frmRelMultasImplantadas.sAuto, 
:frmRelMultasImplantadas.sInfracao,
:frmRelMultasImplantadas.nValorEmUFIR,
:frmRelMultasImplantadas.nValorDaUFIR ,
:frmRelMultasImplantadas.nValorEmReal,
:frmRelMultasImplantadas.nValorComDesconto,
:frmRelMultasImplantadas.nProtocolo,
:frmRelMultasImplantadas.sAssunto,
:frmRelMultasImplantadas.sDecisao')
.head 4 +  If NOT SqlExecute( hSql )
.head 5 -  Return FALSE
.head 4 +  ! If frmRelMultasImplantadas.sSerie 	= STRING_Null AND 
   frmRelMultasImplantadas.sAuto 	= STRING_Null AND
   frmRelMultasImplantadas.sInfracao	= STRING_Null
.head 5 -  Call SalMessageBox( 'Sem dados para o filtro informado', 'Atenção', MB_Ok | MB_IconInformation )
.head 5 -  Return FALSE
