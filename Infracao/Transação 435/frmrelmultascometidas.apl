...
0080: 6D52656C4D756C74 6173436F6D657469 646173
.enddata
...
.head 1 +  Form Window: frmRelMultasCometidas
.head 2 -  Class: cQCK1Form
.head 2 -  Property Template:
.head 2 -  Class DLL Name:
.head 2 -  Title: Relatório de Multas Por Data de Cometimento
.head 2 -  Icon File:
...
.head 6 -  Set _sConsultaFrmOpcoesCampo = 'exec dbinfracao..OrgaoAutuanteS_desc_Estan @Setor=:frmRelMultasCometidas.nSetorUsuario'
...
.head 6 -  Set _sConsultaFrmOpcoesSQLOuSP = 'SP'
.head 6 -  Set _sConsultaFrmOpcoesCampo = 'exec dbinfracao..AgenteEquipS_desc_Estan @OrgaoAutuante = :frmRelMultasCometidas.dfnOrgao, @Setor=:frmRelMultasCometidas.nSetorUsuario'
...
.head 3 -  Background Text: Período de Cometimento:
.head 4 -  Resource Id: 26772
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class:
.head 4 -  Window Location and Size
...
.head 7 -  Call SalMessageBox( 'O agente autuador deverá ser informado', 'Atenção', MB_IconExclamation | MB_Ok )
.head 7 -  Call SalSetFocus( dfnOrgao)
.head 7 -  Return FALSE
.head 6 -  !
.head 6 +  If SalIsNull( dfnAgenteEquip)
.head 7 -  Call SalMessageBeep( MB_IconExclamation )
.head 7 -  Call SalMessageBox( 'O agente equipamento deverá ser informado', 'Atenção', MB_IconExclamation | MB_Ok )
.head 7 -  Call SalSetFocus( dfnAgenteEquip)
.head 7 -  Return FALSE
.head 6 -  !
...
.head 7 -  Return FALSE
.head 6 -  !
.head 6 -  Set sArquivoQRP = 'MulCome.qrp'
.head 6 -  !
.head 6 -  Call SalTblReset( tblMultasCometidas )
.head 6 -  ! ! ! ! --- executa o _sComandoPesquisa da table
.head 6 -  Call SalSendMsg( tblMultasCometidas, MSG_PesquisaTabela, lParam, wParam )
.head 6 +  If NOT SalTblAnyRows( tblMultasCometidas, 0, 0 )
...
.head 7 +  If NOT ValidaQrpLocal( sArquivoQRP )
.head 8 -  Call SalMessageBox ( 'Prezado usuário, o arquivo '||sArquivoQRP||' não foi localizado, favor entrar em contato com o suporte técnico.', 'Atenção', MB_IconExclamation | MB_Ok )
.head 8 -  Return FALSE
.head 7 +  Else
.head 8 -  Call SalReportTablePrint( tblMultasCometidas,  sArquivoQRP,nParamArray, nErro )
...
.head 8 -  Call SalReportTableView( tblMultasCometidas, hWndReport, sArquivoQRP, lParam )
.head 6 +  Else
.head 7 -  Call GeraArquivoFromGridView( frmRelMultasCometidas.tblMultasCometidas, 12, "RelMultasCometidas")
...
.head 6 -  Set _sConsultaDescrição = 'exec dbinfracao..AgenteEquipS_desc_sint @Cod = :frmRelMultasCometidas.dfnAgenteEquip,
                                             @OrgaoAutuante = :frmRelMultasCometidas.dfnOrgao'
...
.head 6 -  Set _bNuncaHabilitado = TRUE
.head 6 -  Set _bÉCampoDescrição = TRUE
.head 6 -  Set _sConsultaDescrição ='exec OrgaoAutuanteS_desc_sintRest @Cod = :frmRelMultasCometidas.dfnOrgao, @SetorReduzido=:frmRelMultasCometidas.nSetorReduzido'
.head 6 -  Set _bÉDependente = TRUE
...
.head 6 -  Set _bSempreHabilitado = FALSE
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 +  ! cQCK1DataField: dfArquivo
.winattr class Data Field:
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class: cQCK1DataField
...
.head 5 -  ! On PAM_SetaFoco
.head 3 +  Child Table: tblMultasCometidas
.data INHERITPROPS
0000: 0100
.enddata
.data CLASSPROPS
...
.head 8 -  Set _sTipoMsgNulo = 'PADRAO'
.head 8 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  Column: coldDataInicial
.head 6 -  Class Child Ref Key: 0
.head 6 -  Class ChildKey: 0
.head 6 -  Class: cQCK1Column
.head 6 -  Property Template:
.head 6 -  Class DLL Name:
.head 6 -  Title: Data Inicial
.head 6 -  Visible? Class Default
.head 6 -  Editable? Class Default
...
.head 8 -  Set _sTipoMsgNulo = 'PADRAO'
.head 8 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  Column: coldDataFinal
.head 6 -  Class Child Ref Key: 0
.head 6 -  Class ChildKey: 0
.head 6 -  Class: cQCK1Column
.head 6 -  Property Template:
.head 6 -  Class DLL Name:
.head 6 -  Title: Data Final
.head 6 -  Visible? Class Default
.head 6 -  Editable? Class Default
.head 6 -  Maximum Data Length: Class Default
.head 6 -  Data Type: Date/Time
...
.head 8 -  Set _sTipoMsgNulo = 'PADRAO'
.head 8 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  Column: colnValorComDesc
.head 6 -  Class Child Ref Key: 0
.head 6 -  Class ChildKey: 0
.head 6 -  Class: cQCK1Column
.head 6 -  Property Template:
.head 6 -  Class DLL Name:
.head 6 -  Title: Vl. C/Desconto
.head 6 -  Visible? Class Default
.head 6 -  Editable? Class Default
.head 6 -  Maximum Data Length: Class Default
.head 6 -  Data Type: Number
...
.head 6 -  Set _bSempreHabilitado = TRUE
.head 6 -  ! Procedure'
.head 6 -  Set _sComandoPesquisa = 'exec dbinfracao..RelMultasCometidas
		 	@OrgaoAutuante	= :frmRelMultasCometidas.dfnOrgao,
			@DataI		= :frmRelMultasCometidas.dfdInicial,  
			@DataF 		= :frmRelMultasCometidas.dfdFinal,
			@Saida		= "",
			@AgenteEquip	= :frmRelMultasCometidas.dfnAgenteEquip'

.head 6 -  Set _sIntoPesquisa = '
	:frmRelMultasCometidas.tblMultasCometidas.coldDataImplantacao, 
	:frmRelMultasCometidas.tblMultasCometidas.colsSerie,
	:frmRelMultasCometidas.tblMultasCometidas.colsAuto, 
	:frmRelMultasCometidas.tblMultasCometidas.colsInfracao,
	:frmRelMultasCometidas.tblMultasCometidas.colnValorEmUFIR,
	:frmRelMultasCometidas.tblMultasCometidas.colnDaUFIR ,
	:frmRelMultasCometidas.tblMultasCometidas.colnValorEmReal,
	:frmRelMultasCometidas.tblMultasCometidas.colnValorComDesc'
	
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  On SAM_FetchRowDone
.head 6 -  Set frmRelMultasCometidas.tblMultasCometidas.colsOrgaoAutuante = frmRelMultasCometidas.dfsOrgao
.head 6 -  Set frmRelMultasCometidas.tblMultasCometidas.colsAgentEquip = frmRelMultasCometidas.dfsAgenteEquip
.head 6 -  Set frmRelMultasCometidas.tblMultasCometidas.coldDataInicial = frmRelMultasCometidas.dfdInicial
.head 6 -  Set frmRelMultasCometidas.tblMultasCometidas.coldDataFinal = frmRelMultasCometidas.dfdFinal
.head 6 -  !
...
.head 5 -  Call fMPSPrepareProc( hSql, 'exec RelMultasCometidas @OrgaoAutuante = :frmRelMultasCometidas.dfnOrgao,
@DataI = :frmRelMultasCometidas.dfdInicial,  @DataF = :frmRelMultasCometidas.dfdFinal,@Saida="A"',
':sTexto')
...
.head 6 -  Call SalReportView( frmRelMultasCometidas, hWndReport, 'Mulimp.qrp',
...
.head 5 -  Call SalSendMsgToChildren( frmRelMultasCometidas, MSG_Limpa,wParam,lParam )
.head 5 -  Return TRUE
...
.head 4 -  Call SqlImmediate( 'select getdate() into :frmRelMultasCometidas.dCorrente' )
...
'Relatório de Multas Implantadas e Não Pagas', 'Relatório de Multas Implantadas e Não Pagas' )
.head 4 -  Return TRUE
.head 3 +  ! On SAM_ReportFetchInit
.head 4 -  Call SqlImmediate( 'select getdate() into :frmRelMultasCometidas.dCorrente' )
.head 4 -  Call fMPSPrepareProc( hSql, 'exec dbinfracao..RelMultasCometidas @OrgaoAutuante = :frmRelMultasCometidas.dfnOrgao,
@DataI = :frmRelMultasCometidas.dfdInicial,  @DataF = :frmRelMultasCometidas.dfdFinal,@Saida="",@AgenteEquip=:frmRelMultasCometidas.dfnAgenteEquip',
':frmRelMultasCometidas.dDataImplantacao, :frmRelMultasCometidas.sSerie,
:frmRelMultasCometidas.sAuto, :frmRelMultasCometidas.sInfracao,:frmRelMultasCometidas.nValorEmUFIR,
:frmRelMultasCometidas.nValorDaUFIR ,:frmRelMultasCometidas.nValorEmReal,
:frmRelMultasCometidas.nValorComDesconto')
