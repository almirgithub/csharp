...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmLeituraArquivoDePlacas
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Leitura do Arquivo de Placas
		Icon File:
		...
		Description: Tela de Cadastro de Csv via arquivo. ( Programador: Gerson Barreto Neto
						                             Data: 16.03.2004)
		Named Menus
		Menu
		Tool Bar
...
.enddata
					...
					On SAM_Click
						...
						Loop
							...
							Call fGravaRegistrosNoBanco()
								! Call SalMessageBox( "Arquivo gerado com sucesso", "Mensagem", MB_IconExclamation )
								! Call SalSendMsgToChildren( hWndForm, PAM_Limpa, wParam, lParam )
							Set bok =  SalFileClose( hFile)
							Set bok =  SalFileClose( hFile2)
			...
			Combo Box: cmbOrgaoAutuante
				...
				Message Actions
					On PAM_PreencherComboBox
						Call PreencheLista(cmbOrgaoAutuante,"exec dbinfracao..OrgaoAutuantePaiS_desc" )
					On SAM_Click
			...
			Combo Box: cmbTipoArquivo
				...
				Message Actions
					On PAM_PreencherComboBox
						Call PreencheLista(cmbTipoArquivo,"exec dbinfracao..TipoArquivoS @OrgaoAutuante= 'DETRAN - PE                             '" )
					On SAM_Click
						Call SalSendMsgToChildren( hWndForm, PAM_Habilita,DISABLE, lParam )
					On PAM_Limpa
						Set cmbTipoArquivo = ''
			...
			Function: fGravaRegistrosNoBanco
				...
				Actions
					...
					Loop
						...
						Set sPlaca = SalStrMidX( strTexto, 0,7 )
						! Set sUFPlaca = SalStrMidX(strTexto,7,2)
				...
				Actions
					...
					Loop
						If SalTblFetchRow( tblPlacas, nRow ) = TBL_NoMoreRows
							Break
						! Set bVeiculoBin = BINConsultaVeiculo( tblPlacas.colPlaca , STRING_Null, NUMBER_Null, STRING_Null, STRING_Null,
					...
					Loop
						...
						Set strComando = 'Exec dbinfracao..RNFGeraArquivoRetornoPlacas
								@CodConsulta = 902 ,@NumSeqTransacao = :tblPlacas.colNumSeqTransacao,
								@Placa = :tblPlacas.colPlaca'
						If rbRadar
							Set strComando = 'Exec dbinfracao..RNFGeraArquivoRetornoPlacas
									@CodConsulta = 902 ,@NumSeqTransacao = :tblPlacas.colNumSeqTransacao,
									@Placa = :tblPlacas.colPlaca, @Radar = "S"'
