...
.enddata
.data CLASSPROPS
0000: 4442475F504C4159 4241434B5F475549 4400100006E1FE64 F2ACCF40ABA3C440
0020: 865E7EDB000000
.enddata
...
.enddata
.data DT_MAKERUNDLG
0000: 0900001000000000 23433A5C41706C69 6344657472616E5C 496D6167656E735C
0020: 4A77617574756163 2E69636F14456E76 696143726C764469 676974616C2E6578
0040: 650C494E46524143 414F2E646C6C0C49 4E46524143414F2E 6170630000010101
0060: 0064000000000000 0000010000000000 00000C494E465241 43414F2E6170640C
0080: 494E46524143414F 2E646C6C0C494E46 524143414F2E6170 6300000101010064
00A0: 0000000C494E4652 4143414F2E61706C 0C494E4652414341 4F2E646C6C0C494E
00C0: 46524143414F2E61 7063000001010100 640000000C494E46 524143414F2E6578
00E0: 650C494E46524143 414F2E646C6C0C49 4E46524143414F2E 6170630000010101
0100: 00640000000C494E 46524143414F2E64 6C6C0C494E465241 43414F2E646C6C0C
0120: 494E46524143414F 2E61706300000101 0100640000000C49 4E46524143414F2E
0140: 646C6C0C494E4652 4143414F2E646C6C 0C494E4652414341 4F2E617063000001
0160: 0101006400000000 0000000000000000 0000000000000000 0000000000000000
0180: 0001000000010000 0001000100000000 0000000001000010 0000000000000000
01A0: 00000000
.enddata
...
.head 2 -  Title: Rôbo - Solicita Emissão Autorização de Documento - Transação 237 RENAVAM
...
.head 2 -  Icon File: Jwautuac.ico
.data RESOURCE 2 0 1 1472441604
0000: 00030000D7010000 0000000000000000 0200A20001000120 3010000000E80200
0020: 0000160000002800 0000002000000040 0008000001040000 00FFFFFF8F800000
0040: 0300808000800068 00008080808100C0 C0C0008084800000 FF00000300FFFF00
0060: FF00680000FFFFFF 4D00FF0000FFFFFF C1BBB0000000FFDD BB000FB0F00000DC
0080: 00BB00070B70BF00 00DC00BB0007B7B0 FBF000DDBB00030B 7B70BFBF00C1BBBB
00A0: 00000023B7B7B0FB F0B5BBB000650B7B 70BFA400BBBB0000 65B7B7B0FB60F0BB
00C0: BBBBB000660B7B70 BF6600BBB000EAB7 B7B000FF0BB000B0 00000B6B7B700F24
00E0: FF0BFF0000B7ADB7 B0F000FFF0B0FFF0 00007B8C7B7B0FBF 0F48CFF0B0FF00B7
0100: F5B7B050FCF000FF F07BE17B0B0FBF5C FFCFF0B763F0FBF0 FC5CFFFCF07BF50F
0120: BFCECFFF00B8B0FB FBFC2EFCF0007B70 000FBF0FCF27FF00 00B7500000FBF0FC
0140: FC37F0007BF9000F 5ACFFF00B0F300FB DAFCF000870F000F FFEF003FFFFCEF00
0160: BF0FF6FF007FFFF6 F0007F0FF8000000 FFFFFFFFFF3FFFFF 0EFFF83FFFF144F8
0180: 3FE0F83FC000783F FF80383FFF000018 1FFE00080FFC0000 0007F8000003F000
01A0: 23E00000C000FA00 8051018000010055 0100010015010003 8400000007860000
01C0: 0F870000001F8F80 003F9FC440007FBF EE00FFFF0001FFFF FF83FFFFFF00C7FF
01E0: FFFFEFFFFFFF3F00 00
.enddata
...
.head 2 -  Named Menus
.head 2 +  Menu
.head 3 +  Popup Menu: &Solic.Autorização Emissão Doc (TRANS.237)
...
.head 4 -  Title: Transmissão das Transações 237 - Solicita Autorização Emissão do CRLVe
.head 4 -  Icon File:
...
.head 7 -  Input Mask: Unformatted
.head 6 -  Message Actions
.head 5 -  Background Text: Arquivo pendente de processoamento do RETORNO:
.head 6 -  Resource Id: 39013
.head 6 -  Class Child Ref Key: 0
.head 6 -  Class ChildKey: 0
.head 6 -  Class: cQCK1BackgroundText
.head 6 -  Window Location and Size
...
.head 6 -  Text Color: Class Default
.head 6 -  Background Color: Class Default
.head 5 +  Data Field: dfsArquivoPendente
.head 6 -  Class Child Ref Key: 0
.head 6 -  Class ChildKey: 0
.head 6 -  Class:
.head 6 -  Property Template:
...
.head 8 -  Call BINEnviaTransacao237(tblAutos.colnVeiculo, tblAutos.colsPlaca, tblAutos.colnTransacao, tblAutos.colnSetor, tblAutos.colnProcesso, tblAutos.colnNumeroDoc)
.head 8 -  Set nRow = nRow + 1
.head 7 -  Call SalTblReset(tblAutos)
.head 7 +  If Not fVerificarGeraArquivoBatch() 
.head 8 -  Set tblAutos.nPermissao = 1
.head 8 -  Call SalSendMsg( tblAutos, MSG_PesquisaTabela, 0 ,0)
.head 7 +  Else
.head 8 -  Call fGeraArquivoBatch()
.head 7 -  Set nRow = 0
.head 7 -  ! If SalTblSetContext( tblAutos, nRow ) = TRUE
.head 7 -  Return SalSendMsg( pbArquivar, SAM_Click, 0 ,0)
.head 7 +  ! Else
.head 8 -  Call GeraArquivo() 
.head 7 -  ! Return TRUE
...
.head 8 -  Return TRUE
.head 5 +  Function: fVerificarGeraArquivoBatch
.head 6 -  Description:
.head 6 -  Returns
.head 6 -  Parameters
.head 6 -  Static Variables
...
.head 7 +  If NOT fMPSConnect( hSqlSisCsv )
.head 8 -  Return FALSE
.head 7 +  If NOT fMPSPrepareProc( hSqlSisCsv, 'exec EnviaCrlvDigitalS @Verifica = "S"' ,':sRetorno, :frmEnvia237.dfsArquivoPendente' )
.head 8 -  Call fMPSDisconnect( hSqlSisCsv )
.head 8 -  Return FALSE
.head 7 +  If NOT SqlExecute( hSqlSisCsv )
.head 8 -  Call fMPSDisconnect( hSqlSisCsv )
...
.head 8 -  Return FALSE
.head 7 -  Call fMPSDisconnect( hSqlSisCsv )
.head 7 +  If sRetorno = 'N'
.head 8 -  Return FALSE
.head 7 -  Return TRUE
.head 5 +  Function: fGeraArquivoBatch
.head 6 -  Description: Gera os dados que irão fazer parte do arquivo texto
.head 6 -  Returns
.head 6 -  Parameters
.head 6 -  Static Variables
.head 6 +  Local variables
.head 7 -  Sql Handle: hSqlArquivo
.head 7 -  Long String: sArquivo
.head 7 -  Long String: sRegistro
.head 7 -  Long String: sHeader
.head 7 -  Long String: sTrailler
.head 7 -  String: sCaminhoComArquivo
.head 7 -  File Handle: fArquivo
.head 7 -  String: sNomArq
.head 7 -  Number: nArquivopen
.head 7 -  String: sNomeArq
.head 7 -  Number: nTotalReg
.head 7 -  Number: Total
.head 7 -  String: totalLido
.head 7 -  String: sEspacos100
.head 7 -  String: sEspacos84
.head 7 -  String: sEspacos69
.head 6 +  Actions
.head 7 -  Call SalWaitCursor( TRUE )
.head 7 -  !
.head 7 +  If fMPSConnect( hSqlArquivo )
.head 8 -  Call fMPSPrepareProc( hSqlArquivo, ' exec dbvcen..EnviaCrlvDigitalS
		@RetCrlvDigitalBatch	=	"S" ,
		@Verifica			 = 	"N"',
		':sArquivo,
		:sRegistro')
.head 8 +  If SqlExecute( hSqlArquivo )
.head 9 -  !
.head 9 +  If SqlFetchNext(hSqlArquivo, lParam) = FALSE
.head 10 -  Call fMPSDisconnect( hSqlArquivo )
.head 10 -  Return FALSE
.head 9 +  If SalFileOpen( fArquivo,  sArquivo, OF_Create|OF_ReadWrite) = FALSE
.head 10 -  Call SalMessageBox( 'Não foi possivel gerar o arquivo' || sArquivo || ' ! Verifique se a pasta C:\CrlvDigitalBatch existe' ,'Aviso', MB_Ok | MB_IconHand)
.head 10 -  Call fMPSPrepareProc( hSqlArquivo, ' exec dbvcen..EnviaCrlvDigitalS
		@RetCrlvDigitalBatch	=	"D" ,
		@Verifica			 = 	"N", 
		@Arquivo			= :sArquivo','')
.head 10 -  Call SqlExecute( hSqlArquivo )
.head 10 -  Call fMPSDisconnect( hSqlArquivo )
.head 10 -  Return FALSE
.head 9 -  Set nArquivopen  = 0
.head 9 -  Call SalFilePutStr( fArquivo, sRegistro)
.head 9 +  While SqlFetchNext(hSqlArquivo, lParam)
.head 10 -  Call SalFilePutStr( fArquivo, sRegistro)
.head 9 -  Call fMPSDisconnect( hSqlArquivo )
.head 9 -  !
.head 9 -  Call SalFileClose( fArquivo )
.head 9 -  Call SalMessageBox( 'Transmitir URGENTE o arquivo ' || sArquivo || ' para o SERPRO e Processar o arquivo de retorno','Aviso', MB_Ok | MB_IconHand)
...
.head 4 -  Set _sLoginSistema = 'Controle de Veículo'
