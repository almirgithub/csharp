...
0020: 0000000000E00000 002C000000020000 0003000000FFFFFF FFFFFFFFFFF8FFFF
...
0080: 6D436F6E73417574 6F734E616F4E6F74 6966696361646F73
.enddata
...
.head 1 +  Form Window: frmConsAutosNaoNotificados
.head 2 -  Class: cQCK1Form
.head 2 -  Property Template:
.head 2 -  Class DLL Name:
.head 2 -  Title: Consulta de Autos não Notificados
.head 2 -  Icon File:
...
.head 4 -  Border Color: Default
.head 4 -  Background Color: 3D Face Color
.head 3 -  Background Text: OS AUTOS APRESENTADOS NESSA TELA ESTÃO COM PROBLEMA NA NOTIFICAÇÃO DE AUTUAÇÃO E PRECISÃO SER RESOLVIDOS, SE NECESSÁRIO ENTRE EM CONTATO COM O DEPTO DE INFORMÁTICA DO DETRAN
.head 4 -  Resource Id: 64920
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class:
.head 4 -  Window Location and Size
...
.head 6 -  Set _sConsultaFrmOpcoesCampo = 'exec dbinfracao..OrgaoAutuanteS_desc_Estan @Setor=:frmConsAutosNaoNotificados.nSetorUsuario'
...
@Cod = :frmConsAutosNaoNotificados.dfnOrgao, @Setor=:frmConsAutosNaoNotificados.nSetorUsuario'
...
.head 5 +  On SAM_Create
.head 6 -  Set _bVisivel = TRUE
.head 6 -  Set _sTextoStatusBar = 'Data incial do período'
...
.head 5 +  On SAM_Create
.head 6 -  Set _bVisivel = TRUE
.head 6 -  Set _sTextoStatusBar = 'Data final do período'
.head 6 -  Set _bSempreHabilitado = TRUE
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  On SAM_Validate
...
.head 6 -  Call SalSendClassMessage( SAM_Validate, wParam, lParam )
.head 3 -  !
.head 3 +  Child Table: tblAutosNaoNotificados
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
...
.head 4 +  Contents
.head 5 +  Column: colDataImplantacao
.head 6 -  Class Child Ref Key: 0
.head 6 -  Class ChildKey: 0
.head 6 -  Class: cQCK2Column
.head 6 -  Property Template:
.head 6 -  Class DLL Name:
.head 6 -  Title: Implantação
.head 6 -  Visible? Yes
...
.head 8 -  Set _sTipoMsgNulo = 'PADRAO'
.head 8 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  Column: colCodigoRENAINF
.head 6 -  Class Child Ref Key: 0
.head 6 -  Class ChildKey: 0
.head 6 -  Class: cQCK2Column
.head 6 -  Property Template:
.head 6 -  Class DLL Name:
.head 6 -  Title: Cód. RENAINF
.head 6 -  Visible? Yes
.head 6 -  Editable? Class Default
.head 6 -  Maximum Data Length: Class Default
.head 6 -  Data Type: String
...
.head 8 -  Set _sTipoMsgNulo = 'PADRAO'
.head 8 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  Column: colLocalCometimento
.head 6 -  Class Child Ref Key: 0
.head 6 -  Class ChildKey: 0
.head 6 -  Class: cQCK2Column
.head 6 -  Property Template:
.head 6 -  Class DLL Name:
.head 6 -  Title: Retorno RENAINF
.head 6 -  Visible? Yes
.head 6 -  Editable? Class Default
.head 6 -  Maximum Data Length: Class Default
...
.head 8 -  Set _sTipoMsgNulo = 'PADRAO'
.head 8 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  Column: colRetornoImg
.head 6 -  Class Child Ref Key: 0
.head 6 -  Class ChildKey: 0
.head 6 -  Class: cQCK2Column
.head 6 -  Property Template:
.head 6 -  Class DLL Name:
.head 6 -  Title: Retorno IMG
.head 6 -  Visible? Yes
.head 6 -  Editable? Class Default
.head 6 -  Maximum Data Length: Class Default
.head 6 -  Data Type: String
...
.head 8 -  Set _sTipoMsgNulo = 'PADRAO'
.head 8 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  Column: colDataRetornoImg
.head 6 -  Class Child Ref Key: 0
.head 6 -  Class ChildKey: 0
.head 6 -  Class: cQCK2Column
.head 6 -  Property Template:
.head 6 -  Class DLL Name:
.head 6 -  Title: Data IMG
.head 6 -  Visible? Yes
.head 6 -  Editable? Class Default
.head 6 -  Maximum Data Length: Class Default
...
.head 4 +  Message Actions
.head 5 +  On SAM_Create
.head 6 -  Set _sTextoStatusBar = 'Tabela de Autos não notificados'
.head 6 -  Set _sComandoPesquisa = 'exec dbinfracao..AutosNaoNotificadosS 
@OrgaoAutuante = :frmConsAutosNaoNotificados.dfnOrgao,
@DataIni 	= :frmConsAutosNaoNotificados.dfdInicial,
@DataFin = :frmConsAutosNaoNotificados.dfdFinal'
.head 6 -  Set _sIntoPesquisa = '
:frmConsAutosNaoNotificados.tblAutosNaoNotificados.colDataImplantacao,
:frmConsAutosNaoNotificados.tblAutosNaoNotificados.colAgente,	 
:frmConsAutosNaoNotificados.tblAutosNaoNotificados.colPlaca,
:frmConsAutosNaoNotificados.tblAutosNaoNotificados.colAuto,
:frmConsAutosNaoNotificados.tblAutosNaoNotificados.colCodigoRENAINF,
:frmConsAutosNaoNotificados.tblAutosNaoNotificados.colDataInfracao,
:frmConsAutosNaoNotificados.tblAutosNaoNotificados.colLocalCometimento,
:frmConsAutosNaoNotificados.tblAutosNaoNotificados.colRetornoImg,
:frmConsAutosNaoNotificados.tblAutosNaoNotificados.colDataRetornoImg'
...
.head 7 -  Call SqlImmediate( 'select getdate() into :frmConsAutosNaoNotificados.dCorrente' )
...
.head 6 -  Set nAux = 0
.head 6 -  !
.head 6 +  If NOT SalTblAnyRows( tblAutosNaoNotificados, 0, 0 )
.head 7 -  Call SalMessageBox( "Sem dados para serem impressos", "Atenção", MB_Ok | MB_IconInformation )
.head 7 -  Return FALSE
.head 6 -  !
...
.head 6 -  ! Set nErro = 0
.head 6 +  ! If Not fGetPermissaoExtrato()
.head 7 -  Set nErro = RPT_NoPrint
.head 6 -  Call SalSetWindowText( hWndReport, 'Relatórios de autos não notificados' )
.head 6 -  ! Call SalReportView( hWndForm, hWndReport, _sNomeQRP, _sVarSQLWindows, _sVarQRP, nErro)
.head 6 -  !
.head 6 -  Call SalReportTableView( tblAutosNaoNotificados,hWndReport, 'AutosNaoNotificados.qrp', nAux )
...
.head 5 -  Return FALSE
.head 4 -  Call SalSendMsg( tblAutosNaoNotificados, MSG_PesquisaTabela, 0, 0)
.head 4 -  Return TRUE
.head 3 +  On UDM_AposPesquisa
.head 4 -  ! Desabilita Campos/Botões
.head 4 -  Call SalSendClassMessage( UDM_AposPesquisa, wParam, lParam )
.head 4 -  !
.head 4 +  If NOT SalTblAnyRows( tblAutosNaoNotificados, 0, 0 )
.head 5 -  Call SalMessageBox( "Não existem dados para os parâmetros informados", "Atenção", MB_Ok | MB_IconInformation )
.head 5 -  Return FALSE
.head 4 +  If nGlobalOrgaoAutuante != NUMBER_Null
...
.head 5 -  Call SalEnableWindow(pbImprimir)
.head 5 -  !
.head 5 -  ! Call SalSendClassMessage( UDM_AposPesquisa, wParam, lParam )
...
'Relatório de Autos não Notificados', 'Relatório de Autos não Notificados' )
.head 4 -  Return TRUE
.head 3 +  On SAM_ReportFetchInit
.head 4 -  Set nRow= 0
.head 3 +  On SAM_ReportFetchNext
.head 4 +  If SalTblFetchRow(tblAutosNaoNotificados,nRow)!=TBL_NoMoreRows
