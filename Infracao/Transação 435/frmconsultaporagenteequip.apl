...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmConsultaPorAgenteEquip
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Infrações Arrecadadas por Agente/Equipamento
		Icon File:
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Set _sConsultaFrmOpcoesCampo = 'exec dbinfracao..OrgaoAutuanteS_desc_Estan @Setor=:frmConsultaPorAgenteEquip.nSetorUsuario'
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Set _sConsultaDescrição = 'exec dbinfracao..OrgaoAutuanteS_desc_sint @Cod = :frmConsultaPorAgenteEquip.dfnOrgao, @Setor=:frmConsultaPorAgenteEquip.nSetorUsuario'
			...
			Pushbutton: pbImprimir
				...
				Message Actions
					...
					On SAM_Click
						! Data Obrigatórias
						! If cmbMunicipio = ''
							Set sMunicipio  = 'em ' || cmbAno
						! Else
							Set sMunicipio = 'em ' || cmbAno || ' no Município de ' || cmbMunicipio
						! If hWndReport != hWndNULL
							 Call SalSendMsg( hWndReport, SAM_Close, 0,0)
						If rbImpressora
							Call SalReportPrint( hWndForm, 'MultasPA.qrp',
									'sGlobalSecretaria, sGlobalDetran, nGlobalSetor, sGlobalSetor, dCorrente, SqlUser,
									 :tblMultas.colDescricao, :tblMultas.colQuantidade,:tblMultas.colValorArrecadado,
									 :frmConsultaPorAgenteEquip.dfTotalValorArrecadado,
									 :frmConsultaPorAgenteEquip.dfTotalQtde,:frmConsultaPorAgenteEquip.dfsOrgao,
									 :frmConsultaPorAgenteEquip.cmbAno',
									'Secretaria, Detran, Setor, DesSetor, DataCorrente, Usuario,AgenteEquip, Qtde, ValorEmUFIR,
									,TotalEmUFIR,TotalQtde,OrgaoAutuante,Ano',1,RPT_PrintAll,0,0, nErro )
						Else
							Call SalReportView( hWndForm,hWndReport, 'MultasPA.qrp',
									'sGlobalSecretaria, sGlobalDetran, nGlobalSetor, sGlobalSetor, dCorrente, SqlUser,
									 :tblMultas.colDescricao, :tblMultas.colQuantidade,:tblMultas.colValorArrecadado,
									 :frmConsultaPorAgenteEquip.dfTotalValorArrecadado,
									 :frmConsultaPorAgenteEquip.dfTotalQtde,:frmConsultaPorAgenteEquip.dfsOrgao,
									 :frmConsultaPorAgenteEquip.cmbAno',
									'Secretaria, Detran, Setor, DesSetor, DataCorrente, Usuario,AgenteEquip, Qtde, ValorEmUFIR,
									,TotalEmUFIR,TotalQtde,OrgaoAutuante,Ano', nErro )
							Call SalSetWindowText( hWndReport, 'Relatório de Multas por Orgao Autuante' )
			Pushbutton: pbLimpar
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class: cQCK1PushButton
			...
			Child Table: tblMultas
				...
				Message Actions
					On SAM_Create
						...
						Set _sComandoPesquisa = 'exec dbinfracao..EstatS_OrgaoAutuanteAgente @Ano=:frmConsultaPorAgenteEquip.cmbAno,
								@OrgaoAutuante=:frmConsultaPorAgenteEquip.dfnOrgao'
						Set _sIntoPesquisa = ':frmConsultaPorAgenteEquip.tblMultas.colDescricao,:frmConsultaPorAgenteEquip.tblMultas.colQuantidade,
								                                    :frmConsultaPorAgenteEquip.tblMultas.colValorArrecadado'
						Set _bPesquisaCreate = FALSE
						Set _bSempreHabilitado = TRUE
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
					! On SAM_FetchRowDone
						 Set dfTotalQtde = tblMultas.colQuantidade+dfTotalQtde
						 Set dfTotalValorArrecadado = tblMultas.colValorArrecadado+dfTotalValorArrecadado
						 Set dfTotalValorEmREAL = tblMultas.colValorEmREAL+dfTotalValorEmREAL
			Data Field: dfTotalQtde
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class: cQCK1DataField
				Property Template:
				...
				Message Actions
					On SAM_Create
						...
						Set _sTipoMsgNulo = 'PADRAO'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			Data Field: dfTotalValorArrecadado
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class: cQCK1DataField
				Property Template:
		...
		Message Actions
			...
			On SAM_CreateComplete
				...
				! Call HabilitacaoNome( 'pbAuto', mdiInfracao.MenuHabilitado( 'frmConsultaPorAgenteEquip' ) )
				Call SalEnableWindow(dfnOrgao)
			On SAM_Destroy
			...
			On SAM_ReportStart
				...
				! Set sMes = frmConsultaPorAgenteEquip.cmbMunicipio
				! Set sAno =  frmConsultaPorAgenteEquip.cmbAno
				! Call SalReportSetStringVar( hWndReport, 'Ano', frmConsultaPorAgenteEquip.sAno )
				! Call SalReportSetStringVar( hWndReport, 'Mes', frmConsultaPorAgenteEquip.sMes)
				Return TRUE
			On SAM_ReportFetchInit
				Call SqlImmediate( 'select getdate() into :frmConsultaPorAgenteEquip.dCorrente' )
				Set nRow= 0
				Call SalTblSetContext( tblMultas, 0 )
			On SAM_ReportFetchNext
				...
				Else
					Return FALSE
			! On SAM_ReportFinish
				 Call SalReportSetStringVar( hWndReport, 'Ano', frmConsultaPorAgenteEquip.cmbAno )
				 Call SalReportSetStringVar( hWndReport, 'Mes', frmConsultaPorAgenteEquip.cmbMunicipio)
  