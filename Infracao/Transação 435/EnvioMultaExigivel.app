...
.enddata
.data CLASSPROPS
0000: 4442475F504C4159 4241434B5F475549 44001000694B3A68 91C7B2498188BFAE
0020: 9402EB9A000000
.enddata
...
.head 6 -  Enabled when: MenuHabilitado('frmEnviaMultaExigivel')
.head 6 -  Checked when:
.head 5 +  Menu Actions
...
.head 4 -  Title: Transmissão FILA BIN Multa exigível
.head 4 -  Icon File:
...
.head 7 -  Set nHoraInicial = nHoraInicial + 2
.head 7 -  Call SalTblReset( tblPlacas )
.head 7 +  If SalDateHour( SalDateCurrent() ) >=nHoraInicial 
