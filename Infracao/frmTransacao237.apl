...
0020: 0000000000F90000 002C000000020000 0003000000FFFFFF FFFFFFFFFFF8FFFF
...
0080: 6D5472616E736163 616F323337
.enddata
...
.head 1 +  Form Window: frmTransacao237
.head 2 -  Class: cQCK1Form
.head 2 -  Property Template:
.head 2 -  Class DLL Name:
.head 2 -  Title: Geração do arquivo TXT da transação 237
.head 2 -  Icon File:
...
.head 2 -  Description: --------------------------------------------------------------------------------------------------
27/01/2022 [afs] Cria o arquivo txt da transação 237  
--------------------------------------------------------------------------------------------------
.head 2 -  Named Menus
.head 2 -  Menu
.head 2 +  Tool Bar
...
.head 4 +  Contents
.head 5 +  Column: colsArquivo
.head 6 -  Class Child Ref Key: 0
.head 6 -  Class ChildKey: 0
.head 6 -  Class: cQCK1Column
.head 6 -  Property Template:
.head 6 -  Class DLL Name:
.head 6 -  Title: Arquivo(s)
...
.head 5 +  Column: colnTotalReg
.head 6 -  Class Child Ref Key: 0
.head 6 -  Class ChildKey: 0
.head 6 -  Class: cQCK1Column
.head 6 -  Property Template:
.head 6 -  Class DLL Name:
.head 6 -  Title: Total Registro
.head 6 -  Visible? Class Default
.head 6 -  Editable? No
.head 6 -  Maximum Data Length: Class Default
...
.head 6 -  Set _sComandoPesquisa = 'exec dbvcen..RecuperandoArquivoS'
.head 6 -  Set _sIntoPesquisa = '
:frmTransacao237.tblEnvio.colsArquivo,
:frmTransacao237.tblEnvio.colnTotalReg'
...
.head 4 -  Message Actions
.head 3 -  !
.head 3 +  Pushbutton: pbAtualizar
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class: cQCK1PushButton
.head 4 -  Property Template:
.head 4 -  Class DLL Name:
.head 4 -  Title: Atualizar
.head 4 -  Window Location and Size
.head 5 -  Left: 5.388"
.head 5 -  Top: 2.656"
...
.head 4 +  Message Actions
.head 5 +  On SAM_Create
.head 6 -  Set _sTextoStatusBar = 'Atualiza a Tabela'
.head 6 -  Set _nPermissao = 15
.head 6 -  Set _sTipoComando = 'Comum'
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  On SAM_Click
.head 6 -  Call SalSendClassMessage( SAM_Click, wParam, lParam )
.head 6 -  Call SalSendMsg( tblEnvio, MSG_PesquisaTabela, 0, 0)
.head 6 -  Set dfInfo = ""
.head 3 +  Pushbutton: pbIGerar
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class: cQCK1PushButton
.head 4 -  Property Template:
...
.head 4 +  Message Actions
.head 5 +  On SAM_Create
.head 6 -  Set _sTextoStatusBar = 'Gera o Arquivo'
.head 6 -  Set _nPermissao = 15
.head 6 -  Set _sTipoComando = 'Comum'
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  On SAM_Click
...
.head 6 -  Call SalSendClassMessage( SAM_Click, wParam, lParam )
.head 6 -  !
.head 6 +  If NOT SalTblAnyRows( tblEnvio, 0, 0 )
.head 7 -  Call SalMessageBox( "Não existem arquivos para serem gerados", "Atenção", MB_Ok | MB_IconInformation )
.head 7 -  Return FALSE
.head 6 -  !
.head 6 +  If NOT  fVerificandoMarcacao( )
.head 7 -  Call SalMessageBox( "Um arquivo deverá ser selecionado", "Atenção", MB_Ok | MB_IconInformation )
.head 7 -  Return FALSE
.head 6 -  !
.head 6 -  Call SalWaitCursor( TRUE )
.head 6 -  !
.head 6 -  Set dfInfo = "Gerando o Arquivo......."
.head 6 +  If NOT fPegandoSelecionados()
.head 7 -  Call SalWaitCursor( FALSE )
.head 7 -  Call SalMessageBox( "Erro na Geração do Arquivo " || sArquivoCriado , "Atenção", MB_Ok | MB_IconInformation )
.head 6 +  Else
.head 7 -  Set dfInfo = "Arquivo Gerado com Sucesso....."
.head 6 -  !
...
.head 4 -  Message Actions
.head 2 +  Functions
.head 3 +  Function: fVerificandoMarcacao
.head 4 -  Description: Gera os dados que irão fazer parte do arquivo texto
.head 4 -  Returns
.head 4 -  Parameters
.head 4 -  Static Variables
.head 4 +  Local variables
.head 5 -  ! cArquivo: oArquivo
...
.head 5 -  Set nTotal = 0
.head 5 -  !
.head 5 -  ! Verificando se o usuário marcou algum arquivo
.head 5 +  While SalTblFindNextRow( tblEnvio, nLinha, 0, 0 )
.head 6 -  Call SalTblSetContext( tblEnvio, nLinha )
.head 6 +  If SalTblQueryRowFlags( tblEnvio, nLinha, ROW_Edited)
.head 7 -  Set nTotal = nTotal + 1
.head 5 -  !
.head 5 +  If nTotal > 0
.head 6 -  Set bRetorno = TRUE
.head 5 +  Else
.head 6 -  Set bRetorno = FALSE
.head 5 -  !
.head 5 -  Return bRetorno
.head 3 +  Function: fPegandoSelecionados
.head 4 -  Description: Gera o arquivo txt da transação 237 (Pasta Infracao237)
.head 4 -  Returns
.head 4 -  Parameters
.head 4 -  Static Variables
.head 4 +  Local variables
.head 5 -  Sql Handle: hSqlTexto
.head 5 -  Number: nLinhas
.head 5 -  Boolean: bRetorno
.head 4 +  Actions
.head 5 -  !
.head 5 -  Set nLinhas = TBL_MinRow
.head 5 -  !
.head 5 -  Set bRetorno = TRUE
.head 5 -  ! Pegando os arquivos selecionador
.head 5 +  While SalTblFindNextRow( tblEnvio, nLinhas, 0, 0 )
.head 6 -  Call SalTblSetContext( tblEnvio, nLinhas )
.head 6 +  If SalTblQueryRowFlags( tblEnvio, nLinhas, ROW_Edited)
.head 7 +  If NOT  fSaidaEmArquivo(frmTransacao237.tblEnvio.colsArquivo)
...
.head 4 -  Returns
.head 4 +  Parameters
.head 5 -  String: psArquivo
.head 4 -  Static Variables
.head 4 +  Local variables
.head 5 -  Sql Handle: hSqlTexto
.head 5 -  Number: nLinhas
.head 5 -  String: sArquivo
.head 5 -  Long String: lsRegistro
.head 5 -  String: sHeader
.head 5 -  Number: nArquivopen
.head 4 +  Actions
.head 5 -  !
.head 5 -  Set nLinhas = TBL_MinRow
.head 5 -  !
.head 5 -  ! Pegando os dados para geração do arquivo
.head 5 +  If fMPSConnect( hSqlTexto )
.head 6 -  Call fMPSPrepareProc( hSqlTexto, ' exec dbvcen..EnviaCrlvDigitalS
		@Arquivo		=	:psArquivo,
		@Regerar 	=	"S" ',
		':sArquivo,
		:lsRegistro'	)
.head 6 +  If SqlExecute( hSqlTexto )
.head 7 -  !
.head 7 -  ! Montando o primeiro registro
.head 7 -  Set nArquivopen  = 0
.head 7 -  Call SqlFetchNext( hSqlTexto, lParam )
.head 7 -  Set sNomArq =  SalStrTrimX( psArquivo )
.head 7 -  Set sCaminhoComArquivo = SalStrTrimX( sArquivo )
.head 7 -  !
.head 7 +  If NOT VisDosExist( sCaminhoComArquivo )
.head 8 -  Call SalFileSetCurrentDirectory(VisDosGetCurDir( 'C:\\'  ))
.head 8 -  Call SalFileCreateDirectory (sCaminhoComArquivo)
.head 7 -  !
.head 7 -  Set sHeader = '0' || sNomArq || sEspacos100
	|| sEspacos100 || sEspacos100 || sEspacos100 || sEspacos69
.head 7 -  !
.head 7 +  If SalFileOpen( fArquivo,  sCaminhoComArquivo || sNomArq, OF_Create|OF_ReadWrite)
.head 8 -  Call SalFilePutStr( fArquivo, sHeader)
.head 8 -  Set nArquivopen  = 1
.head 7 +  Else
.head 8 -  Return FALSE
.head 7 -  !
.head 7 +  While SqlFetchNext(hSqlTexto, lParam)
.head 8 -  !
.head 8 -  Call SalFilePutStr( fArquivo, lsRegistro)
.head 8 -  !
.head 7 -  Call fMPSDisconnect( hSqlTexto )
.head 7 -  Call SalFileClose( fArquivo )
.head 7 -  ! Montando o trailler 
.head 5 -  !
.head 5 -  Return TRUE
.head 5 -  !
.head 2 +  Window Parameters
.head 3 -  Window Handle: pmdipbTransacao
.head 2 +  Window Variables
.head 3 -  File Handle: fArquivo
.head 3 -  String: sCaminhoComArquivo
.head 3 -  String: sNomArq
.head 3 -  String: sNomeArq
.head 3 -  String: sEspacos100
.head 3 -  String: sEspacos84
.head 3 -  String: sEspacos69
.head 3 -  String: sArquivoCriado
.head 2 +  Message Actions
.head 3 +  ! Observações
.head 4 -      Autor: Celso - 09/10/1997
.head 3 +  On SAM_Create
.head 4 -  Set _sTextoStatusBar = 'Tela de reenvio de arquivo 237-batch'
.head 4 -  Set _nEstadoInicialForm = EF_RegistroExistente
.head 4 -  Call SalCenterWindow( hWndForm )
.head 4 -  !
.head 4 -  Call SqlImmediate( 'select getdate() into :dDataImp' )
.head 4 -  Call SalDisableWindow( pmdipbTransacao )
...
.head 4 -  !
.head 4 -  Call SalSendMsg( tblEnvio, MSG_PesquisaTabela, 0, 0)
.head 4 -  Set sEspacos100 = '                                                                                                    '
.head 4 -  Set sEspacos84 = '                                                                                    '
.head 4 -  Set sEspacos69 = '                                                                     '
.head 4 -  !
.head 3 -  !
.head 3 +  On SAM_Destroy
.head 4 -  Call SalEnableWindow( pmdipbTransacao )
