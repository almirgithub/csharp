...
0080: 6742494E436F6E73 5072696E63436F6E 6475746F72
.enddata
...
.head 1 +  Dialog Box: dlgBINConsPrincCondutor
.head 2 -  Class: cQCK1DialogBox
.head 2 -  Property Template:
.head 2 -  Class DLL Name:
.head 2 -  Title: Escolha um Processo
...
.head 2 -  Description: Retorno de vários registro de Principal Condutor. Atende retorno transação: 959
Autor: Antonio Lins  -  09.04.2019
.head 2 +  Tool Bar
...
.head 6 -  Title: CPF Princ.Condutor
...
.head 8 -  Set _bVisivel = TRUE
.head 8 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  Column: coldDataAtivacao
.head 6 -  Class Child Ref Key: 0
.head 6 -  Class ChildKey: 0
.head 6 -  Class: cQCK2Column
.head 6 -  Property Template:
...
.head 6 -  Set _sComandoPesquisa = 'exec dbvcen..BINConsultaPrincCondutorS_RT03 @CodConsulta = :dlgBINConsPrincCondutor.nCodConsulta,
@NumSeqTransacao = :dlgBINConsPrincCondutor.nSeqTransacao'
.head 6 -  Set _sIntoPesquisa = ':dlgBINConsPrincCondutor.tblKey.colsCpfPrincipalCondutor, :dlgBINConsPrincCondutor.tblKey.colsSituacao,
:dlgBINConsPrincCondutor.tblKey.coldDataAtivacao,:dlgBINConsPrincCondutor.tblKey.coldDataExclusao,:dlgBINConsPrincCondutor.tblKey.colsMotivoExclusao'
.head 6 -  !
...
.head 4 +  Message Actions
.head 5 +  On SAM_Create
.head 6 -  Set _sTextoStatusBar = 'Seleciona o condutor marcado'
...
.head 7 -  Return FALSE
.head 6 -  Set sCpfPrincipalCondutor = tblKey.colsCpfPrincipalCondutor
...
.head 6 -  Call SalSendMsg( hWndForm, SAM_Close, 0, 0 )
.head 3 -  Background Text: Registros Encontrados
...
.head 3 -  Receive String: sCpfPrincipalCondutor
...
.head 4 -  Set sCpfPrincipalCondutor = STRING_Null
