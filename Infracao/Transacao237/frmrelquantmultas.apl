...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmRelQuantMultas
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Relatório Quantitativo de Multas
		Icon File:
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Set _sConsultaFrmOpcoesCampo = 'exec dbinfracao..OrgaoAutuanteS_desc_Estan @Setor=:frmRelQuantMultas.nSetorUsuario'
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Set _sConsultaFrmOpcoesSQLOuSP = 'SP'
						Set _sConsultaFrmOpcoesCampo = 'exec dbinfracao..AgenteEquipS_desc_Estan @OrgaoAutuante = :frmRelQuantMultas.dfnOrgao, @Setor=:frmRelQuantMultas.nSetorUsuario'
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Set _sConsultaDescrição = 'exec dbinfracao..AgenteEquipS_desc_sint @Cod = :frmRelQuantMultas.dfnAgenteEquip,
								                                             @OrgaoAutuante = :frmRelQuantMultas.dfnOrgao'
			...
			Background Text: a
				...
				Text Color: Default
				Background Color: Default
			Background Text: Agente Autuador:
.data INHERITPROPS
0000: 0100
.enddata
.data CLASSPROPS
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Set _bNuncaHabilitado = TRUE
						Set _bÉCampoDescrição = TRUE
						Set _sConsultaDescrição ='exec OrgaoAutuanteS_desc_sintRest @Cod = :frmRelQuantMultas.dfnOrgao, @SetorReduzido=:frmRelQuantMultas.nSetorReduzido'
						Set _bÉDependente = TRUE
			...
			Pushbutton: pbImprimir
				...
				Message Actions
					...
					On SAM_Click
						...
						If rbImpressora
							Call SalReportPrint( hWndForm,'QuantMul.qrp',
									'sGlobalSecretaria, sGlobalDetran, nGlobalSetor, sGlobalSetor, dCorrente, SqlUser,sData,
									nImplantadas, nValorImplant, nCanceladas, nValorCanc,dfdInicial, dfdFinal, dfsOrgao,dfsAgenteEquip',
									'Secretaria, Detran, Setor, DesSetor, DataCorrente, Usuario, Data, Implantadas, ValorImplant, Canceladas,
									ValorCanc, DataI, DataF, OrgaoAutuante,AgenteEquip', 1,RPT_PrintAll,0,0, nErro )
						Else If rbTela
							Set hWndReport = SalCreateWindow( frmReportView, hWndForm )
							Call SalSetWindowText( hWndReport, 'Relatório Quantitativo de Multas' )
							Call SalReportView( hWndForm, hWndReport,'QuantMul.qrp',
									'sGlobalSecretaria, sGlobalDetran, nGlobalSetor, sGlobalSetor, dCorrente, SqlUser,sData,
									nImplantadas, nValorImplant, nCanceladas,nValorCanc, dfdInicial, dfdFinal, dfsOrgao,dfsAgenteEquip',
									'Secretaria, Detran, Setor, DesSetor, DataCorrente, Usuario, Data, Implantadas, ValorImplant, Canceladas,
									ValorCanc, DataI, DataF, OrgaoAutuante,AgenteEquip', nErro)
						Else
							If dfArquivo = ''
...
.enddata
		...
		Functions
			Function: fMontaArquivo
				...
				Actions
					...
					Call fMPSPrepareProc( hSql, 'exec dbinfracao..RelQuantMultas @OrgaoAutuante = :frmRelQuantMultas.dfnOrgao,
							@DataI = :frmRelQuantMultas.dfdInicial,  @DataF = :frmRelQuantMultas.dfdFinal,@AgenteEquip=:frmRelQuantMultas.dfnAgenteEquip,@Saida="A"',
							':sTexto' )
					...
					If SalMessageBox( 'Deseja visualizar o layout do arquivo gerado?', 'Atenção',MB_YesNo )=IDYES
						! Call SalReportView( frmRelQuantMultas, hWndNULL, 'QuantMu.qrp', '', '', lParam )
						Set hWndReport = SalCreateWindow( frmReportView, hWndForm )
						Call SalReportView( frmRelQuantMultas, hWndReport, 'QuantMu.qrp',
					...
					! If VisFileGetSize( dfsArquivo ) <= 0
						  Call SalFileOpen( hArquivo, dfsArquivo, OF_Delete )
						  Call SalMessageBox( 'Não há multas pagas para o Orgão Autuante no período', 'Atenção', MB_IconExclamation | MB_Ok )
					! Call SalEndDialog( dlgEsperaGeracao, bok )
					! dfTexto
					Call SalSendMsgToChildren( frmRelQuantMultas, MSG_Limpa,wParam,lParam )
					! Call SalHideWindow( dfArquivo )
					! Call SalHideWindow( dfTexto )
					Return TRUE
		Window Parameters
		...
		Message Actions
			! Observações
				  Autor: Roberto T. - 10/02/2000
			On SAM_Create
				Set _sTextoStatusBar = 'Tela de relatório quantitativo de multas'
			...
			On SAM_ReportStart
				Call SalReportDlgOptions( SalNumberToWindowHandle( wParam ), 'Impressão', 'Imprimindo',
						'Relatório Quantitativo de Multas', 'Relatório Quantitativo de Multas' )
				Return TRUE
			On SAM_ReportFetchInit
				Call SqlImmediate( 'select getdate() into :frmRelQuantMultas.dCorrente' )
				Call fMPSPrepareProc( hSql, 'exec dbinfracao..RelQuantMultas @OrgaoAutuante = :frmRelQuantMultas.dfnOrgao,
						@DataI = :frmRelQuantMultas.dfdInicial,  @DataF = :frmRelQuantMultas.dfdFinal,@AgenteEquip=:frmRelQuantMultas.dfnAgenteEquip,@Saida=""',
						':frmRelQuantMultas.sData, :frmRelQuantMultas.nImplantadas, :frmRelQuantMultas.nValorImplant,
						:frmRelQuantMultas.nCanceladas, :frmRelQuantMultas.nValorCanc' )
				If NOT SqlExecute( hSql )
					Return FALSE
