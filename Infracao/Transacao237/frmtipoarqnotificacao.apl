...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmTipoArqNotificacao
.data INHERITPROPS
0000: 0100
.enddata
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Tipo de Arquivo de Notificação
		Icon File:
...
.enddata
				...
				Message Actions
					! On SAM_Create
						...
						Set _sTextoStatusBar = 'Código do tipo de arquivo'
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Set _bPermiteNulos = FALSE
						Set _sTextoStatusBar = 'Descricao do tipo de arquivo de notificação'
			...
			Data Field: dfnOrgaoAutuante
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Órgão autuante associadao a série'
						...
						Set _sConsultaFrmOpcoesCampo = 'exec dbinfracao..OrgaoAutuanteS_desc_Estan @Cod = :frmTipoArqNotificacao.dfnOrgaoAutuante'
						! Set _sConsultaFrmOpcoesCampo = 'select  distinct convert( varchar( 10), o.Cod), o.Descricao from ' || DATABASE_INFRACAO || '..AgenteEquip ae, '
										  || DATABASE_INFRACAO || '..OrgaoAutuante o, '
								                                  || DATABASE_CENTRAL || '..OrgaoAutSetor oas , ' || DATABASE_CENTRAL
										  || '..Setor s Where s.CodReduzido =  :frmSerieLiberada.nSetorUsuario and s.Cod = oas.Setor and
						...
						Set _sTipoMsgNulo = 'ESPECIFICA'
						Set _sMsgNulo = 'O campo Órgão Autuante é obrigatório'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			Combo Box: cmbTipoLote
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class: cQCK1ComboBox
				Property Template:
				...
				Message Actions
					On SAM_Create
						...
						Set _sNomeParaMsgs = 'Tipo do Lote'
						Set _sTipoMsgNulo = 'PADRAO'
						Set _bVisivel = TRUE
						Set _sRefresh = 'Create'
						Set _sNomeCampoCodigo = 'dfsTipoLote'
						Set _sConsultaBD = 'exec TipoLoteS'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			Data Field: dfnNumInfracoes
.data CLASSPROPSSIZE
0000: 1A00
.enddata
.data CLASSPROPS
...
.enddata
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Número de infrações do arquivo de notificação'
						Set _sNroCamposIgnorados = 'NENHUM'
						Set _sMsgValidacao = 'Informe um valor maior que zero'
						!
						Set _bNuncaHabilitado = FALSE
						Set _bPermiteNulos = 	FALSE
						Set _bSempreHabilitado = FALSE
						!
						Set _bVisivel = TRUE
						Set _sNomeParaMsgs = 'Num. Infrações'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
					On UDM_ValidaCampo
						If SalIsNull( hWndItem ) or dfnNumInfracoes = 0
							Set _sMsgValidacao = 'Informe um valor maior que zero'
							Return FALSE
						Else
			...
			Data Field: dfsOrgaoAutuante
				...
				Message Actions
					On SAM_Create
						...
						Set _bSempreHabilitado = FALSE
						! Set _sConsultaDescrição = 'exec OrgaoAutS_desc @Cod = :frmSerieLiberada.dfnOrgaoAutuante'
						Set _sConsultaDescrição = 'exec dbinfracao..OrgaoAutuanteS_desc_sint @Cod = :frmTipoArqNotificacao.dfnOrgaoAutuante'
...
.enddata
		...
		Message Actions
			On SAM_Create
				Set _sNomeBD = ''
				Set _sPwdUsuario = ''
				Set _sTextoStatusBar = 'Tela de cadastro dos tipos de arquivos de notificação'
				...
				Set _sComandoPesquisa = 'exec TipoArqNotS @Cod = :frmTipoArqNotificacao.dfnCod'
				Set _sListaINTOPesquisa = ':frmTipoArqNotificacao.dfnCod,
						:frmTipoArqNotificacao.dfsDescricao, :frmTipoArqNotificacao.dfsTipoLote,
						:frmTipoArqNotificacao.dfnNumInfracoes,:frmTipoArqNotificacao.dfnOrgaoAutuante,:frmTipoArqNotificacao.dfsOrgaoAutuante'
				Set _sComandoInclusao = 'exec TipoArqNotI  @Cod = :frmTipoArqNotificacao.dfnCod,
						@Descricao = :frmTipoArqNotificacao.dfsDescricao,
						@NumInfracoes = :frmTipoArqNotificacao.dfnNumInfracoes,
						@TipoLote = :frmTipoArqNotificacao.dfsTipoLote,@OrgaoAutuante = :frmTipoArqNotificacao.dfnOrgaoAutuante'
				Set _sListaINTOInclusao = ':frmTipoArqNotificacao.dfnCod'
				Set _sComandoAtualizacao = 'exec TipoArqNotU  @Cod = :frmTipoArqNotificacao.dfnCod,
						@Descricao = :frmTipoArqNotificacao.dfsDescricao,
						@NumInfracoes = :frmTipoArqNotificacao.dfnNumInfracoes,
						@TipoLote = :frmTipoArqNotificacao.dfsTipoLote,@OrgaoAutuante = :frmTipoArqNotificacao.dfnOrgaoAutuante'
				Set _sListaINTOAtualizacao = ''
				Set _sComandoRemocao = 'exec TipoArqNotD  @Cod = :frmTipoArqNotificacao.dfnCod'
			...
			On UDM_AposInclusao
				...
				Return SalSendClassMessage( UDM_AposAtualizacao, wParam, lParam )
			On UDM_AposPesquisa
				! Set cmbFaixaAR = SalNumberToStrX( dfnFaixaAR, 0 )
				Call SalDisableWindow( dfnCod )
				Return TRUE
  