...
0020: 0000000000D70000 002C000000020000 0003000000FFFFFF FFFFFFFFFFF8FFFF
...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmCargaTalaoEletronico
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Carga de Multas Eletrônicas de Veículos do Estado de PE
		Icon File:
			...
			! cQCK2ChildTable: tblAutos
				...
				Message Actions
					On SAM_Create
						...
						Set _sComandoPesquisa = 'exec dbinfracao..RNFEnvioTransacaoEletrS @TipoArquivo = :frmCargaTalaoEletronico.cmbTipoArquivo'
						! coluna para o retorno
						Set _sIntoPesquisa = ':frmCargaTalaoEletronico.tblAutos.colnOrgaoAutuante,
								:frmCargaTalaoEletronico.tblAutos.colsNumAutoInfracao,
								:frmCargaTalaoEletronico.tblAutos.colnInfracao,
								:frmCargaTalaoEletronico.tblAutos.colnCodigoRENAINF,
								:frmCargaTalaoEletronico.tblAutos.coldDataLimiteDefesa,
								:frmCargaTalaoEletronico.tblAutos.colsSerie,
								:frmCargaTalaoEletronico.tblAutos.colnAuto,
								:frmCargaTalaoEletronico.tblAutos.colsTipoMovimento,:frmCargaTalaoEletronico.tblAutos.colnTransacao,
								:frmCargaTalaoEletronico.tblAutos.colsMensagem,
								:frmCargaTalaoEletronico.tblAutos.colsDescMovimento,
								:frmCargaTalaoEletronico.tblAutos.coldDataMovimento'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
					! On SAM_FetchRowDone
			...
			Function: fCarga
				...
				Actions
					...
					Loop
						...
						Set strComando = 'Exec dbinfracao..CargaTalaoEletronicoI
								@Registro="' || tblPlacas.colsRegistro  || '" ,@DescAgente=:cmbTipoArquivo,@Sequencial = :nSeq,@Arquivo = :dfProcessando,
								@Lote = :nLote'
