...
0020: 00000000005B0100 002C000000020000 0003000000FFFFFF FFFFFFFFFFFCFFFF
...
0080: 6D43617267614D75 6C74617341647665 7274656E6369610D 4368696C64205769
00A0: 6E646F7773097462 6C506C61636173
.enddata
...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmCargaMultasAdvertencia
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Carga de Multas Eletrônicas EDUCATIVAS / ADVERTÊNCIAS
		Icon File:
		...
		Description: Tela de Carga de Multas Eletrônicas
		Named Menus
		Menu
		Tool Bar
			Display Settings
			...
			Pushbutton: pbGerar
				...
				Message Actions
					On SAM_Click
						...
						Call SalMessageBox( "Processo encerrado", "Mensagem", MB_IconExclamation )
			...
			! cQCK2ChildTable: tblAutos
				...
				Message Actions
					On SAM_Create
						...
						Set _sComandoPesquisa = 'exec dbinfracao..RNFEnvioTransacaoEletrS @TipoArquivo = :frmCargaMultasAdvertencia.cmbTipoArquivo'
						! coluna para o retorno
						Set _sIntoPesquisa = ':frmCargaMultasAdvertencia.tblAutos.colnOrgaoAutuante,
								:frmCargaMultasAdvertencia.tblAutos.colsNumAutoInfracao,
								:frmCargaMultasAdvertencia.tblAutos.colnInfracao,
								:frmCargaMultasAdvertencia.tblAutos.colnCodigoRENAINF,
								:frmCargaMultasAdvertencia.tblAutos.coldDataLimiteDefesa,
								:frmCargaMultasAdvertencia.tblAutos.colsSerie,
								:frmCargaMultasAdvertencia.tblAutos.colnAuto,
								:frmCargaMultasAdvertencia.tblAutos.colsTipoMovimento,:frmCargaMultasAdvertencia.tblAutos.colnTransacao,
								:frmCargaMultasAdvertencia.tblAutos.colsMensagem,
								:frmCargaMultasAdvertencia.tblAutos.colsDescMovimento,
								:frmCargaMultasAdvertencia.tblAutos.coldDataMovimento'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
					! On SAM_FetchRowDone
			...
			Function: fCarga
				...
				Actions
					...
					Loop
						...
						Set strComando = 'Exec dbinfracao..CargaMultaEletronicaI
								@Registro=:tblPlacas.colsRegistro,@DescAgente=:cmbTipoArquivo,@Sequencial = :nSeq,@Arquivo = :dfProcessando,@Lote = :nLote,
								@Advertencia = 1,@Registro1 = :tblPlacas.colsRegistro1'
						Set bOk = fMPSPrepareProc(hSql,strComando ,':strErro,:nLote')
						Set bOk = SqlExecute(hSql)
						Call fGravaErrosDaHisMulta()
						!
						Set dfnContador = nSeq
						Set nSeq = nSeq + 1
						Set nRow = nRow + 1
						!
