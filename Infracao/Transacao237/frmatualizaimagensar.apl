...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmAtualizaImagensAR
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Atualiza Imagens do AR
		Icon File:
		...
		Contents
			Frame
				...
				Background Color: 3D Face Color
			Child Table: tblAtualizaImagensAR
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class:
				Property Template:
				...
				Message Actions
					On SAM_Click
						...
						Loop
							...
							Call SalTblReset(tblAtualizaImagensAR)
						...
						Call SalMessageBox( "Processo encerrado envie o arquivo de retorno para o analista responsável", "Mensagem", MB_IconExclamation )
		...
		Functions
			...
			Function: fGravaRegistrosNoBanco
				...
				Actions
					...
					Loop
						...
						Set sValues = ''
						!
						Call SalTblInsertRow( tblAtualizaImagensAR, nRow )
						Call SalTblSetContext(tblAtualizaImagensAR,nRow)
						Set tblAtualizaImagensAR.colsRegistro = strTexto
						Set nRow = nRow + 1
						!
					Call fCarga()
					Return TRUE
			...
			Function: fCarga
				...
				Actions
					...
					Set nSeq = 1
					Loop
						If SalTblFetchRow( tblAtualizaImagensAR, nRow ) = TBL_NoMoreRows
							Break
						Set strErro = STRING_Null
						Set strComando = 'Exec dbinfracao..AtualizaNomeImagemU @Registro=:tblAtualizaImagensAR.colsRegistro'
						Call SalWaitCursor( TRUE )
						! Set bOk = SybPrepareProc(hSqlApp,strComando,'strErro')
						! Set bOk = SqlExecute(hSqlApp)
						Set bOk = fMPSPrepareProc(hSql,strComando ,':strErro')
						Set bOk = SqlExecute(hSql)
						Call fGravaErrosAtualizacao()
						!
			...
			Function: fGravaErrosAtualizacao
				Description:
				Returns
				Parameters
				Static Variables
