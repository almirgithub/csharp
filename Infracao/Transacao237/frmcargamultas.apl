...
0080: 6D43617267614D75 6C746173
.enddata
			...
			! cQCK2ChildTable: tblAutos
				...
				Message Actions
					On SAM_Create
						...
						Set _sComandoPesquisa = 'exec dbinfracao..RNFEnvioTransacaoEletrS @TipoArquivo = :frmCargaMultas.cmbTipoArquivo'
						! coluna para o retorno
						Set _sIntoPesquisa = ':frmCargaMultas.tblAutos.colnOrgaoAutuante,
								:frmCargaMultas.tblAutos.colsNumAutoInfracao,
								:frmCargaMultas.tblAutos.colnInfracao,
								:frmCargaMultas.tblAutos.colnCodigoRENAINF,
								:frmCargaMultas.tblAutos.coldDataLimiteDefesa,
								:frmCargaMultas.tblAutos.colsSerie,
								:frmCargaMultas.tblAutos.colnAuto,
								:frmCargaMultas.tblAutos.colsTipoMovimento,:frmCargaMultas.tblAutos.colnTransacao,
								:frmCargaMultas.tblAutos.colsMensagem,
								:frmCargaMultas.tblAutos.colsDescMovimento,
								:frmCargaMultas.tblAutos.coldDataMovimento'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
					! On SAM_FetchRowDone
				...
				Actions
					...
					Loop
						...
						Set strComando = 'Exec dbinfracao..CargaMultaEletronicaI
								...
								@Lote = :nLote, @Registro1 = :tblPlacas.colsRegistro1'
