	...
	Form Window: frmRelGuiaLicenc
		...
		Contents
			Pushbutton: pbImprimir
				...
				Message Actions
					On SAM_Create
						If nPermissaoImprimir = 1
							Call frmRelGuiaLicenc.fSetPermissaoExtrato(FALSE)
						Else
							Call frmRelGuiaLicenc.fSetPermissaoExtrato(TRUE)
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			Data Field: dfsCpfCgc
		...
		Window Parameters
			...
			Number: nParCopias
			Number: nPermissaoImprimir
		Window Variables
			! ----- Relatório de Guia de Licenciamento -----
			String: sObsIpvaNotificacaoTit
			String: sPlaca
			String: sTipoPessoa
			String: sChassi
			String: sMarca
			String: sNumBancIpva3
			String: sNumBancIpva2
			String: sNumBancIpva1
			String: sNumBancIpvaU
			String: sNumBancDpvat
			String: sNumBancLicen
			String: sNumBancMultas
			Number: nRenavam
			Number: nExercicio
			Number: nValor1
			Number: nValor2
			...
			Number: nSeq
			String: sPropr
			String: sTituloValor1
			String: sTituloValor2
			String: sTituloLinha
			String: sSubTitLinha
			String: sCodBarras
			String: sLinhaDigitavel
			Date/Time: dVencimento
		...
		Message Actions
			On SAM_CreateComplete
				...
				! Chamado Apartir da Guia de Licensiamento
				!
				! ! -- [faml] 01/01/2017 - @EmitirTaxaPostagem= sEmitirTaxaPostagem
				!
				Set _sStored = 'Exec GuiaLicenciamentoUnicaR
				...
				Set _sNomeQRP = 'GuiaLicen.QRP'
				Set _sTituloRelatório = 'Guia de Licenciamento'
				!
				Set _sPrimeiroRetorno = '	:frmRelGuiaLicenc.sPlaca, 		:frmRelGuiaLicenc.sPropr,
									:frmRelGuiaLicenc.dfsCpfCgc,		:frmRelGuiaLicenc.nRenavam,
									:frmRelGuiaLicenc.nAnoFabricacao,	:frmRelGuiaLicenc.sChassi,
									:frmRelGuiaLicenc.sMarca,	 	:frmRelGuiaLicenc.sNumBancIpva3,	
									:frmRelGuiaLicenc.sNumBancIpva2,	:frmRelGuiaLicenc.sNumBancIpva1,
									:frmRelGuiaLicenc.sNumBancIpvaU,	:frmRelGuiaLicenc.sNumBancDpvat,
									:frmRelGuiaLicenc.sNumBancLicen,	:frmRelGuiaLicenc.sNumBancMultas,
									:frmRelGuiaLicenc.sInstruPag1,	:frmRelGuiaLicenc.sInstruPag2,
									:frmRelGuiaLicenc.sInstruPag3,
									:frmRelGuiaLicenc.nExercicio,		:frmRelGuiaLicenc.nSeq,
									:frmRelGuiaLicenc.sTituloLinha,	:frmRelGuiaLicenc.sSubTitLinha,
									:frmRelGuiaLicenc.nValor1,		:frmRelGuiaLicenc.nValor2,
									:frmRelGuiaLicenc.sTituloValor1,	:frmRelGuiaLicenc.sTituloValor2,
									:frmRelGuiaLicenc.dVencimento,	:frmRelGuiaLicenc.sCodBarras,
									:frmRelGuiaLicenc.sLinhaDigitavel,	:frmRelGuiaLicenc.sTipoPessoa,
									:frmRelGuiaLicenc.sObsIpva,		:frmRelGuiaLicenc.nValorTotal,
									:frmRelGuiaLicenc.sObsIpvaNotificacaoTit'
				!
				Set _sVarSQLWindows = '	frmRelGuiaLicenc.sPlaca, 		frmRelGuiaLicenc.sPropr,
									frmRelGuiaLicenc.dfsCpfCgc,		frmRelGuiaLicenc.nRenavam,
									frmRelGuiaLicenc.nAnoFabricacao,	frmRelGuiaLicenc.sChassi,
									frmRelGuiaLicenc.sMarca,	 	frmRelGuiaLicenc.sNumBancIpva3,	
									frmRelGuiaLicenc.sNumBancIpva2,	frmRelGuiaLicenc.sNumBancIpva1,
									...
									frmRelGuiaLicenc.sInstruPag1,	frmRelGuiaLicenc.sInstruPag2,
									frmRelGuiaLicenc.sInstruPag3,
									frmRelGuiaLicenc.nExercicio,		frmRelGuiaLicenc.sTituloLinha,	:frmRelGuiaLicenc.sSubTitLinha,
									frmRelGuiaLicenc.nValor1,		frmRelGuiaLicenc.nValor2,
									frmRelGuiaLicenc.sTituloValor1,	frmRelGuiaLicenc.sTituloValor2,
									frmRelGuiaLicenc.dVencimento,	frmRelGuiaLicenc.sCodBarras,
									frmRelGuiaLicenc.sLinhaDigitavel,	frmRelGuiaLicenc.sObsIpva,
									frmRelGuiaLicenc.nValorTotal,	frmRelGuiaLicenc.sObsIpvaNotificacaoTit'
				!
				Set _sVarQRP = '		Placa, 		Nome,
									CPFCGC,		Renavam,
									AnoFab,		Chassi,
									MarcaModelo,	NumBancIpva3,	
									NumBancIpva2,	NumBancIpva1,
									NumBancIpvaU,	NumBancDpvat,
									NumBancLicen,	NumBancMultas,
									InstruPag1,	InstruPag2,	InstruPag3,
									Exercicio,		
									TituloLinha,	SubTituloLinha,
									Valor1,		Valor2,
									TituloValor1,	TituloValor2,
									Vencimento,	CodBarras,
									NumDigitavel,	ObsIpva,
									ValorTotal,	ObsIpvaNotificacaoTit'
				!
			...
			On UDM_AposPesquisa
				If sTipoPessoa = 'J'
					Call SalFmtSetInputMask ( dfsCpfCgc, '99.999.999/9999-99' )
				Else If sTipoPessoa = 'F'
					Call SalFmtSetInputMask ( dfsCpfCgc, '999.999.999-99' )
				If sCodBarras != STRING_Null
					Call fCodigoBarra( sCodBarras, sCodBarras )
				Return TRUE
			On SAM_ReportFetchInit
				Call SalSendClassMessage( SAM_ReportFetchInit, wParam, lParam )
			On SAM_ReportFinish
				Call SqlPrepareAndExecute( hSql, 'cancel' )
				Call SalSendClassMessage( SAM_ReportFinish, wParam, lParam)
  