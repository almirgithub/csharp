...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmNotificacaoAdvertencia
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Notificações de ADVERTENCIAS
		Icon File:
		...
		Contents
			...
			Child Table: tblArquivos
				...
				Message Actions
					On SAM_Create
						...
						Set _sIntoPesquisa = ':frmNotificacaoAdvertencia.tblArquivos.colsArquivo,:frmNotificacaoAdvertencia.tblArquivos.colnQtdeRegistros'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			...
			! cQCK2ChildTable: tblInf
				  ...
				  Message Actions
					  On SAM_Create
						  Set _sTextoStatusBar = 'Selecione a infração para a pesquisa'
						  Set _bPesquisaCreate = TRUE
						  Set _bSempreHabilitado = TRUE
						  Set _sCriacaoConexao = 'FALSE'
						! Procedure's
						Set _sComandoAtualiza = 'exec tmpInfracaoI @Cod = :frmNotificacaoAdvertencia.tblInf.colnCod'
						  Set _sComandoPesquisa = 'exec InfracaoS_coddesc'
						! coluna para o retorno
						Set _sIntoPesquisa = ':frmNotificacaoAdvertencia.tblInf.colnCod, :frmNotificacaoAdvertencia.tblInf.colsDes'
						  Call SalSendClassMessage( SAM_Create, wParam, lParam )
					  On SAM_RowHeaderClick
						  Call SalTblSetRowFlags( hWndForm, lParam,  ROW_Edited, NOT SalTblQueryRowFlags( hWndForm, lParam, ROW_Edited ) )
					  On SAM_CornerDoubleClick
						  Call SalTblSetFlagsAnyRows( hWndForm, ROW_Edited, NOT SalTblAnyRows( hWndForm, ROW_Edited, 0 ), 0, 0 )
					! On WMSG_KEYDOWN
					! On MSG_NovaLinha
					! On MSG_RemoveLinha
					! On MSG_Desabilita1
		...
		Functions
			Function: GeraArquivo
				...
				Actions
					...
					! Call SalFileClose( hArquivo )
					! Abre Arquivo no caminho indicado pelo usuario
					...
					Else
						Set nTipoArquivo = 17
						Set nAgenteEquip = 32
					Call SybPrepareProc( hSqlApp, 'exec dbinfracao..NotificacaoAdvertencia @TipoNotificacao = :cmbTipoNotificacao,@OrgaoAutuante = 117200, @AgenteEquip=:nAgenteEquip,@TipoArqNot = :nTipoArquivo',
							':frmNotificacaoAdvertencia.nTipoArquivo,:frmNotificacaoAdvertencia.sArquivo,:frmNotificacaoAdvertencia.nQtdeRegistros,:frmNotificacaoAdvertencia.sRegistro1, :frmNotificacaoAdvertencia.sRegistro2,
							:frmNotificacaoAdvertencia.sRegistro3,
							:frmNotificacaoAdvertencia.sRegistro4,
							:frmNotificacaoAdvertencia.sRegistro5, :frmNotificacaoAdvertencia.sRegistro6,
							:frmNotificacaoAdvertencia.sRegistro7, :frmNotificacaoAdvertencia.sRegistro8,:frmNotificacaoAdvertencia.sRegistro9')
				...
				Actions 
					...
					Loop 
						...
						If NOT bFimLeitura
							...
							Call SalFilePutStr( hArquivo,
									sRegistro1||SalStrRepeatX(' ',255-SalStrLength(sRegistro1)) || sRegistro2 ||SalStrRepeatX(' ',28-SalStrLength(sRegistro2))   || sRegistro3 ||SalStrRepeatX(' ',199-SalStrLength(sRegistro3))
		...
		Message Actions
			...
			On MSG_Limpa
				...
				Call fMPSPrepareProc( hSql, 'exec ArqNotMultaNCS_ultimo',
						':frmNotificacaoAdvertencia.dfsArquivo, :frmNotificacaoAdvertencia.dfsUltimo, :frmNotificacaoAdvertencia.dfdTermino,
						:frmNotificacaoAdvertencia.sUsuario, :frmNotificacaoAdvertencia.dCriacao' )
				...
				Call fMPSPrepareProc( hSql, 'exec ArqNotMultaNCS_retoma',
						':frmNotificacaoAdvertencia.dfnTipoArq, :frmNotificacaoAdvertencia.cmbTipoArquivo, :frmNotificacaoAdvertencia.dfsArquivo, :frmNotificacaoAdvertencia.dCriacao,
						:frmNotificacaoAdvertencia.dfdNotI, :frmNotificacaoAdvertencia.dfdNotF, :frmNotificacaoAdvertencia.nRetomando' )
				If NOT SqlExecute( hSql )
					Call SalWaitCursor( FALSE )
					Return FALSE
				If NOT  SqlFetchNext( hSql, nProximo )
			...
			On MSG_Arquiva
				! If NOT SalSendMsg( tblArquivos, MSG_Arquiva, 0, 0 )
					Call SalTblSetFlagsAnyRows( tblArquivos, ROW_Edited, TRUE, ROW_Edited |  ROW_MarkDeleted, 0 )
					Call SalTblSetFlagsAnyRows( tblArquivos, ROW_MarkDeleted, FALSE, ROW_MarkDeleted, 0 )
					Return FALSE
