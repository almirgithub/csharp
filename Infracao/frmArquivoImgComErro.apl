...
0020: 0000000000AE0000 002C000000020000 0003000000FFFFFF FFFFFFFFFFF8FFFF
...
0080: 6D4172717569766F 496D67436F6D4572 726F
.enddata
...
.head 1 +  Form Window: frmArquivoImgComErro
.head 2 -  Class: cQCK1Form
.head 2 -  Property Template:
.head 2 -  Class DLL Name:
.head 2 -  Title: Consulta os Autos com pendências de retorno das imagens enviadas para o SERPRO
.head 2 -  Icon File:
...
.head 2 +  Contents
.head 3 -  !
.head 3 +  Child Table: tblAutosNotificados
...
.head 4 +  Contents
.head 5 +  Column: coldDataCriacao
.head 6 -  Class Child Ref Key: 0
.head 6 -  Class ChildKey: 0
.head 6 -  Class: cQCK2Column
.head 6 -  Property Template:
.head 6 -  Class DLL Name:
.head 6 -  Title: Data Criação
.head 6 -  Visible? Yes
...
.head 8 -  Set _sTipoMsgNulo = 'PADRAO'
.head 8 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  Column: colnQtdNotificado
.head 6 -  Class Child Ref Key: 0
.head 6 -  Class ChildKey: 0
.head 6 -  Class: cQCK2Column
.head 6 -  Property Template:
.head 6 -  Class DLL Name:
.head 6 -  Title: Qtd Notificada
.head 6 -  Visible? Yes
.head 6 -  Editable? Class Default
.head 6 -  Maximum Data Length: Class Default
...
.head 6 -  Set _sTextoStatusBar = 'Tabela de Imagens Notificadas'
.head 6 -  Set _sComandoPesquisa = 'exec dbinfracao..RetornaAutoImgS
	@ChamadaTela	=	"S" '
.head 6 -  Set _sIntoPesquisa = ' 	
	:frmArquivoImgComErro.tblAutosNotificados.colsArquivo,
	:frmArquivoImgComErro.tblAutosNotificados.coldDataCriacao,
	:frmArquivoImgComErro.tblAutosNotificados.colnQtdNotificado'
...
.head 6 -  !
.head 6 +  If NOT SalTblAnyRows( tblAutosNotificados, 0, 0 )
.head 7 -  Call SalSendClassMessage( UDM_AposPesquisa, wParam, lParam )
.head 7 -  Call SalMessageBox( "Sem notificação de imagens", "Atenção", MB_Ok | MB_IconInformation )
.head 7 -  Return FALSE
.head 6 -  Return TRUE
.head 5 +  ! On SAM_ReportNotify
.head 6 -  Set hWndReport = SalNumberToWindowHandle( wParam )
.head 6 +  If lParam = RPT_BeforePageHeader
.head 7 -  Call SqlImmediate( 'select getdate() into :frmConsImagemAutos.dCorrente' )
...
.head 3 -  !
.head 3 -  !
.head 3 +  ! cQCK1PushButton: pbPesquisa
...
.head 4 +  Message Actions
.head 5 +  On SAM_Create
.head 6 -  Set _sTextoStatusBar = 'Pesquisa os dados'
.head 6 -  Set _sTipoComando = 'Sai'
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  On SAM_Click
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 6 -  Call SalSendMsg( tblAutosNotificados, MSG_PesquisaTabela, 0, 0)
.head 3 -  !
...
.head 4 -  Call SalSendMsg( pbPesquisa, SAM_Click, 0, 0)
...
.head 5 -  Return FALSE
.head 4 -  Call SalTblReset( tblAutosNotificados )
.head 4 -  Call SalSendMsg( tblAutosNotificados, MSG_PesquisaTabela, 0, 0)
.head 4 -  Return TRUE
.head 3 +  ! On UDM_AposPesquisa
.head 4 -  !
.head 4 +  If NOT SalTblAnyRows( tblAutosNotificados, 0, 0 )
.head 5 -  Call SalSendClassMessage( UDM_AposPesquisa, wParam, lParam )
.head 5 -  Call SalMessageBox( "Sem notificação de imagens", "Atenção", MB_Ok | MB_IconInformation )
.head 5 -  Return TRUE
