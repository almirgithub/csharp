...
0020: 0000000000EA0000 002C000000020000 0003000000FFFFFF FFFFFFFFFFF8FFFF
...
0080: 6D52656C4D756C74 61734E5061676173
.enddata
...
.head 1 +  Form Window: frmRelMultasNPagas
.head 2 -  Class: cQCK1Form
.head 2 -  Property Template:
.head 2 -  Class DLL Name:
.head 2 -  Title: Relatório de Multas Não Pagas
.head 2 -  Icon File:
...
.head 6 -  Set _sConsultaFrmOpcoesCampo = 'exec dbinfracao..OrgaoAutuanteS_desc_Estan @Setor=:frmRelMultasNPagas.nSetorUsuario'
...
.head 6 -  Set _sConsultaFrmOpcoesSQLOuSP = 'SP'
.head 6 -  Set _sConsultaFrmOpcoesCampo = 'exec dbinfracao..AgenteEquipS_desc_Estan @OrgaoAutuante = :frmRelMultasNPagas.dfnOrgao, @Setor=:frmRelMultasNPagas.nSetorUsuario'
.head 6 -  Set _bComponenteChave = TRUE
...
.head 6 -  Set _sConsultaDescrição = 'exec dbinfracao..AgenteEquipS_desc_sint @Cod = :frmRelMultasNPagas.dfnAgenteEquip,
                                             @OrgaoAutuante = :frmRelMultasNPagas.dfnOrgao'
...
.head 6 -  Set _bNuncaHabilitado = TRUE
.head 6 -  Set _bÉCampoDescrição = TRUE
.head 6 -  Set _sConsultaDescrição ='exec OrgaoAutuanteS_desc_sintRest @Cod = :frmRelMultasNPagas.dfnOrgao, @SetorReduzido=:frmRelMultasNPagas.nSetorReduzido'
.head 6 -  Set _bÉDependente = TRUE
...
.head 6 +  If dfnOrgao = NUMBER_Null
.head 7 -  Call SalMessageBeep( MB_IconExclamation )
.head 7 -  Call SalMessageBox( 'Informe um Órgão Autuante', 'Atenção', MB_IconExclamation | MB_Ok )
.head 7 -  Call SalSetFocus( dfnOrgao)
.head 7 -  Return FALSE
.head 6 +  If dfnAgenteEquip = NUMBER_Null
.head 7 -  Call SalMessageBeep( MB_IconExclamation )
.head 7 -  Call SalMessageBox( 'Informe um Agente/Equipamento', 'Atenção', MB_IconExclamation | MB_Ok )
...
.head 6 -  !
.head 6 -  Set sArquivoQRP = 'MulNaoPg.qrp'
.head 6 -  !
.head 6 -  ! ! ! !
.head 6 -  Call SalTblReset( tblMultasNaoPagas )
.head 6 -  ! ! ! --- executa o _sComandoPesquisa da table
.head 6 -  Call SalSendMsg( tblMultasNaoPagas, MSG_PesquisaTabela, lParam, wParam )
.head 6 +  If NOT SalTblAnyRows( tblMultasNaoPagas, 0, 0 )
.head 7 -  Call SalWaitCursor( FALSE )
.head 7 -  Call SalMessageBox( "Sem dados para o filtro informado", "Atenção", MB_Ok | MB_IconInformation )
.head 7 -  Return FALSE
.head 6 -  ! Call ValidarQRP(sNomeQRP, lParam)
...
.head 8 -  Return FALSE
.head 7 +  Else
.head 8 -  Call SalReportTablePrint( tblMultasNaoPagas,  sArquivoQRP,nParamArray, nErro )
...
.head 8 -  Call SalReportTableView( tblMultasNaoPagas, hWndReport, sArquivoQRP, lParam )
.head 6 +  Else
.head 7 -  Call GeraArquivoFromGridView( frmRelMultasNPagas.tblMultasNaoPagas, 15,"RelMultasNaoPagas")
...
.head 6 -  Set _bSempreHabilitado = FALSE
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 +  Child Table: tblMultasNaoPagas
.data INHERITPROPS
0000: 0100
.enddata
.data CLASSPROPS
...
.head 6 -  Set _bSempreHabilitado = TRUE
.head 6 -  ! Procedure'
.head 6 -  Set _sComandoPesquisa = 'exec dbinfracao..RelMultasNaoPagas
		@OrgaoAutuante 	= :frmRelMultasNPagas.dfnOrgao,
		@DataI 		= :frmRelMultasNPagas.dfdInicial,  
		@DataF 		= :frmRelMultasNPagas.dfdFinal,
		@Saida		= "",
		@AgenteEquip	= :frmRelMultasNPagas.dfnAgenteEquip'

.head 6 -  Set _sIntoPesquisa = '
	:frmRelMultasNPagas.tblMultasNaoPagas.coldDataImplantacao, 
	:frmRelMultasNPagas.tblMultasNaoPagas.colsSerie,
	:frmRelMultasNPagas.tblMultasNaoPagas.colsAuto, 
	:frmRelMultasNPagas.tblMultasNaoPagas.colsInfracao,
	:frmRelMultasNPagas.tblMultasNaoPagas.colnValorEmUFIR,
	:frmRelMultasNPagas.tblMultasNaoPagas.colnDaUFIR ,
	:frmRelMultasNPagas.tblMultasNaoPagas.colnValorEmReal,
	:frmRelMultasNPagas.tblMultasNaoPagas.colnValorComDesc,
	:frmRelMultasNPagas.tblMultasNaoPagas.colnProtocolo,
	:frmRelMultasNPagas.tblMultasNaoPagas.colsAssunto,
	:frmRelMultasNPagas.tblMultasNaoPagas.colsDecisao'
	
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  On SAM_FetchRowDone
.head 6 -  Set frmRelMultasNPagas.tblMultasNaoPagas.colsOrgaoAutuante = frmRelMultasNPagas.dfsOrgao
.head 6 -  Set frmRelMultasNPagas.tblMultasNaoPagas.colsAgentEquip = frmRelMultasNPagas.dfsAgenteEquip
.head 6 -  Set frmRelMultasNPagas.tblMultasNaoPagas.coldDataInicial = frmRelMultasNPagas.dfdInicial
.head 6 -  Set frmRelMultasNPagas.tblMultasNaoPagas.coldDataFinal = frmRelMultasNPagas.dfdFinal
.head 6 -  !
...
.head 5 -  Call fMPSPrepareProc( hSql, 'exec RelMultasNaoPagas @OrgaoAutuante = :frmRelMultasNPagas.dfnOrgao,
@DataI = :frmRelMultasNPagas.dfdInicial,  @DataF = :frmRelMultasNPagas.dfdFinal,@Saida="A"',
':sTexto')
...
.head 6 -  Call SalReportView( frmRelMultasNPagas, hWndReport, 'MulNaoP.qrp',
...
.head 5 -  Call SalSendMsgToChildren( frmRelMultasNPagas, MSG_Limpa,wParam,lParam )
...
.head 4 -  Call SqlImmediate( 'select getdate() into :frmRelMultasNPagas.dCorrente' )
...
.head 4 -  Call SqlImmediate( 'select getdate() into :frmRelMultasNPagas.dCorrente' )
.head 4 -  Call fMPSPrepareProc( hSql, 'exec dbinfracao..RelMultasNaoPagas @OrgaoAutuante = :frmRelMultasNPagas.dfnOrgao,
@DataI = :frmRelMultasNPagas.dfdInicial,  @DataF = :frmRelMultasNPagas.dfdFinal,@Saida="",@AgenteEquip=:frmRelMultasNPagas.dfnAgenteEquip',
':frmRelMultasNPagas.dDataImplantacao, :frmRelMultasNPagas.sSerie,
:frmRelMultasNPagas.sAuto, :frmRelMultasNPagas.sInfracao,:frmRelMultasNPagas.nValorEmUFIR,
:frmRelMultasNPagas.nValorDaUFIR ,:frmRelMultasNPagas.nValorEmReal,
:frmRelMultasNPagas.nValorComDesconto,:frmRelMultasNPagas.nProtocolo,:frmRelMultasNPagas.sAssunto,:frmRelMultasNPagas.sDecisao')
