...
rojeto Divisão dos Sistemas em APL
...
.head 1 +  Form Window: frmOrgaoTranspAluguel
.head 2 -  Class: cQCK1Form
.head 2 -  Property Template:
.head 2 -  Class DLL Name:
.head 2 -  Title: Órgão de Controle de Transporte de Aluguel
.head 2 -  Icon File:
...
.head 3 +  Pushbutton: pbPesquisarOrgao
.data INHERITPROPS
0000: 0100
.enddata
.data CLASSPROPS
...
.head 4 -  Text Color: Class Default
.head 4 -  Background Color: Class Default
.head 3 +  Data Field: dfnCodigoOrgao
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
...
.head 4 +  Message Actions
.head 5 +  On SAM_Create
.head 6 -  Set _sTextoStatusBar = 'Código do Órgão de Controle de Transporte de Aluguel'
.head 6 -  Set _sNomeParaMsgs = 'Código do Órgão de Controle de Transporte de Aluguel'
.head 6 -  !
...
.head 6 -  Set _sConsultaFrmOpcoesCampo = 'exec dbvcen..OrgaoTransporteAluguelS'
.head 6 -  ! Set _sConsultaFrmOpcoesColunaOuParam = '@Descricao'
.head 6 -  !
.head 6 -  Set _bVisivel = TRUE
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 -  !
.head 3 -  Background Text: Desc. Órgão:
.head 4 -  Resource Id: 40568
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class: cQCK1BackgroundText
.head 4 -  Window Location and Size
...
.head 4 -  Text Color: Class Default
.head 4 -  Background Color: Class Default
.head 3 +  Data Field: dfsDescricaoOrgao
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class: cQCK1DataField
.head 4 -  Property Template:
...
.head 4 +  Message Actions
.head 5 +  On SAM_Create
.head 6 -  Set _sTextoStatusBar = 'Descrição do Órgão de Controle de Transporte de Aluguel'
...
.head 6 -  !
.head 6 -  Set _bVisivel = TRUE
.head 6 -  Set _sNomeParaMsgs = 'Descrição do Órgão de Controle de Transporte de Aluguel'
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 -  ! Botões
.head 3 +  Pushbutton: pbAnteriorOrgao
.data INHERITPROPS
0000: 0100
.enddata
.data CLASSPROPS
...
.head 3 +  Pushbutton: pbProximoOrgao
.data INHERITPROPS
0000: 0100
.enddata
.data CLASSPROPS
...
.head 6 -  Call SalEnableWindow( dfsDescricaoOrgao )
.head 6 -  Call SalEnableWindow( pbArquivarOrgao )
.head 6 -  Set dfnCodigoOrgao = 0
.head 6 -  Set dfsMsg = ''
.head 5 +  On SAM_Create
...
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 +  Pushbutton: pbArquivarOrgao
.data INHERITPROPS
0000: 0100
.enddata
.head 4 -  Class Child Ref Key: 0
...
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 +  Pushbutton: pbLimparOrgao
.data INHERITPROPS
0000: 0100
.enddata
.head 4 -  Class Child Ref Key: 0
...
.head 6 -  Call SalSendClassMessage( SAM_Click, wParam, lParam )
.head 6 -  ! Call SalSendMsg( hWndForm, MSG_Novo, wParam, lParam )
.head 6 -  Call SalDisableWindow( pbArquivarOrgao )
.head 6 -  Call SalEnableWindow( dfsDescricaoOrgao )
.head 6 -  Set dfsMsg = ''
.head 3 +  Pushbutton: pbExcluirOrgao
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class: cQCK1PushButton
.head 4 -  Property Template:
...
.head 4 -  Message Actions
.head 2 +  Functions
.head 3 +  Function: ContemDados
.head 4 -  Description: Consulta para verificar se existe ógão para o código informado
.head 4 -  Returns
.head 4 -  Parameters
.head 4 -  Static Variables
.head 4 -  Local variables
.head 4 +  Actions
.head 5 +  If fMPSConnect( sqlWndOrgao )
.head 6 -  If fMPSPrepareProc( sqlWndOrgao, ' dbvcen..OrgaoTransporteAluguelS @nCod = :frmOrgaoTranspAluguel.dfnCodigoOrgao ',
		':frmOrgaoTranspAluguel.dfnCodigoOrgao, :frmOrgaoTranspAluguel.dfsDescricaoOrgao')
.head 6 -  Call SqlExecute( sqlWndOrgao )
.head 6 -  Call SqlFetchNext( sqlWndOrgao, lParam )
.head 6 -  Call fMPSDisconnect( sqlWndOrgao )
.head 6 +  If dfsDescricaoOrgao = STRING_Null
.head 7 -  Return FALSE
.head 5 -  !
.head 5 -  Return TRUE
...
.head 3 -  File Handle: sqlWndOrgao
.head 2 +  Message Actions
.head 3 +  On SAM_Create
.head 4 -  Set _nEstadoInicialForm = EF_Vazio
.head 4 -  Set _sTextoStatusBar = 'Tela de cadastro de órgão de transporte de aluguel'
.head 4 -  !
.head 4 -  Set _sCriacaoConexao = 'Default'
.head 4 -  Set _sComandoPesquisa = 'exec dbvcen..OrgaoTransporteAluguelS @nCod = :frmOrgaoTranspAluguel.dfnCodigoOrgao'
.head 4 -  Set _sListaINTOPesquisa = ':frmOrgaoTranspAluguel.dfnCodigoOrgao, :frmOrgaoTranspAluguel.dfsDescricaoOrgao'
.head 4 -  !
.head 4 -  Set _bLimpaTelaAposInclusao = FALSE
.head 4 -  Set _sComandoInclusao = 'exec dbvcen..OrgaoTransporteAluguelI @nCod = :frmOrgaoTranspAluguel.dfnCodigoOrgao,
@sDescricao = :frmOrgaoTranspAluguel.dfsDescricaoOrgao'
.head 4 -  Set _sListaINTOInclusao = ':frmOrgaoTranspAluguel.dfnCodigoOrgao'
.head 4 -  !
.head 4 -  Set _bLimpaTelaAposAtualizacao = FALSE
.head 4 -  Set _sComandoAtualizacao = 'exec dbvcen..OrgaoTransporteAluguelA @nCod =  :frmOrgaoTranspAluguel.dfnCodigoOrgao,
@sDescricao = :frmOrgaoTranspAluguel.dfsDescricaoOrgao'
.head 4 -  Set _sListaINTOAtualizacao = ''
.head 4 -  !
.head 4 -  Set _bLimpaTelaAposRemocao = TRUE
.head 4 -  Set _sComandoRemocao = 'exec dbvcen..OrgaoTransporteAluguelE @nCod = :frmOrgaoTranspAluguel.dfnCodigoOrgao'
...
.head 4 -  !
.head 4 -  Call SalSendMsg( pbExcluirOrgao, MSG_Desabilita1, wParam, lParam )
.head 4 -  Call SalSendMsg( pbPesquisarOrgao, MSG_Habilita1, wParam, lParam )
.head 4 -  !
.head 4 +  If frmOrgaoTranspAluguel.fObtemPermissao('frmOrgaoTranspAluguel') = 1
.head 5 -  Call SalDisableWindow( pbArquivarOrgao )
.head 5 -  Call SalDisableWindow( pbExcluirOrgao )
.head 4 +  Else If frmOrgaoTranspAluguel.fObtemPermissao('frmOrgaoTranspAluguel') = 15
.head 5 -  Call SalEnableWindow( pbArquivarOrgao )
.head 5 -  Call SalEnableWindow( pbExcluirOrgao )
.head 3 +  On UDM_AposPesquisa
.head 4 -  ! Call SalSendClassMessage( UDM_AposPesquisa, wParam, lParam )
.head 4 +  If dfsDescricaoOrgao = STRING_Null
.head 5 -  Call SalDisableWindow( dfnCodigoOrgao )
.head 5 -  Call SalDisableWindow( dfsDescricaoOrgao )
.head 5 -  Set dfsMsg = "Não existe órgão para o código informado!"
.head 5 -  Call SalDisableWindow( pbArquivarOrgao )
.head 5 -  ! Return FALSE
.head 4 -  Return TRUE
.head 0 -  
