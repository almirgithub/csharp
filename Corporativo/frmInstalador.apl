...
0060: 000F4170706C6963 6174696F6E497465 6D02000000075769 6E646F77730D6672
0080: 6D496E7374616C61 646F72
.enddata
...
.head 2 -  File Include: frmEnderProprietario.apl
...
.head 1 +  Form Window: frmInstalador
.data INHERITPROPS
0000: 0100
.enddata
...
.head 2 -  Title: Cadastro Instalador
.head 2 -  Icon File:
...
.head 3 +  Data Field: dfnInstalador
.data INHERITPROPS
0000: 0100
.enddata
.head 4 -  Class Child Ref Key: 0
...
.head 6 -  Set _sTextoStatusBar = 'Código do proprietário'
...
.head 6 -  Set _sValorDefault = '0'
.head 6 -  Set _sMsgNulo = ''
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  ! On SAM_KillFocus
.head 6 +  If NOT SalIsNull(dfnInstalador)
.head 7 -  Call SalSendMsg( pbPesquisar, SAM_Click, 0, 0 )
.head 5 +  On MSG_MudaEstadoForm
.head 6 -  Call SalSendClassMessage( MSG_MudaEstadoForm, wParam, lParam )
.head 6 -  !
.head 6 +  If nEstadoForm & EF_Vazio
.head 7 -  Call SalPostMsg( pbNovo, MSG_Habilita1, wParam, lParam )
.head 6 +  Else
.head 7 -  Call SalPostMsg( pbNovo, MSG_Desabilita1, 0, lParam )
.head 3 -  !
.head 3 -  Background Text: CPF:
.head 4 -  Resource Id: 38864
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class:
.head 4 -  Window Location and Size
...
.head 5 +  On SAM_Create
.head 6 -  Set _bVisivel = TRUE
.head 6 -  Set _sNomeParaMsgs = 'CPF/CNPJ'
.head 6 -  Set _sTextoStatusBar = 'Número do CPF para pessoa física ou do CNPJ para pessoa jurídica'
.head 6 -  Set _bPermiteNulos = FALSE
.head 6 -  Set _bSempreHabilitado = TRUE
.head 6 -  Set _sMsgNulo = ''
.head 6 -  Set _sTipoMsgNulo = 'PADRAO'
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 6 -  Set _sTipoMsgValidacao = 'ESPECIFICO'
...
.head 7 -  Set sCPF = ''
.head 7 -  Return FALSE
.head 6 -  Call SalFmtSetInputMask ( dfsDoc, '999.999.999-99' )
.head 6 -  Return TRUE
.head 5 +  ! On UDM_ValidaCampo
.head 6 +  If NOT SalIsNull( hWndItem )
.head 7 +  If nEstadoForm = EF_Vazio
.head 8 -  Call SalSendMsg( hWndForm, MSG_Pesquisa, 0, 0 )
.head 8 -  Call SalPostMsg( hWndForm, MSG_MudaSemaforo, S_Verde, 0 )
.head 7 +  Else 
.head 8 +  If DetranHCPF( dfsDoc )
.head 9 -  Set rbCPFProp = TRUE
.head 9 -  Call SalSendMsg( rbCPFProp, SAM_Click, 0, 0 )
.head 8 +  Else If DetranHCGC( dfsDoc )
.head 9 -  Set rbCGC = TRUE
.head 9 -  Call SalSendMsg( rbCGC, SAM_Click, 0, 0 )
.head 8 +  Else 
.head 9 -  Set rbOculto = TRUE
.head 9 -  Call SalSendMsg( rbOculto, SAM_Click, 0, 0 )
.head 6 -  Return TRUE
.head 5 +  ! On MSG_Pesquisa
.head 6 -  Call SalFmtSetInputMask ( hWndItem, '99.999.999/9999-99' )
.head 6 +  ! If dfnPropTipoDoc = 2
.head 7 -  Call SalFmtSetInputMask ( hWndItem, '99.999.999/9999-99' )
.head 6 +  ! Else If dfnPropTipoDoc = 1 OR dfnPropTipoDoc = 3 OR dfnPropTipoDoc = 4
.head 7 -  Call SalFmtSetInputMask ( hWndItem, '999.999.999-99' )
.head 6 +  ! Else 
.head 7 -  Call SalFmtSetInputMask ( dfsDoc, '99999999999999' )
.head 6 -  ! Set MyValue = sDoc
.head 3 -  !
.head 3 +  Check Box: cbSituacao
.data INHERITPROPS
0000: 0100
.enddata
.data CLASSPROPS
...
.head 6 -  Set _bVisivel = TRUE
.head 6 -  Set _sNomeCampoFonte = 'sSituacao'
...
.head 5 +  On SAM_Create
.head 6 -  Set _bVisivel = TRUE
.head 6 -  Set _sTextoStatusBar = 'Descrição do proprietário'
.head 6 -  Set _sNomeParaMsgs = 'Descrição'
.head 6 -  Set _bPermiteNulos = FALSE
.head 6 -  Set _sMsgNulo = ''
.head 6 -  Set _sTipoMsgNulo = 'PADRAO'
.head 6 -  Set _bÉDependente = FALSE
.head 6 -  Set _sCamposResponsaveis[0] = 'dfnCod'
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  On UDM_ValidaCampo
.head 6 -  Return ConverteCampo( hWndItem )
.head 3 -  !
.head 3 -  Background Text: Ent. Credenciada:
.head 4 -  Resource Id: 33734
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class: cQCK1BackgroundText
.head 4 -  Window Location and Size
...
.head 4 -  Text Color: Class Default
.head 4 -  Background Color: Class Default
.head 3 +  Combo Box: cmbEntCredenciada
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
...
.head 6 -  Set _sTipoMsgNulo = 'PADRAO'
.head 6 -  Set _bSempreHabilitado = FALSE
.head 6 -  Set _sNomeParaMsgs = 'Tipo de Documento'
.head 6 -  Set _sNomeCampoCodigo = 'dfnCodEntCred'
.head 6 -  Set _sTextoStatusBar = 'Tipo de Documento'
.head 6 -  Set _sConsultaBD = 'exec dbvcen..EstabelecimentoCredCodDescS'
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  ! On SAM_Click
.head 6 -  Call SalSendClassMessage( SAM_Click, wParam, lParam )
.head 6 -  Call SalSendMsg( cmbOrgaoProp, SAM_Create, wParam, lParam )
.head 3 +  Data Field: dfnCodEntCred
.data INHERITPROPS
0000: 0100
.enddata
.head 4 -  Class Child Ref Key: 0
...
.enddata
.data CLASSPROPS
0000: 5461624368696C64 4E616D6573001200 7461624361726163 7465726973746963
0020: 610000
.enddata
.data CLASSPROPSSIZE
0000: 2300
...
.head 4 +  Message Actions
.head 5 +  ! On SAM_Create
.head 6 -  Set _sTextoStatusBar = 'Observação do veículo'
...
.head 7 -  Set sObservacao01 = SalStrLeftX( mlObservacao, 250 )
.head 7 -  Set sObservacao02 = SalStrMidX( mlObservacao, 250, 250)
.head 3 -  !
...
.head 5 +  On SAM_Create
.head 6 -  Set _sTabela = ''
.head 6 -  Set _sTextoStatusBar = 'Insere novo proprietário'
.head 6 -  Set _sTipoComando = 'Novo'
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
...
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  ! On SAM_Click
.head 6 +     If hWndEnderProprietario != hWndNULL
.head 7 -     Call SalSendMsg( hWndEnderProprietario, MSG_Sai, wParam, lParam )
.head 6 -     Call SalSendClassMessage( SAM_Click, wParam, lParam )
.head 3 -  !
.head 3 -  Frame
.head 4 -  Resource Id: 38873
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class:
.head 4 -  Window Location and Size
...
.head 3 -  String: sObservacao01
.head 3 -  String: sObservacao02
.head 3 -  String: sCPF
.head 2 +  Message Actions
.head 3 +  On SAM_Create
.head 4 -  Set _bLimpaTelaAposRemocao = TRUE
.head 4 -  Set _sTextoStatusBar = 'Cadastro de Proprietário'
.head 4 -  Set _sComandoRemocao = 'exec dbvcen..InstaladorE @nInstalador = :frmInstalador.dfnInstalador , @sCpf = :frmInstalador.dfsDoc'
.head 4 -  Set _sListaINTOAtualizacao = ''
.head 4 -  Set _bLimpaTelaAposInclusao = FALSE
.head 4 -  ! ----------------------------------------------------------------
.head 4 -  Set _sComandoInclusao = 'exec dbvcen..InstaladorI 
@nInstalador	= :frmInstalador.dfnInstalador,
@sNome	 	= :frmInstalador.dfsNome, 
@sCpf 		= :frmInstalador.dfsDoc,
@sSituacao	= :frmInstalador.sSituacao,
@nCredenciado	= :frmInstalador.dfnCodEntCred, 
@sObservacao 	= :frmInstalador.sObservacao01, 
@sObservacaoComp = :frmInstalador.sObservacao02'
.head 4 -  Set _sListaINTOInclusao = ':frmInstalador.dfnInstalador'
.head 4 -  !
.head 4 -  Set _sComandoPesquisa = 'exec dbvcen..InstaladorS 
	@nInstalador = :frmInstalador.dfnInstalador,
	@sCpf = :frmInstalador.dfsDoc'
.head 4 -  Set _sListaINTOPesquisa = 
':frmInstalador.dfnInstalador,
:frmInstalador.dfsNome, 
:frmInstalador.dfsDoc,
:frmInstalador.sSituacao,
:frmInstalador.dfnCodEntCred,
:frmInstalador.sObservacao01, 
:frmInstalador.sObservacao02'
.head 4 -  Set _nEstadoInicialForm = EF_Vazio
.head 4 -  !
.head 4 -  Set _sComandoAtualizacao = 'exec dbvcen..InstaladorA
@nInstalador	= :frmInstalador.dfnInstalador,
@sNome	 	= :frmInstalador.dfsNome, 
@sCpf 		= :frmInstalador.dfsDoc,
@sSituacao	= :frmInstalador.sSituacao,
...
.head 4 -  Call SalEnableWindow( dfsDoc )
.head 4 -  Call SalFmtSetInputMask ( dfsDoc, '99999999999' )
.head 3 +  On MSG_Limpa
.head 4 -  Call SalFmtSetInputMask ( dfsDoc, '99999999999' )
.head 4 -  Call SalSendClassMessage( MSG_Limpa, wParam, lParam )
.head 3 -  !
.head 3 +  On UDM_AntesPesquisa
.head 4 +  If dfnInstalador = NUMBER_Null and dfsDoc = STRING_Null
.head 5 -  Call SalMessageBeep( 0 )
.head 5 -  Call SalMessageBox( 'Deve ser informado o Código ou  CPF  para pesquisa!', 'Atenção', MB_IconExclamation | MB_Ok )
.head 5 -  Return FALSE
.head 4 -  Return TRUE
.head 3 +  On UDM_AntesAtualizacao
.head 4 -  !
.head 4 -  !
.head 4 +  If cbSituacao = TRUE
.head 5 -  Set sSituacao = 'S'
.head 4 +  Else
.head 5 -  Set sSituacao = 'N'
.head 4 -  !
.head 4 -  Return TRUE
...
.head 4 -  !
.head 4 -  !
.head 4 +  If sObservacao01 != STRING_Null
.head 5 -  Set mlObservacao = sObservacao01 || sObservacao02
.head 4 +  Else
.head 5 -  Set mlObservacao = STRING_Null
.head 4 -  !
.head 4 +  If sSituacao = 'S'
.head 5 -  Set cbSituacao = TRUE
.head 4 +  Else
.head 5 -  Set cbSituacao = FALSE
.head 4 -  !
.head 4 -  Return TRUE
