...
0080: 6D5365746F724465 766F6C7563616F44 6F6356656963
.enddata
...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmSetorDevolucaoDocVeic
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
			...
			Child Table: tblDevolucao
				...
				Message Actions
					On SAM_Create
						...
						! ------------------------Selecionar------------------
						!
						Set _sComandoPesquisa = 'SetorDevolucaoDocVeicS
								@nMunicipio  = :frmSetorDevolucaoDocVeic.nMunicipio,
								@nTipoDocumento = :frmSetorDevolucaoDocVeic.dfnDocumento'
						Set _sIntoPesquisa = 
								':frmSetorDevolucaoDocVeic.tblDevolucao.colnSetorReduzido, 
								:frmSetorDevolucaoDocVeic.tblDevolucao.colsSetor,
								:frmSetorDevolucaoDocVeic.tblDevolucao.colsEndereco1,
								:frmSetorDevolucaoDocVeic.tblDevolucao.colsEndereco2'
						! ------------------------Excluir------------------
						!
						Set _sComandoExclui = 'SetorDevolucaoDocVeicE
								@nMunicipio  = :frmSetorDevolucaoDocVeic.nMunicipio,
								@nTipoDocumento = :frmSetorDevolucaoDocVeic.dfnTipoDocumento'
						!
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
					On SAM_DoubleClick
						If hWndDetalhe != hWndNULL
							Call SalSendMsg(hWndDetalhe, SAM_Close, 0,0)
						Set hWndDetalhe = SalCreateWindow( frmSetorDevolucaoDocVeicDetalh, 
								frmSetorDevolucaoDocVeic, 
								nMunicipio,
								sMunicipio,
								dfnDocumento,
								cmbDocumento,
