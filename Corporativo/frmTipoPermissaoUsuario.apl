...
0060: 000F4170706C6963 6174696F6E497465 6D04000000075769 6E646F7773176672
0080: 6D5469706F506572 6D697373616F5573 756172696F0D4368 696C642057696E64
00A0: 6F77730870624C69 6D706172
.enddata
...
.head 1 +  Form Window: frmTipoPermissaoUsuario
.head 2 -  Class: cQCK1Form
.head 2 -  Property Template:
.head 2 -  Class DLL Name:
.head 2 -  Title: Permissão - Tela de Permissão ao Tipo de Permissão
.head 2 -  Icon File:
...
.head 3 -  ! -
.head 3 -  Group Box: Pesquisa
.head 4 -  Resource Id: 53453
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
...
.head 4 -  Text Color: Class Default
.head 4 -  Background Color: Class Default
.head 3 +  Data Field: dfsCodUsuario
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
...
.head 6 -  Call SalClearField(dfnCodSetor)
.head 6 -  Call SalClearField(dfsSetor)
.head 6 -  Call SalSendClassMessage( SAM_Validate, wParam, lParam )
.head 3 +  Data Field: dfsUsuario
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class: cQCK1DataField
.head 4 -  Property Template:
...
.head 6 -  Set _sCamposResponsaveis[0] = 'dfsCodUsuario'
.head 6 -  Set _sConsultaDescrição = 'exec UsuarioS_nome @Cod = :frmTipoPermissaoUsuario.dfsCodUsuario'
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 -  !
.head 3 +  Data Field: dfnCodSetor
.data INHERITPROPS
0000: 0100
.enddata
.head 4 -  Class Child Ref Key: 0
...
.head 6 -  Set _bCompChaveOpcionalParaPesquisa = TRUE
.head 6 -  !
.head 6 -  Set _sNomeParaMsgs = 'Código do setor'
.head 6 -  Set _sConsultaFrmOpcoesCampo = 'SetorS_codreddesc'
.head 6 -  Set _sConsultaFrmOpcoesSQLOuSP = 'SP'
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  On SAM_Validate
.head 6 -  Call SalClearField(dfsCodUsuario)
.head 6 -  Call SalClearField(dfsUsuario)
.head 6 -  Call SalSendClassMessage( SAM_Validate, wParam, lParam )
...
.head 6 -  Set _sCamposResponsaveis[0] = 'dfnCodSetor'
.head 6 -  Set _sConsultaDescrição = 'SetorS_desc @CodReduzido = :frmTipoPermissaoUsuario.dfnCodSetor'
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 -  ! -
.head 3 +  Child Table: tblPermissaoUsuario
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class: cQCK3ChildTable
.head 4 -  Property Template:
.head 4 -  Class DLL Name:
.head 4 -  Display Settings
.head 5 -  Window Location and Size
...
.head 4 +  Contents
.head 5 +  Column: colnisPermissao
.head 6 -  Class Child Ref Key: 0
.head 6 -  Class ChildKey: 0
.head 6 -  Class: cQCK2Column
.head 6 -  Property Template:
.head 6 -  Class DLL Name:
.head 6 -  Title: Permissão
.head 6 -  Visible? Yes
.head 6 -  Editable? Yes
...
.head 8 -  Set _bComponenteChave = FALSE
.head 8 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  Column: colnCodSetor
.head 6 -  Class Child Ref Key: 0
.head 6 -  Class ChildKey: 0
.head 6 -  Class: cQCK2Column
.head 6 -  Property Template:
.head 6 -  Class DLL Name:
.head 6 -  Title: CodSetor
.head 6 -  Visible? No
.head 6 -  Editable? Yes
.head 6 -  Maximum Data Length: Default
...
.head 6 -  Set _sComandoPesquisa = 'exec dbvcen..TipoPermissaoUsuarioS 
		@TipoPermissao 	= :frmTipoPermissaoUsuario.nTipoPermissao,
		@Usuario 	= :frmTipoPermissaoUsuario.dfsCodUsuario,
		@Setor 		= :frmTipoPermissaoUsuario.dfnCodSetor'
.head 6 -  Set _sIntoPesquisa = '
:frmTipoPermissaoUsuario.tblPermissaoUsuario.colnisPermissao,
:frmTipoPermissaoUsuario.tblPermissaoUsuario.colsCodUsuario,
:frmTipoPermissaoUsuario.tblPermissaoUsuario.colsUsuario,
:frmTipoPermissaoUsuario.tblPermissaoUsuario.colnCodSetor,
:frmTipoPermissaoUsuario.tblPermissaoUsuario.colsSetor'
.head 6 -  !
.head 6 -  ! ------------------------Atualizar---------------------
.head 6 -  !
.head 6 -  Set _sComandoAtualiza = 'exec dbvcen..TipoPermissaoUsuarioI
		@TipoPermissao 	= :frmTipoPermissaoUsuario.nTipoPermissao,
		@Usuario 	= :frmTipoPermissaoUsuario.tblPermissaoUsuario.colsCodUsuario'
.head 6 -  !
.head 6 -  ! ------------------------Inserir------------------------
.head 6 -  !
.head 6 -  ! Set _sComandoInsere = 'null'
.head 6 -  !
.head 6 -  ! ------------------------Excluir-----------------------
.head 6 -  !
.head 6 -  Set _sComandoExclui = 'exec dbvcen..TipoPermissaoUsuarioE
		@TipoPermissao 	= :frmTipoPermissaoUsuario.nTipoPermissao,
		@Usuario 	= :frmTipoPermissaoUsuario.tblPermissaoUsuario.colsCodUsuario'
.head 6 -  !
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  On SAM_FetchRowDone
.head 6 +  If colnisPermissao = '1'
.head 7 -  Call SalTblSetRowFlags( hWndItem, lParam, ROW_New, TRUE )
.head 5 -  ! -
.head 5 +  On UDM_AposPesquisa
.head 6 +  If SalTblAnyRows( tblPermissaoUsuario, 0, 0 )
.head 7 -  Call SalEnableWindow(pbArquivar)
.head 6 -  Return SalSendClassMessage( UDM_AposPesquisa, wParam, lParam )
.head 5 +  On UDM_AposInclusao
.head 6 -  Return SalSendMsg(hWndItem, MSG_PesquisaTabela,0, 0)
.head 5 +  On UDM_AposAtualizacao
.head 6 -  Return SalSendMsg(hWndItem, MSG_PesquisaTabela,0, 0)
.head 5 +  On UDM_AposRemocao
.head 6 -  Return SalSendMsg(hWndItem, MSG_PesquisaTabela,0, 0)
.head 5 -  ! -  O ACESSO SERÁ CONCEDIDO COMO SE TIVESSE SENDO ATUALIZADO A TABELA - ! 
.head 5 +  On SAM_RowHeaderClick
.head 6 +  If NOT SalTblQueryRowFlags( hWndItem, lParam,  ROW_Edited | ROW_New | ROW_MarkDeleted)
.head 7 -  Call SalTblSetRowFlags( hWndForm, lParam, ROW_Edited, TRUE )
.head 6 +  Else If SalTblQueryRowFlags( hWndItem, lParam,  ROW_Edited )
...
.head 6 +  Else If SalTblQueryRowFlags( hWndItem, lParam,  ROW_Edited )
.head 7 -  Return FALSE
.head 6 +  Else If SalTblQueryRowFlags( hWndItem, lParam,  ROW_New )
.head 7 -  Call SalTblSetRowFlags( hWndForm, lParam, ROW_New, FALSE )
.head 7 -  Call SalTblSetRowFlags( hWndForm, lParam, ROW_MarkDeleted, TRUE )
.head 6 +  Else If SalTblQueryRowFlags( hWndItem, lParam,  ROW_MarkDeleted ) and tblPermissaoUsuario.colnisPermissao = '1'
.head 7 -  Call SalTblSetRowFlags( hWndForm, lParam, ROW_MarkDeleted, FALSE )
.head 7 -  Call SalTblSetRowFlags( hWndForm, lParam, ROW_New, TRUE )
.head 6 -  Call SalEnableWindow(pbArquivar)
.head 6 -  Return TRUE
.head 3 -  ! - Botões
...
.head 6 -  Set _sTabela = 'tblPermissaoUsuario'
.head 6 -  Set nPermissao = EF_PesquisaHabilitada | EF_Vazio | EF_RegistroNovo | EF_RegistroExistente
.head 6 -  Set _bValidaCamposNulos = FALSE
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 +  ! cQCK1PushButton: pbPesquisar
.data INHERITPROPS
0000: 0100
.enddata
.data CLASSPROPS
...
.head 6 -  Call SalTblReset( tblPermissaoUsuario )
.head 6 -  Call SalPostMsg(tblPermissaoUsuario, MSG_PesquisaTabela,0, 0)
...
.head 3 -  Number: nTipoPermissao
.head 3 -  String: sTipoPermissao
.head 2 +  Window Variables
.head 3 -  Number: nSeqAnt
.head 3 -  Number: nLinhaAtual
.head 2 +  Message Actions
.head 3 +  On SAM_Create
.head 4 -  Set _sComandoPesquisa = 'null'
.head 4 -  Set _nEstadoInicialForm = EF_RegistroExistente | EF_PesquisaHabilitada
.head 4 -  Set _sTextoStatusBar = 'Cadastro de tipo de permissão por usuário'
...
.head 4 -  Call SalSetWindowText( hWndForm, 'Permissão: ' ||SalNumberToStrX( nTipoPermissao, 0 ) || '-' ||SalStrUpperX( sTipoPermissao ) )
.head 4 +  If hWndBotao != hWndNULL
.head 5 -  Call SalDisableWindow(hWndBotao)
.head 3 +  On SAM_Close
.head 4 +  If hWndBotao != hWndNULL
.head 5 -  Call SalEnableWindow( hWndBotao )
.head 3 +  On MSG_Pesquisa
.head 4 -  Return SalPostMsg(tblPermissaoUsuario, MSG_PesquisaTabela, 0, 0)
.head 0 -  
.head 0 -  
.head 0 -  
