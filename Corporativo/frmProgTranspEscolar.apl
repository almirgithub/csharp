...
0080: 6D50726F67547261 6E73704573636F6C 6172
.enddata
...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmProgTranspEscolar
.data INHERITPROPS
0000: 0100
.enddata
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Programação de Inspeção Obrigatória do Transporte Escolar
		Icon File:
					...
					! On SAM_Click
						If NOT SalIsNull( dfdDataIniPrimSemestre )
							...
							If dfdDataFimPrimSemestre < dfdDataIniPrimSemestre AND NOT SalIsNull( dfdDataFimPrimSemestre )
								...
								Call SalClearField( dfdDataIniPrimSemestre )
								Return VALIDATE_Cancel
						Else If NOT SalIsNull( dfdDataFimPrimSemestre )
							If NOT (SalIsValidDateTime( dfdDataFimPrimSemestre ))
								Call SalMessageBeep( 0 )
								Call SalMessageBox( 'Data inválida.', 'Atenção', MB_Ok | MB_IconExclamation )
								Call SalClearField( dfdDataFimPrimSemestre )
							...
							Else If dfdDataFimPrimSemestre < dfdDataIniPrimSemestre
								...
								Call SalClearField( dfdDataFimPrimSemestre )
								Return VALIDATE_Cancel
						Else If NOT SalIsNull( dfdDataIniSegSemestre )
							If NOT (SalIsValidDateTime( dfdDataIniSegSemestre ))
								Call SalMessageBeep( 0 )
								Call SalMessageBox( 'Data inválida.', 'Atenção', MB_Ok | MB_IconExclamation )
								Call SalClearField( dfdDataIniSegSemestre )
							...
							If dfdDataFimSegSemestre < dfdDataIniSegSemestre AND NOT SalIsNull( dfdDataFimSegSemestre )
								...
								Call SalClearField( dfdDataIniSegSemestre )
								Return VALIDATE_Cancel
						Else If NOT SalIsNull( dfdDataFimSegSemestre )
							If NOT (SalIsValidDateTime( dfdDataFimSegSemestre ))
								Call SalMessageBeep( 0 )
								Call SalMessageBox( 'Data inválida.', 'Atenção', MB_Ok | MB_IconExclamation )
								Call SalClearField( dfdDataFimSegSemestre )
...
.enddata
		...
		Message Actions
			On SAM_Create
				...
				Set _sTextoStatusBar = 'Tela de Cadastro de Programação de Transporte Escolar'
				!
				Set _sCriacaoConexao = 'Default'
				Set _sComandoPesquisa = 'exec ProgramacaoTranspEscolarS @nExercicio = :frmProgTranspEscolar.dfnExercicio'
				Set _sListaINTOPesquisa =
						':frmProgTranspEscolar.dfnExercicio,
						:frmProgTranspEscolar.dfdDataIniPrimSemestre,
						:frmProgTranspEscolar.dfdDataFimPrimSemestre,
						:frmProgTranspEscolar.dfdDataIniSegSemestre,
						:frmProgTranspEscolar.dfdDataFimSegSemestre'
				!
				Set _bLimpaTelaAposInclusao = FALSE
				Set _sComandoInclusao = 'exec ProgramacaoTranspEscolarI @nExercicio = :frmProgTranspEscolar.dfnExercicio,
						@dDataIniPrimSemestre = :frmProgTranspEscolar.dfdDataIniPrimSemestre,
						@dDataFimPrimSemestre = :frmProgTranspEscolar.dfdDataFimPrimSemestre,
						@dDataIniSegSemestre = :frmProgTranspEscolar.dfdDataIniSegSemestre,
						@dDataFimSegSemestre = :frmProgTranspEscolar.dfdDataFimSegSemestre'
				Set _sListaINTOInclusao = ':frmProgTranspEscolar.dfdDataAtualiz,:frmProgTranspEscolar.dfsUsuario'
				!
				Set _bLimpaTelaAposAtualizacao = FALSE
				Set _sComandoAtualizacao = 'exec ProgramacaoTranspEscolarA @nExercicio = :frmProgTranspEscolar.dfnExercicio,
						@dDataIniPrimSemestre = :frmProgTranspEscolar.dfdDataIniPrimSemestre,
						@dDataFimPrimSemestre = :frmProgTranspEscolar.dfdDataFimPrimSemestre,
						@dDataIniSegSemestre = :frmProgTranspEscolar.dfdDataIniSegSemestre,
						@dDataFimSegSemestre = :frmProgTranspEscolar.dfdDataFimSegSemestre'
				Set _sListaINTOAtualizacao = ':frmProgTranspEscolar.dfdDataAtualiz,:frmProgTranspEscolar.dfsUsuario'
				!
				Set _bLimpaTelaAposRemocao = TRUE
				Set _sComandoRemocao = 'exec ProgramacaoTranspEscolarE @nExercicio = :frmProgTranspEscolar.dfnExercicio'
			...
			On SAM_CreateComplete
				...
				!
				Call SalSendMsg( pbExcluir, MSG_Desabilita1, wParam, lParam )
				Call SalSendMsg( pbPesquisar, MSG_Habilita1, wParam, lParam )
				!
				If frmProgTranspEscolar.fObtemPermissao('frmProgTranspEscolar') = 1
					Call SalDisableWindow( pbArquivar )
					Call SalDisableWindow( pbExcluir )
				Else If frmProgTranspEscolar.fObtemPermissao('frmProgTranspEscolar') = 15
