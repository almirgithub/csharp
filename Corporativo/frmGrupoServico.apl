...
0020: 0000000000370100 002C000000020000 0003000000FFFFFF FFFFFFFFFFF8FFFF
...
0080: 6D477275706F5365 727669636F
.enddata
...
.enddata
	...
	Libraries
		...
		File Include: frmTipoCaracteristicaEscopo.apl
	Global Declarations
		Window Defaults
			Tool Bar
...
.enddata
	...
	Form Window: frmGrupoServico
		...
		Description: 13/03/2014 - Pedro Borba (pcbs)  - Tela de Cadastro dos Grupos de Serviço
		Named Menus
		Menu
		Tool Bar
			Display Settings
		...
		Contents
			Data Field: dfnCodigo
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Código do Grupo de Serviço'
			...
			Data Field: dfsDescricao
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Descrição do Grupo de Serviço'
						Set _sNroCamposIgnorados = 'NENHUM'
						!
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
					On SAM_Click
						If dfsDescricao = STRING_Null
							Call SalMessageBox( 'O Campo Descrição é Obrigatório!', 'Atenção', MB_IconExclamation | MB_Ok )
						Else
							Call SalSendMsg( hWndItem, SAM_Create, wParam, lParam )
						Call SalSendClassMessage( SAM_Click, wParam, lParam )
			Pushbutton: pbLimpa
.data INHERITPROPS
0000: 0100
...
.enddata
		...
		Window Variables
			Number: nRetorno
			Window Handle: hWndEscopo
		Message Actions
			On SAM_Create
				Set _nEstadoInicialForm = EF_Vazio
				Set _sTextoStatusBar = 'Tela de Cadastro de Grupos de Serviço'
				!
				! Set _sCriacaoConexao = 'Default'
				Set _sCriacaoConexao = 'TRUE'
				Set _sComandoPesquisa = 'exec GrupoServicoS @nGrupoServico = :frmGrupoServico.dfnCodigo'
				Set _sListaINTOPesquisa = 
							':frmGrupoServico.dfnCodigo,
						               :frmGrupoServico.dfsDescricao'
				!
				Set _bLimpaTelaAposInclusao = FALSE
				Set _sComandoInclusao = 'exec GrupoServicoI
							@sDescricao = :frmGrupoServico.dfsDescricao'
				Set _sListaINTOInclusao = ':frmGrupoServico.dfnCodigo'
				!
				Set _bLimpaTelaAposAtualizacao = FALSE
				Set _sComandoAtualizacao = 'exec GrupoServicoA 
							@nGrupoServico = :frmGrupoServico.dfnCodigo,
							@sDescricao = :frmGrupoServico.dfsDescricao'
				Set _sListaINTOAtualizacao = ''
				!
				Set _bLimpaTelaAposRemocao = TRUE
				Set _sComandoRemocao = 'exec GrupoServicoE @nGrupoServico = :frmGrupoServico.dfnCodigo'
			...
			On SAM_CreateComplete
				...
				!
				! If frmTipoCaracteristica.fObtemPermissao('frmTipoCaracteristica') = 1
					Call SalDisableWindow( pbArquivar )
					Call SalDisableWindow( pbExcluir )
				! Else If frmTipoCaracteristica.fObtemPermissao('frmTipoCaracteristica') = 15
