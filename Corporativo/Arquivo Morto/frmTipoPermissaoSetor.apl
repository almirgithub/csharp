...
0020: 00000000002D0100 002C000000020000 0003000000FFFFFF FFFFFFFFFFF8FFFF
...
0080: 6D5469706F506572 6D697373616F5365 746F72
.enddata
...
.head 1 +  Form Window: frmTipoPermissaoSetor
.data INHERITPROPS
0000: 0100
.enddata
...
.head 2 -  Title: Tela de permissões associadas a setores
.head 2 -  Icon File:
...
.head 3 -  ! -
.head 3 +  List Box: lbSetoresNaoPermitidos
.data CLASSPROPSSIZE
0000: 1D00
.enddata
.data CLASSPROPS
...
.head 6 -  Set _sTextoStatusBar = 'Lista dos setores que não são permitidos para esse tipo de permissão'
...
.head 6 -  Set _sComandoPesquisa = 'exec dbvcen..TipoPermissaoSetorS @TipoPermissao = :frmTipoPermissaoSetor.nTipoPermissao, @TipoRetorno = "SNP" '
...
.head 6 -  Set _sNomeCampoFonte = 'dfnlb1'
.head 6 -  Set _sComandoPesquisa = 'exec MunicipioParalisacaoOutrosS @ParalisacaoDetran = :frmTipoPermissaoSetor.nTipoPermissao, @UF = :frmTipoPermissaoSetor.cmbUF'
.head 6 -  Set _bPopulaNaCriacao = TRUE
.head 6 -  Set _sCmdTransfEntreListas = 'pbDireita'
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 +  List Box: lbSetoresPermitidos
.data CLASSPROPSSIZE
0000: 1D00
.enddata
.data CLASSPROPS
...
.head 5 +  On SAM_Create
.head 6 -  Set _bVisivel = TRUE
.head 6 -  Set _sTextoStatusBar = 'Lista dos setores permitidos para esse tipo de permissão'
.head 6 -  Set _sNomeParaMsgs = 'Municípios Associados ao Setor'
.head 6 -  Set _sTipoMsgNulo = 'PADRAO'
.head 6 -  Set _bPermiteNulos = TRUE
.head 6 -  Set _sNomeCampoFonte = 'dfnlb2'
.head 6 -  Set _sComandoPesquisa = 'exec dbvcen..TipoPermissaoSetorS @TipoPermissao = :frmTipoPermissaoSetor.nTipoPermissao, @TipoRetorno = "SP" '
.head 6 -  Set _sComandoInclusao = 'exec dbvcen..TipoPermissaoSetorI @TipoPermissao = :frmTipoPermissaoSetor.nTipoPermissao, @Setor = ^'
.head 6 -  Set _sComandoRemocao = 'exec dbvcen..TipoPermissaoSetorE @TipoPermissao = :frmTipoPermissaoSetor.nTipoPermissao, @Setor = ^'
.head 6 -  Set _bPopulaNaCriacao = TRUE
.head 6 -  Set _sCmdTransfEntreListas = 'pbEsquerda'
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  ! On SAM_CreateComplete
.head 6 -  Set _sNomeCampoFonte = 'dfnlb2'
.head 6 -  Set _sComandoPesquisa = 'exec MunicipioParalisacaoPesquisaS @ParalisacaoDetran = :frmTipoPermissaoSetor.nTipoPermissao, @UF = :frmTipoPermissaoSetor.cmbUF '
.head 6 -  Set _bPopulaNaCriacao = TRUE
.head 6 -  Set _sCmdTransfEntreListas = 'pbEsquerda'
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 -  ! -
...
.head 6 -  Set _sListaOrigem = 'lbSetoresNaoPermitidos'
.head 6 -  Set _sListaDestino = 'lbSetoresPermitidos'
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
...
.head 6 -  ! Set _nPermissao = EF_RegistroExistente
.head 6 -  Set _sListaOrigem = 'lbSetoresPermitidos'
.head 6 -  Set _sListaDestino = 'lbSetoresNaoPermitidos'
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 -  ! - Botões (ações comuns)
...
.head 6 -  Set _bNuncaHabilitado = TRUE
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 -  ! - Campos background
.head 3 -  Background Text: Setores não Permitidos
...
.head 4 -  Text Color: Class Default
.head 4 -  Background Color: Class Default
.head 3 -  Background Text: Setores Permitidos
...
.head 4 -  Set _sTextoStatusBar = 'Tela de permissões associadas a setores'
