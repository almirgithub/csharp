...
0020: 0000000000C60000 002C000000020000 0003000000FFFFFF FFFFFFFFFFF8FFFF
...
0080: 6D5365746F724465 766F6C7563616F42 616972726F446F63 56656963
.enddata
...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmSetorDevolucaoBairroDocVeic
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Cadastro Setor de Devolução
		Icon File:
		...
		Description: Autor
			! Tela de cadastro de Paralisação do Sistema. Analista : Rafael Perrusi Oliveira
								               Data : 11.09.2008	
		Named Menus
		Menu
		Tool Bar
...
.enddata
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Tipo de documento'
						Set _bPermiteNulos = FALSE
						Set _bSempreHabilitado = TRUE
						Set _bVisivel = TRUE
						Set _sNomeParaMsgs = 'Documento'
						Set _sNomeCampoCodigo = 'dfnDocumento'
						Set _sConsultaBD = 'exec TipoDocumentoS_cod_sig_desc'
						Set _sRefresh = 'Create'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
					On SAM_Click
						Call SalSendClassMessage( SAM_Click, wParam, lParam )
						Call SalSendMsg( tblDevolucao, MSG_PesquisaTabela, 0, 0)
						Call SalSendMsg( pbNovo, MSG_Habilita1, 0, 0 )
			!
			Child Table: tblDevolucao
				Class Child Ref Key: 0
				Class ChildKey: 0
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Dê duplo clique na linha para alterar ou excluir um endereço'
						! ------------------------Selecionar------------------
						!
						Set _sComandoPesquisa = 'SetorDevolucaoBairroDocVeicS
								@nBairro  = :frmSetorDevolucaoBairroDocVeic.nBairro,
								@nMunicipio  = :frmSetorDevolucaoBairroDocVeic.nMunicipio,
								@nTipoDocumento = :frmSetorDevolucaoBairroDocVeic.dfnDocumento'
						Set _sIntoPesquisa = 
								':frmSetorDevolucaoBairroDocVeic.tblDevolucao.colnSetorReduzido, 
								:frmSetorDevolucaoBairroDocVeic.tblDevolucao.colsSetor,
								:frmSetorDevolucaoBairroDocVeic.tblDevolucao.colsEndereco1,
								:frmSetorDevolucaoBairroDocVeic.tblDevolucao.colsEndereco2'
						! ------------------------Excluir------------------
						!
						Set _sComandoExclui = 'SetorDevolucaoDocVeicE
								@nBairro  = :frmSetorDevolucaoBairroDocVeic.nBairro,
								@nMunicipio  = :frmSetorDevolucaoBairroDocVeic.nMunicipio,
								@nTipoDocumento = :frmSetorDevolucaoBairroDocVeic.dfnTipoDocumento'
						!
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
					On SAM_DoubleClick
						If hWndDetalhe != hWndNULL
							Call SalSendMsg(hWndDetalhe, SAM_Close, 0,0)
						Set hWndDetalhe = SalCreateWindow( frmSetorDevoBairroDocVeicDetal, 
								frmSetorDevolucaoBairroDocVeic, 
								nMunicipio,
								sMunicipio,
								nBairro,
								sBairro,
								dfnDocumento,
								cmbDocumento,
								tblDevolucao.colnSetorReduzido,
								tblDevolucao.colsSetor,
								tblDevolucao.colsEndereco1,
								tblDevolucao.colsEndereco2,
								 tblDevolucao,
								"EF_RegistroExistente",
								pbNovo,
								hWndDetalhe )
			! - Botões
			Pushbutton: pbNovo
...
.enddata
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Insere um novo Registro'
...
.enddata
		...
		Window Parameters
			...
			Receive Window Handle: hWndTelaQueChamou
		Window Variables
			Window Handle: hWndDetalhe
		Message Actions
			On SAM_Create
				Set _nEstadoInicialForm = EF_Vazio
				Set _sTextoStatusBar = 'Cadastro setor de devolução!'
				Call SalSendClassMessage( SAM_Create, wParam, lParam )
			...
			On SAM_CreateComplete
				...
				Set dfsBairro = sBairro
				! - Bloqueia o botão que chamou a tela
				Call SalPostMsg( hWndBotao, MSG_Desabilita1, 0, 0 )
			On SAM_Destroy
				! -  Se a tela de cadastro de novo endereço estiver aberta, fecha e limpa o handle
				If hWndDetalhe != hWndNULL
					Call SalSendMsg( hWndDetalhe, MSG_Sai, 0, 0 )
					Set hWndDetalhe = hWndNULL
				! - Hablita o botão que chamou a tela
				Call SalPostMsg( hWndBotao, MSG_Habilita1, 0, 0 )
				! - Seta o handle para nulo da tela que chamou
				Set hWndTelaQueChamou = hWndNULL
				Call SalSendClassMessage( SAM_Destroy, wParam, lParam )
			On MSG_Limpa
				Call SalPostMsg( hWndForm, SAM_CreateComplete, 0, 0)
				Call SalSendMsg( pbNovo, MSG_Desabilita1, 0, 0 )
				Return TRUE 
