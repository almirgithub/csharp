...
0080: 6D4C6F675469706F 5472616E73706F72 7465416C75677565 6C
.enddata
...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmLogTipoTransporteAluguel
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Consulta de log de configuração de transporte de aluguel
		Icon File:
					...
					On SAM_Validate
						If NOT SalIsNull( dfdDataFim )
							...
							Else If dfdDataFim < dfdDataIni
								...
								Return VALIDATE_Cancel
						! Call SalSendClassMessage( SAM_Validate, wParam, lParam )
			Child Table: tblLogTipoTransporteAluguel
				Class Child Ref Key: 0
				Class ChildKey: 0
				...
				Message Actions
					On SAM_Create
						...
						Set _sComandoPesquisa = 'exec dbvcen..LogTipoTransporteAluguelS
								@DataInicial =:frmLogTipoTransporteAluguel.dfdDataIni,
								@DataFinal =:frmLogTipoTransporteAluguel.dfdDataFim,
								@Categoria =:frmLogTipoTransporteAluguel.dfnCategoria,
								@ComplCategoria =:frmLogTipoTransporteAluguel.dfnComplCategoria'
								
						Set _sIntoPesquisa = 
								':frmLogTipoTransporteAluguel.tblLogTipoTransporteAluguel.colsUsuario,
								:frmLogTipoTransporteAluguel.tblLogTipoTransporteAluguel.coldDataOperacao,
								:frmLogTipoTransporteAluguel.tblLogTipoTransporteAluguel.colsDescricaoOperacao,
								:frmLogTipoTransporteAluguel.tblLogTipoTransporteAluguel.colsCategoria,
								:frmLogTipoTransporteAluguel.tblLogTipoTransporteAluguel.colsComplCategoria,
								:frmLogTipoTransporteAluguel.tblLogTipoTransporteAluguel.colsTipo,
								:frmLogTipoTransporteAluguel.tblLogTipoTransporteAluguel.colnIdadeMaxima,
								:frmLogTipoTransporteAluguel.tblLogTipoTransporteAluguel.colnIdadeMaximaSubst,
								:frmLogTipoTransporteAluguel.tblLogTipoTransporteAluguel.colnCapacidMaxPassag,
								:frmLogTipoTransporteAluguel.tblLogTipoTransporteAluguel.colsExigeAutorizacao,
								:frmLogTipoTransporteAluguel.tblLogTipoTransporteAluguel.colsExigeOficio,
								:frmLogTipoTransporteAluguel.tblLogTipoTransporteAluguel.colnCorVeiculo ,
								:frmLogTipoTransporteAluguel.tblLogTipoTransporteAluguel.colnRestricao'
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Set _sTabela = 'tblLogTipoTransporteAluguel'
...
.enddata
			...
			Combo Box: cmbComplemento
				...
				Message Actions
					On SAM_Create
						...
						!
						Set _sConsultaBD = 'exec ComplementoCategoriaS_coddesc @Categoria = :frmLogTipoTransporteAluguel.dfnCategoria'
						!
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
		Functions
		Window Parameters
		...
		Message Actions
			On SAM_Create
				...
				Call SalSendClassMessage( SAM_Create, wParam, lParam )
				Call SalCenterWindow( frmLogTipoTransporteAluguel )
