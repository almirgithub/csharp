...
0080: 6D5365746F724465 766F6C7563616F44 6F63566569634465 74616C68
.enddata
...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmSetorDevolucaoDocVeicDetalh
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Detalhe Endereço Setor Devolução
		Icon File:
...
.enddata
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Código do setor'
						!
						Set _bVisivel = TRUE
						Set _bPermiteNulos = TRUE
						...
						Set _sConsultaFrmOpcoesCampo = 'SetorS_codreddesc'
					...
					On UDM_ValidaCampo
						If NOT SalIsNull( hWndItem )
							Set nSetor = SalNumberTruncate( dfnSetor/10, 5, 0 )
							If (SalNumberMod(dfnSetor, 10)  != DigitoModulo11( nSetor ) )
								Return FALSE
						Return TRUE
			Data Field: dfsSetor
.data INHERITPROPS
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Set _sConsultaDescrição = 'SetorS_desc @CodReduzido = :frmSetorDevolucaoDocVeicDetalh.dfnSetor'
						Set _sValorDefault = ''
						!
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			!
			Background Text: Endereço 1:
				Resource Id: 40519
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class: cQCK1BackgroundText
			...
			Multiline Field: mlEndereco1
				...
				Message Actions
					On SAM_Create
						...
						Set _sTextoStatusBar = 'Local para inserção do Endereço1'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			!
			Background Text: Endereço 2:
				Resource Id: 48269
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class: cQCK1BackgroundText
			...
			Multiline Field: mlEndereco2
				...
				Message Actions
					On SAM_Create
						...
						Set _bSempreHabilitado = TRUE
						Set _sNomeParaMsgs = 'Descrição'
						Set _sTextoStatusBar = 'Local para inserção do Endereço2'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			!
...
.enddata
		...
		Window Parameters
			Number: nMunicipio
			String: sMunicipio
			Number: nTipoDocumento
			String: sDocumento
			Number: nSetor
			String: sSetor
			String: sEndereco1
			String: sEndereco2
			! - Controle da tela que chamou
			Window Handle: hWndTabela
			String: EstadoInicialForm
			Window Handle: hWndBotao
			Window Handle: hWndTelaQueChamou
		Window Variables
		Message Actions
			On SAM_Create
				! - Seta o estado do form para v se é novo ou existente. Dessa forma podendo arquivar um novo registro
				If EstadoInicialForm = 'EF_RegistroExistente'
					Set _nEstadoInicialForm = EF_RegistroExistente
				Else If EstadoInicialForm = 'EF_RegistroNovo'
					Set _nEstadoInicialForm = EF_RegistroNovo
				!
				Set _sTextoStatusBar = 'Tela de cadastro de Motivos para Reprovação'
				!
				Set _bLimpaTelaAposInclusao = FALSE
				Set _sComandoInclusao = 'exec dbvcen..SetorDevolucaoDocVeicI
						@nMunicipio = :frmSetorDevolucaoDocVeicDetalh.nMunicipio,
						@nTipoDocumento = :frmSetorDevolucaoDocVeicDetalh.nTipoDocumento,
						@nSetor = :frmSetorDevolucaoDocVeicDetalh.dfnSetor,
						@sEndereco1 = :frmSetorDevolucaoDocVeicDetalh.mlEndereco1,
						@sEndereco2 = :frmSetorDevolucaoDocVeicDetalh.mlEndereco2'
				Set _sListaINTOInclusao = ''
				!
				Set _bLimpaTelaAposAtualizacao = FALSE
				Set _sComandoAtualizacao = 'exec dbvcen..SetorDevolucaoDocVeicA
						@nMunicipio = :frmSetorDevolucaoDocVeicDetalh.nMunicipio,
						@nTipoDocumento = :frmSetorDevolucaoDocVeicDetalh.nTipoDocumento,
						@nSetor = :frmSetorDevolucaoDocVeicDetalh.dfnSetor,
						@sEndereco1 = :frmSetorDevolucaoDocVeicDetalh.mlEndereco1,
				...
				Set _sComandoRemocao = 'exec dbvcen..SetorDevolucaoDocVeicE
						@nMunicipio = :frmSetorDevolucaoDocVeicDetalh.nMunicipio,
						@nTipoDocumento = :frmSetorDevolucaoDocVeicDetalh.nTipoDocumento,
						@nSetor = :frmSetorDevolucaoDocVeicDetalh.dfnSetor'
			...
			On SAM_CreateComplete
				...
				! - Seta as variaveis nos databox
				Set dfsMunicipio = sMunicipio
				Set dfsDocumento = sDocumento
				Set dfnSetor = nSetor
				Set dfsSetor = sSetor
				Set mlEndereco1 = sEndereco1
				Set mlEndereco2 = sEndereco2
				! - Vê o estado do form. Se for novo, libera o setor para registro, caso não, deixa travado. 
				If EstadoInicialForm = 'EF_RegistroExistente'
					Call SalPostMsg( dfnSetor, MSG_Desabilita1, 0, 0 )
				Else If EstadoInicialForm = 'EF_RegistroNovo'
					Call SalPostMsg( dfnSetor, MSG_Habilita1, 0, 0 )
				! - Desabilita o botão que chamou a tela
				Call SalPostMsg( hWndBotao, MSG_Desabilita1, 0, 0 )
			On SAM_Destroy
				Call SalSendClassMessage( SAM_Destroy, wParam, lParam )
				! - Atualiza a tabela da tela que chamou ao fechar a tela
				Call SalPostMsg( hWndTabela, MSG_PesquisaTabela, 0, 0 )
				! - Habilita o botão que chamou a tela
				Call SalPostMsg( hWndBotao, MSG_Habilita1, 0, 0 )
				! - Seta o handle da tela que chamou para nulo
				Set hWndTelaQueChamou = hWndNULL
			On UDM_AposInclusao
				! - Depois que incluiu faz o refresh na tabela que chamou e sai da tela de detalhe
				Call SalPostMsg( hWndTabela, MSG_PesquisaTabela, 0, 0 )
				Call SalSendMsg( hWndForm, MSG_Sai, 0, 0 )
			On UDM_AposAtualizacao
				! - Depois que alterou faz o refresh na tabela que chamou
				Call SalPostMsg( hWndTabela, MSG_PesquisaTabela, 0, 0 )
			On UDM_AposRemocao
				! - Depois que excluiu faz o refresh na tabela que chamou e sai da tela de detalhe
				Call SalPostMsg( hWndTabela, MSG_PesquisaTabela, 0, 0 )
				Call SalSendMsg( hWndForm, MSG_Sai, 0, 0 )
  