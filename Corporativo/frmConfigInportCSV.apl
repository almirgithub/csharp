...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmConfigInportCSV
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Configuração do Caminho de Importação dos Arquivos CSV
		Icon File:
		...
		Contents
			Picture: picSemaforo
				...
				Background Color: Class Default
				Message Actions
			List Box: lbLocalizarArquivoErro
				...
				Message Actions
					On SAM_Click
						Set dfsDiretorioErro = lbLocalizarArquivoErro.GetSelectedDir(  )
			Group Box: Diretório Sem Erro
				Resource Id: 40425
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class:
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
					On SAM_Click
						Call SalSetProfileString(  "CSV", "DiretorioErro", dfsDiretorioErro, "C:\\AplicDETRAN\\Veiculo\\CSV.ini" )
						Call SalSetProfileString(  "CSV", "DiretorioOk", dfsDiretorioOk, "C:\\AplicDETRAN\\Veiculo\\CSV.ini" )
			Pushbutton: pbSair
.data INHERITPROPS
0000: 0100
.enddata
			...
			List Box: lbLocalizarArquivoOk
				...
				Message Actions
					On SAM_Click
						Set dfsDiretorioOk = lbLocalizarArquivoOk.GetSelectedDir(  )
		Functions
		Window Parameters
		Window Variables
		Message Actions
			On SAM_Create
				...
				Set _sTextoStatusBar = 'Configuração do Caminho de Importação dos Arquivos CSV'
				!
				Call SalSendClassMessage( SAM_Create, wParam, lParam )
