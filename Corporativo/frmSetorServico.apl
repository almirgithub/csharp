...
0020: 00000000004A0100 002C000000020000 0003000000FFFFFF FFFFFFFFFFF8FFFF
...
0080: 6D5365746F725365 727669636F
.enddata
...
.head 2 -  File Include: frmUsuarioServicoAtendimento.apl
...
.head 1 +  Form Window: frmSetorServico
.head 2 -  Class: cQCK1Form
.head 2 -  Property Template:
.head 2 -  Class DLL Name:
.head 2 -  Title: Serviços Associados ao Setor
.head 2 -  Icon File:
...
.head 6 -  Set _sComandoPesquisa = 'exec SetorServicoNaoAssociadoS @Setor = :frmSetor.dfnCod'
.head 6 -  Set _bPopulaNaCriacao = TRUE
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 -  Background Text: Serviços
...
.head 4 -  Text Color: Class Default
.head 4 -  Background Color: Class Default
.head 3 -  Background Text: Serviços  Associados ao Setor
...
.head 6 -  Set _sComandoPesquisa = 'exec SetorServicoAssociadoS @Setor = :frmSetor.dfnCod'
.head 6 -  Set _sComandoInclusao = 'exec SetorServicoI  @TipoServico = ^, @Setor = :frmSetor.dfnCod'
.head 6 -  Set _sComandoRemocao = 'exec SetorServicoD  @TipoServico = ^, @Setor = :frmSetor.dfnCod'
.head 6 -  ! Nayche 19/06/03 (Botao para passar todos de uma vez só)
.head 6 -  Set _sNroCamposIgnorados = 'NENHUM'
.head 6 -  !
.head 6 -  Set _bPermiteNulos = TRUE
