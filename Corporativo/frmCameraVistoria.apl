...
0080: 6D43616D65726156 6973746F726961
.enddata
...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmCameraVistoria
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Câmera de Vistoria
		Icon File:
		...
		Description: Alterado: 20/06/2013 - Marcelo Silva(marcelom)  - adicionado Pesquisa Instantânea para os campo Setor
		Named Menus
		Menu
		Tool Bar
			Display Settings
		...
		Contents
			Data Field: dfnCodigo
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Código da Finalidade'
						...
						! Set _sConsultaFrmOpcoesCampo = 'Exec dbvcen..CameraVistoriaCodDescS'
						Set _bVisivel = TRUE
			...
			Data Field: dfsBox
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Descrição da Câmera'
						Set _sNroCamposIgnorados = 'NENHUM'
						!
...
.enddata
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Número do setor'
						Set _sNomeParaMsgs = 'Setor'
						Set _bVisivel = TRUE
						! Alteração - 20/06/2013 - Marcelo Silva -  Adicionado Pesquisa Instantânea para Setor
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Set _sConsultaDescrição = 'exec SetorS_desc @CodReduzido = :frmCameraVistoria.dfnSetor'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			Radio Button: rbDianteira
.data CLASSPROPSSIZE
0000: 1E00
.enddata
.data CLASSPROPS
...
.enddata
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Clique para indicar que o tipo da camêra é para captura de foto Dianteira.'
						Set _sNomeParaMsgs = 'Tipo Foto'
						Set _bVisivel = TRUE
						...
						Set _sNomeCampoFonte = 'dfsTipoFoto'
						Set _sValorCampoFonte = 'D'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			Radio Button: rbTraseira
.data CLASSPROPSSIZE
0000: 2000
.enddata
.data CLASSPROPS
...
.enddata
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Clique para indicar que o tipo da camêra é para captura de foto Traseira.'
						Set _sNomeParaMsgs = 'Tipo Foto'
						Set _bVisivel = TRUE
						Set _bPermiteNulos = TRUE
						Set _bNuncaHabilitado = FALSE
			...
			Data Field: dfsCaminho
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Caminho da Câmera'
						Set _sNroCamposIgnorados = 'NENHUM'
						!
						Set _bNuncaHabilitado = FALSE
						Set _bPermiteNulos = FALSE
...
.enddata
		...
		Message Actions
			On SAM_Create
				...
				Set _sTextoStatusBar = 'Tela de cadastro de Câmeras de Vistoria'
				!
				Set _sCriacaoConexao = 'Default'
				Set _sComandoPesquisa = 'exec CameraVistoriaS @nCod = :frmCameraVistoria.dfnCodigo'
				Set _sListaINTOPesquisa =
						':frmCameraVistoria.dfnCodigo,
						:frmCameraVistoria.dfsBox,
						:frmCameraVistoria.dfnSetor,
						:frmCameraVistoria.dfsSetor,
						:frmCameraVistoria.dfsTipoFoto,
						:frmCameraVistoria.dfsCaminho'
				!
				Set _bLimpaTelaAposInclusao = FALSE
				Set _sComandoInclusao = 'exec CameraVistoriaI @nCod = :frmCameraVistoria.dfnCodigo,
						@sBox = :frmCameraVistoria.dfsBox, @nSetor = :frmCameraVistoria.dfnSetor,
						@sTipoFoto = :frmCameraVistoria.dfsTipoFoto, @sCaminhoCamera = :frmCameraVistoria.dfsCaminho'
				Set _sListaINTOInclusao = ':frmCameraVistoria.dfnCodigo'
				!
				Set _bLimpaTelaAposAtualizacao = FALSE
				Set _sComandoAtualizacao = 'exec CameraVistoriaA @nCod = :frmCameraVistoria.dfnCodigo,
						@sBox = :frmCameraVistoria.dfsBox, @nSetor = :frmCameraVistoria.dfnSetor,
						@sTipoFoto = :frmCameraVistoria.dfsTipoFoto, @sCaminhoCamera = :frmCameraVistoria.dfsCaminho'
				Set _sListaINTOAtualizacao = ''
				!
				Set _bLimpaTelaAposRemocao = TRUE
				Set _sComandoRemocao = 'exec CameraVistoriaE @nCod = :frmCameraVistoria.dfnCodigo'
