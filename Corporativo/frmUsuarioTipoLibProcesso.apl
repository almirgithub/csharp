...
0020: 0000000000290100 002C000000020000 0003000000FFFFFF FFFFFFFFFFF8FFFF
...
0080: 6D5573756172696F 5469706F4C696250 726F636573736F
.enddata
...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmUsuarioTipoLibProcesso
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Tipos de Liberação de Processo Associados ao Usuário
		Icon File:
		...
		Contents
			...
			Background Text: Tipo Liberação de Processo
				Resource Id: 10588
				Class Child Ref Key: 0
				Class ChildKey: 0
				...
				Text Color: Class Default
				Background Color: Class Default
			Background Text: Tipo Liberação Processo Associado
				Resource Id: 10589
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class: cQCK1BackgroundText
				...
				Text Color: Class Default
				Background Color: Class Default
			List Box: lbTipoLibProcessoDisponivel
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class: bListBox
				Property Template:
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Tipo de liberação de processo disponível'
						Set _sComandoPesquisa = 'exec dbvcen..UsuarioTipoLibProcessoNaoAssS @Usuario = :frmUsuario.dfsCod'
						Set _bPopulaNaCriacao = TRUE
						Set _sCmdTransfEntreListas = 'pbDireita'
						Set _bVisivel = TRUE
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			List Box: lbTipoLibProcessoAssociado
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class: bListBox
				Property Template:
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Tipo liberação de processo associado'
						Set _sComandoPesquisa = 'exec dbvcen..UsuarioTipoLibProcessoAssocS @Usuario = :frmUsuario.dfsCod'
						Set _sComandoInclusao = 'exec dbvcen..UsuarioTipoLibProcessoI @TipoLiberacao = ^, @Usuario = :frmUsuario.dfsCod'
						Set _sComandoRemocao = 'exec dbvcen..UsuarioTipoLibProcessoE @TipoLiberacao = ^, @Usuario = :frmUsuario.dfsCod'
			...
			Pushbutton: pbDireita
				...
				Message Actions
					On SAM_Create
						Set _sListaOrigem = 'lbTipoLibProcessoDisponivel'
						Set _sListaDestino = 'lbTipoLibProcessoAssociado'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			Pushbutton: pbEsquerda
				...
				Message Actions
					On SAM_Create
						Set _sListaOrigem = 'lbTipoLibProcessoAssociado'
						Set _sListaDestino = 'lbTipoLibProcessoDisponivel'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
		...
		Message Actions
			On SAM_Create
				Set _sTextoStatusBar = 'Tela de associação do Tipo de Liberação de Processo'
