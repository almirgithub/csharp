...
0080: 6D5469706F4C6962 50726F6355737561 72696F
.enddata
...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmTipoLibProcUsuario
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Associar Usuário ao Tipo de Liberação
		Icon File:
...
.enddata
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Número do setor da vistoria'
						...
						Set dfnSetor._sValorDefault = SalNumberToStrX( nGlobalSetor, 0)
					...
					On SAM_KillFocus
						If nSetor != dfnSetor
							Call SalPostMsg(lbNaoPertence, MSG_Habilita1, 0, 0)
							Call SalPostMsg(lbPertence, MSG_Habilita1, 0, 0)
							!
							Call SalPostMsg(lbNaoPertence, MSG_Refresh, 0, 0)
							Call SalPostMsg(lbPertence, MSG_Refresh, 0, 0)
							!
							Call SalPostMsg(pbDireitaTodos, MSG_Habilita1, 0, 0)
							Call SalPostMsg(pbEsquerdaTodos, MSG_Habilita1, 0, 0)
							Call SalPostMsg(pbDireita, MSG_Habilita1, 0, 0)
							Call SalPostMsg(pbEsquerda, MSG_Habilita1, 0, 0)
							!
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Set _sConsultaDescrição = 'exec SetorS_desc @CodReduzido = :frmTipoLibProcUsuario.dfnSetor'
						Set dfsSetor._sValorDefault = sGlobalSetor
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			!
.data INHERITPROPS
0000: 0100
			...
			List Box: lbNaoPertence
				...
				Message Actions
					On SAM_Create
						...
						Set _sCmdTransfEntreListas = 'pbDireitaTodos'
						! ! -------------------------------------------------------------------------
						Set _sTextoStatusBar = ''
						Set _sComandoPesquisa = 'exec TipoLibProcUsuarioNaoAssocS 	@nSetor = :frmTipoLibProcUsuario.dfnSetor, 
															@nTipoLiberacao = :frmTipoLibProcUsuario.nCod '
...
.enddata
				...
				Message Actions
					On SAM_Create
						Set _sListaOrigem = 'lbNaoPertence'
						Set _sListaDestino = 'lbPertence'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
					On SAM_Click
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						! Set _nPermissao = EF_RegistroExistente
						Set _sListaOrigem = 'lbPertence'
						Set _sListaDestino = 'lbNaoPertence'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
					On SAM_Click
						Call SalSendClassMessage( SAM_Click, wParam, lParam )
						Call SalPostMsg(pbArquivar, MSG_Habilita1, 0, 0)
...
.enddata
			...
			List Box: lbPertence
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = ''
						Set _sComandoPesquisa = 'exec TipoLibProcUsuarioAssocS 	@nSetor = :frmTipoLibProcUsuario.dfnSetor, 
															@nTipoLiberacao 	= :frmTipoLibProcUsuario.nCod '
						Set _sComandoInclusao =   'exec UsuarioTipoLibProcessoI 	@Usuario 	= :frmTipoLibProcUsuario.dfslb2, 
															@TipoLiberacao 	= :frmTipoLibProcUsuario.nCod '
						Set _sComandoRemocao = 'exec UsuarioTipoLibProcessoE 	@Usuario 	= :frmTipoLibProcUsuario.dfslb2, 
															@TipoLiberacao 	= :frmTipoLibProcUsuario.nCod '
						...
						Set _bVisivel = TRUE
						!
						Set _sCmdTransfEntreListas = 'pbEsquerdaTodos'
						Set _sCmdTransfEntreListas = 'pbEsquerda'
						!
						Set _sNomeCampoFonte = 'dfslb2'
						!
						Set _bSempreHabilitado = TRUE
						!
						Set _bPopulaNaCriacao = TRUE
...
.enddata
		...
		Window Parameters
			...
			! Receive Window Handle: hWndProcUser
		Window Variables
			Number: nSetor
		Message Actions
			On SAM_CreateComplete
				...
				Set nSetor = 0
			On SAM_Create
				Set _sTextoStatusBar = 'Tela de associação de Usuários ao Orgão Autuador!'
				Set _sNroCamposIgnorados = 'NENHUM'
				...
				Set _sComandoRemocao = 'select null'
				Call SalSendClassMessage( SAM_Create, wParam, lParam )
				Call SalCenterWindow( hWndForm )
			! On SAM_CreateComplete
				Call SalSendClassMessage( SAM_CreateComplete, wParam, lParam )
