...
0020: 0000000000FB0000 002C000000020000 0003000000FFFFFF FFFFFFFFFFF8FFFF
...
0080: 6D436172676F4173 73696E6174757261
.enddata
...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmCargoAssinatura
.data INHERITPROPS
0000: 0100
.enddata
		Class: cQCK1Form
...
.enddata
				...
				Message Actions
					On SAM_Create
						Set _bVisivel = TRUE
						Set _sTextoStatusBar = 'Código do atributo veículo'
...
.enddata
				...
				Message Actions
					On SAM_Create
						Set _bVisivel = TRUE
						Set _bPermiteNulos = FALSE
						Set _sNomeParaMsgs = 'Qrp'
						Set _sTextoStatusBar = 'Qrp'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
		...
		Message Actions
			On SAM_Create
				...
				Set _sComandoPesquisa = '
						exec dbvcen..CargoAssinaturaS 
						@CargoAssinatura = :frmCargoAssinatura.dfnCod'
						
				Set _sListaINTOPesquisa = '
						:frmCargoAssinatura.dfnCod,  
						:frmCargoAssinatura.dfsDescricao'
						
				Set _sComandoInclusao = '
						exec CargoAssinaturaI   
						@CargoAssinatura = :frmCargoAssinatura.dfnCod,  
						@Cargo = :frmCargoAssinatura.dfsDescricao'
						
				Set _sListaINTOInclusao = ''
				Set _bLimpaTelaAposInclusao = FALSE
				Set _sComandoAtualizacao = 'exec CargoAssinaturaA  @CargoAssinatura = :frmCargoAssinatura.dfnCod,  @Cargo = :frmCargoAssinatura.dfsDescricao'
