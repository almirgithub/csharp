...
0080: 6D4D6F7469766F52 6570726F76616361 6F
.enddata
...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmMotivoReprovacao
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
...
.enddata
		...
		Message Actions
			On SAM_Create
				...
				Set _sComandoPesquisa = 'exec MotivoReprovacaoS @nMotivoReprovacao = :frmMotivoReprovacao.dfnCodigo'
				Set _sListaINTOPesquisa = ':frmMotivoReprovacao.dfnCodigo, :frmMotivoReprovacao.dfsDescricao'
				!
				Set _bLimpaTelaAposInclusao = FALSE
				Set _sComandoInclusao = 'exec MotivoReprovacaoI @nMotivoReprovacao = :frmMotivoReprovacao.dfnCodigo,
						@sDescricao = :frmMotivoReprovacao.dfsDescricao'
				Set _sListaINTOInclusao = ':frmMotivoReprovacao.dfnCodigo'
				!
				Set _bLimpaTelaAposAtualizacao = FALSE
				Set _sComandoAtualizacao = 'exec MotivoReprovacaoA @nMotivoReprovacao = :frmMotivoReprovacao.dfnCodigo,
						@sDescricao = :frmMotivoReprovacao.dfsDescricao'
				Set _sListaINTOAtualizacao = ''
				!
				Set _bLimpaTelaAposRemocao = TRUE
				Set _sComandoRemocao = 'exec MotivoReprovacaoE @nMotivoReprovacao = :frmMotivoReprovacao.dfnCodigo'
			...
			On SAM_CreateComplete
				...
				!
				If frmMotivoReprovacao.fObtemPermissao('frmMotivoReprovacao') = 1
					Call SalDisableWindow( pbArquivar )
					Call SalDisableWindow( pbExcluir )
				Else If frmMotivoReprovacao.fObtemPermissao('frmMotivoReprovacao') = 15
