...
0020: 0000000000170100 002C000000020000 0003000000FFFFFF FFFFFFFFFFF8FFFF
0040: FFE2FFFFFFFFFFFF FF000000007C0200 004D010000010000 0000000000010000
0060: 000F4170706C6963 6174696F6E497465 6D04000000075769 6E646F77731D6672
0080: 6D5573756172696F 5469706F45737461 62656C6563696D65 6E746F0D4368696C
00A0: 642057696E646F77 73076C624173736F 63
.enddata
...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmUsuarioTipoEstabelecimento
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Usuario Tipo Estabelecimento
		Icon File:
...
.enddata
				...
				Message Actions
					On SAM_Create
						Set _sListaOrigem = 'lbNaoAssoc'
						Set _sListaDestino = 'lbAssoc'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
...
.enddata
				...
				Message Actions
					On SAM_Create
						Set _sListaOrigem = 'lbAssoc'
						Set _sListaDestino = 'lbNaoAssoc'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			List Box: lbNaoAssoc
				Class Child Ref Key: 0
				Class ChildKey: 0
				...
				Message Actions
					On SAM_Create
						...
						! -------------------------------------------------------------------------
						Set _sTextoStatusBar = 'Estabelecimentos que não estão associados ao usuário'
						Set _sComandoPesquisa = 'exec UsuarioTipoEstabelecimentoNAS @Usuario = :frmUsuario.dfsCod'
			...
			List Box: lbAssoc
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Estabelecimentos associados ao usuário'
						Set _sComandoPesquisa = 'exec UsuarioTipoEstabelecimentoAS @Usuario = :frmUsuario.dfsCod'
						Set _sComandoInclusao = 'exec UsuarioTipoEstabelecimentoI @TipoEstabelecimento = ^, @Usuario =:frmUsuario.dfsCod'
						Set _sComandoRemocao = 'exec UsuarioTipoEstabelecimentoE @TipoEstabelecimento = ^, @Usuario =:frmUsuario.dfsCod'
						! ---------------------- Nayche 19/06/03 ---------------------------
						Set _sNroCamposIgnorados = 'NENHUM'
						!
						Set _bPermiteNulos = TRUE
			...
			Pushbutton: pbSair
				...
				Background Color: Class Default
				Message Actions
			Background Text: Estabelecimentos não Assossiados
				Resource Id: 10582
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class: cQCK1BackgroundText
				...
				Text Color: Class Default
				Background Color: Class Default
			Background Text: Estabelecimentos Associados
				Resource Id: 10583
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class: cQCK1BackgroundText
		...
		Message Actions
			On SAM_Create
				Set _sTextoStatusBar = 'Tela de controle de acesso por usuário para o cadastro de estabelecimento por tipo de estabelecimento'
				Set _sNroCamposIgnorados = 'NENHUM'
				!
			...
			On SAM_CreateComplete
				...
				Set frmUsuarioTipoEstabelecimento.dfsNome = sNomeUsuario
			On UDM_Atualizacao
				Return TRUE
			On SAM_Destroy
