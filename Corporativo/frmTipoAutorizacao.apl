...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmTipoAutorizacao
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		...
		Contents
			Data Field: dfnCodigo
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Código do Tipo de Autorização'
			...
			Data Field: dfsDescricao
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Descrição do Tipo de Autorização'
						Set _sNroCamposIgnorados = 'NENHUM'
						!
...
.enddata
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Quantidade de dias da validade da autorização'
						Set _sNroCamposIgnorados = 'NENHUM'
						!
						Set _bNuncaHabilitado = FALSE
						Set _bPermiteNulos = FALSE
...
.enddata
		...
		Message Actions
			On SAM_Create
				...
				Set _sTextoStatusBar = 'Tela de cadastro de tipos de autorizações para veículos'
				!
				Set _sCriacaoConexao = 'Default'
				Set _sComandoPesquisa = 'exec TipoAutorizacaoS @nCod = :frmTipoAutorizacao.dfnCodigo'
				Set _sListaINTOPesquisa = ':frmTipoAutorizacao.dfnCodigo, :frmTipoAutorizacao.dfsDescricao, :frmTipoAutorizacao.dfnValidade'
				!
				Set _bLimpaTelaAposInclusao = FALSE
				Set _sComandoInclusao = 'exec TipoAutorizacaoI @nCod = :frmTipoAutorizacao.dfnCodigo,
						@sDescricao = :frmTipoAutorizacao.dfsDescricao, @nQuantDiasValidos = :frmTipoAutorizacao.dfnValidade'
				Set _sListaINTOInclusao = ':frmTipoAutorizacao.dfnCodigo'
				!
				Set _bLimpaTelaAposAtualizacao = FALSE
				Set _sComandoAtualizacao = 'exec TipoAutorizacaoA @nCod = :frmTipoAutorizacao.dfnCodigo,
						@sDescricao = :frmTipoAutorizacao.dfsDescricao, @nQuantDiasValidos = :frmTipoAutorizacao.dfnValidade'
				Set _sListaINTOAtualizacao = ''
				!
				Set _bLimpaTelaAposRemocao = TRUE
				Set _sComandoRemocao = 'exec TipoAutorizacaoE @nCod = :frmTipoAutorizacao.dfnCodigo'
			...
			On SAM_CreateComplete
				...
				!
				If frmTipoAutorizacao.fObtemPermissao('frmTipoAutorizacao') = 1
					Call SalDisableWindow( pbArquivar )
					Call SalDisableWindow( pbExcluir )
				Else If frmTipoAutorizacao.fObtemPermissao('frmTipoAutorizacao') = 15
