...
0080: 6D5469706F497465 6D566973746F7269 61
.enddata
...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmTipoItemVistoria
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Item de Vistoria
		Icon File:
		...
		Description: Alterado: 20/06/2013 - Marcelo Silva(marcelom)  - adicionado Pesquisa Instantânea para os campos Código, Independente se é Ativo ou não
		Named Menus
		Menu
		Tool Bar
			Display Settings
		...
		Contents
			Data Field: dfnCodigo
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Código do Item de Vistoria'
						...
						! Alteração - 20/06/2013 - Marcelo Silva -  Adicionado Pesquisa Instantânea para código
						Set _sConsultaFrmOpcoesSQLOuSP = 'SP'
						Set _sConsultaFrmOpcoesColunaOuParam = '@Desc'
						Set _sConsultaFrmOpcoesCampo = 'exec dbvcen..TipoItemVistorAtivInatCodDescS'
						Set _bVisivel = TRUE
			...
			Data Field: dfsDescricao
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Descrição do Item de Vistoria'
						Set _sNroCamposIgnorados = 'NENHUM'
						!
			...
			Check Box: cbsAtivo
				...
				Message Actions
					On SAM_Create
						!
						Set _sTextoStatusBar = 'Marque para indicar que Tipo Item de Vistoria Ativo'
						Set _sNroCamposIgnorados = 'NENHUM'
						!
						Set _bVisivel = TRUE
						Set _sNomeCampoFonte = 'dfsAtivo'
...
.enddata
		...
		Message Actions
			On SAM_Create
				...
				Set _sTextoStatusBar = 'Tela de cadastro de Tipo de Item de Vistoria'
				!
				Set _sCriacaoConexao = 'Default'
				Set _sComandoPesquisa = 'exec TipoItemVistoriaS @nCod = :frmTipoItemVistoria.dfnCodigo'
				Set _sListaINTOPesquisa = ':frmTipoItemVistoria.dfnCodigo, :frmTipoItemVistoria.dfsDescricao,
						:frmTipoItemVistoria.dfsAtivo'
				!
				Set _bLimpaTelaAposInclusao = FALSE
				Set _sComandoInclusao = 'exec TipoItemVistoriaI @nCod = :frmTipoItemVistoria.dfnCodigo,
						@sDescricao = :frmTipoItemVistoria.dfsDescricao,
						@siAtivo = :frmTipoItemVistoria.dfsAtivo'
				Set _sListaINTOInclusao = ':frmTipoItemVistoria.dfnCodigo'
				!
				Set _bLimpaTelaAposAtualizacao = FALSE
				Set _sComandoAtualizacao = 'exec TipoItemVistoriaA @nCod = :frmTipoItemVistoria.dfnCodigo,
						@sDescricao = :frmTipoItemVistoria.dfsDescricao,
						@siAtivo = :frmTipoItemVistoria.dfsAtivo'
				Set _sListaINTOAtualizacao = ''
				!
				Set _bLimpaTelaAposRemocao = TRUE
				Set _sComandoRemocao = 'exec TipoItemVistoriaE @nCod = :frmTipoItemVistoria.dfnCodigo'
			...
			On SAM_CreateComplete
				...
				!
				If frmTipoItemVistoria.fObtemPermissao('frmTipoItemVistoria') = 1
					Call SalDisableWindow( pbArquivar )
					Call SalDisableWindow( pbExcluir )
				Else If frmTipoItemVistoria.fObtemPermissao('frmTipoItemVistoria') = 15
