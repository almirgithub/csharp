...
0080: 6D5573756172696F 5365746F72
.enddata
...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmUsuarioSetor
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Ciretrans Associadas ao Usuário
		Icon File:
...
.enddata
			...
			List Box: lbNaoAssoc
				...
				Message Actions
					On SAM_Create
						...
						! -------------------------------------------------------------------------
						Set _sTextoStatusBar = 'Ciretrans não-informatizadas que não estão associadas ao usuário'
						Set _sComandoPesquisa = 'exec UsuarioSetorS_naoassoc @Usuario = :frmUsuario.dfsCod'
			...
			List Box: lbAssoc
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Ciretrans não-informatizadas associadas ao usuário'
						Set _sComandoPesquisa = 'exec UsuarioSetorS_assoc @Usuario = :frmUsuario.dfsCod'
						Set _sComandoInclusao = 'exec UsuarioSetorI @Setor = "^", @Usuario =:frmUsuario.dfsCod'
						Set _sComandoRemocao = 'exec UsuarioSetorD @Setor = "^", @Usuario =:frmUsuario.dfsCod'
						! ---------------------- Nayche 19/06/03 ---------------------------
						Set _sNroCamposIgnorados = 'NENHUM'
						!
						Set _bPermiteNulos = TRUE
			...
			Pushbutton: pbSair
				...
				Background Color: Class Default
				Message Actions
			Background Text: Ciretrans Não-Informatizadas
				Resource Id: 10582
				Class Child Ref Key: 0
				Class ChildKey: 0
				...
				Text Color: Class Default
				Background Color: Class Default
			Background Text: Ciretrans Associadas ao Usuário
				Resource Id: 10583
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class: cQCK1BackgroundText
		...
		Message Actions
			On SAM_Create
				Set _sTextoStatusBar = 'Tela de associação de ciretran a usuário'
				Set _sNroCamposIgnorados = 'NENHUM'
				!
