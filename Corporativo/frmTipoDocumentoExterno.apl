...
0080: 6D5469706F446F63 756D656E746F4578 7465726E6F
.enddata
...
.head 1 +  Form Window: frmTipoDocumentoExterno
.data INHERITPROPS
0000: 0100
.enddata
...
.head 2 -  Title: Cadastro de Tipo de Documento Externo
.head 2 -  Icon File:
...
.head 3 +  Data Field: dfnTipoDocExterno
.data INHERITPROPS
0000: 0100
.enddata
.head 4 -  Class Child Ref Key: 0
...
.head 6 -  Set _sTextoStatusBar = 'Descrição do tipo de documento'
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 -  ! -
...
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 -  ! -
.head 3 -  Background Text: Validade:
.head 4 -  Resource Id: 60749
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class: cQCK1BackgroundText
.head 4 -  Window Location and Size
...
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 -  !
.head 3 +  Pushbutton: pbServicos
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class: cQCK1PushButton
.head 4 -  Property Template:
.head 4 -  Class DLL Name:
.head 4 -  Title: &Serviços
.head 4 -  Window Location and Size
.head 5 -  Left: 3.77"
.head 5 -  Top: 1.823"
.head 5 -  Width:  Class Default
...
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 5 +  On SAM_Click
.head 6 +  If hWndServicos != hWndNULL
.head 7 -  Call SalSendMsg( hWndTipoDocumentoExterno, MSG_Sai, 0, 0 )
.head 6 -  Set hWndTipoDocumentoExterno = SalCreateWindow( frmDocExternoServicoAssoc, hWndForm, hWndItem, pnCodSetor, psNomeSetor, dfnTipoDocExterno, dfsDescricao)
.head 3 -  !
...
.head 4 -  Message Actions
.head 2 +  Functions
.head 3 +  Function: fPreencheSetor
.head 4 -  Description:
.head 4 -  Returns
.head 4 -  Parameters
...
.head 3 -  Window Handle: hWndServicos
.head 2 +  Message Actions
.head 3 +  On SAM_Create
.head 4 -  Set _nEstadoInicialForm = EF_PesquisaHabilitada
.head 4 -  ! -
.head 4 -  Set _sComandoPesquisa = 'exec dbvcen..TipoDocumentoExternoS
			@Setor 		= :frmTipoDocumentoExterno.pnCodSetor,
			@TipoDocExterno     	= :frmTipoDocumentoExterno.dfnTipoDocExterno'
.head 4 -  Set _sListaINTOPesquisa = '	:frmTipoDocumentoExterno.pnCodSetor,
			:frmTipoDocumentoExterno.dfnTipoDocExterno, 
			:frmTipoDocumentoExterno.dfsDescricao,
			:frmTipoDocumentoExterno.dfsSituacao,
			:frmTipoDocumentoExterno.dfnValidade'
.head 4 -  !
.head 4 -  Set _sComandoInclusao = 'exec dbvcen..TipoDocumentoExternoI
			@Setor 		= :frmTipoDocumentoExterno.pnCodSetor,
			@TipoDocExterno     	= :frmTipoDocumentoExterno.dfnTipoDocExterno,
			@DescDocExterno    	= :frmTipoDocumentoExterno.dfsDescricao,
			@iSituacao 	= :frmTipoDocumentoExterno.dfsSituacao,
			@PrazoValidade        = :frmTipoDocumentoExterno.dfnValidade'
.head 4 -  Set _sListaINTOInclusao = '	:frmTipoDocumentoExterno.dfnTipoDocExterno'
.head 4 -  !
.head 4 -  Set _sComandoAtualizacao = 'exec dbvcen..TipoDocumentoExternoA
			@Setor 		= :frmTipoDocumentoExterno.pnCodSetor,
			@TipoDocExterno     	= :frmTipoDocumentoExterno.dfnTipoDocExterno,
			@DescDocExterno    	= :frmTipoDocumentoExterno.dfsDescricao,
			@iSituacao 	= :frmTipoDocumentoExterno.dfsSituacao,
			@PrazoValidade        = :frmTipoDocumentoExterno.dfnValidade'
.head 4 -  Set _sComandoRemocao = 'exec TipoDocumentoExternoE  
			@TipoDocExterno 	= :frmTipoDocumentoExterno.dfnTipoDocExterno'
...
.head 4 -  Call fPreencheSetor()
.head 4 -  Call SalDisableWindow(pbServicos)
.head 0 -  
.head 0 -  
  