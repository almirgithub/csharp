...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmImpressoraSetor
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Setores Requisitantes de Impressão
		Icon File:
		...
		Contents
			...
			List Box: lbNaoRequis
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Setores não requisitantes de impressão para a impressora'
						Set _sComandoPesquisa = 'exec ImpressoraSetorReqS_naorequis @SetorN = :frmImpressoraSetor.nSetor,
								@Impressora = :frmImpressoraSetor.nImpressora'
			...
			List Box: lbRequis
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Setores requisitantes de impressão para a impressora'
						Set _sComandoPesquisa = 'exec ImpressoraSetorReqS_requis @SetorN = :frmImpressoraSetor.nSetor,
								@Impressora = :frmImpressoraSetor.nImpressora'
						Set _sComandoInclusao = 'exec ImpressoraSetorReqI @SetorN = :frmImpressoraSetor.nSetor,
								@Impressora = :frmImpressoraSetor.nImpressora, @SetorRequisitante = "^"'
						Set _sComandoRemocao = 'exec ImpressoraSetorReqD @SetorN = :frmImpressoraSetor.nSetor,
								@Impressora = :frmImpressoraSetor.nImpressora, @SetorRequisitante = "^"'
			...
			Pushbutton: pbDireita
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Associa o setor selecionado à impressora'
						! Set _nPermissao = EF_RegistroExistente
						Set _sListaOrigem = 'lbNaoRequis'
						Set _sListaDestino = 'lbRequis'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			Pushbutton: pbEsquerda
				...
				Font Size: Class Default
				Font Enhancement: Class Default
				Picture File Name: Anterior.Bmp
				Picture Transparent Color: Gray
				Image Style: Class Default
				Text Color: Class Default
				Background Color: Class Default
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Desassocia o setor à impressora'
						! Set _nPermissao = EF_RegistroExistente
						Set _sListaOrigem = 'lbRequis'
						Set _sListaDestino = 'lbNaoRequis'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			...
			Background Text: Setores
				...
				Text Color: Class Default
				Background Color: Class Default
			Background Text: Setores Requisitantes
				Resource Id: 62937
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class: cQCK1BackgroundText
