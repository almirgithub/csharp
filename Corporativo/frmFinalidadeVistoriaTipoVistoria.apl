...
.enddata
		...
		Resources
		Variables
.data RESOURCE 0 0 1 1935871842
0000: 2200000012000000 0000000000000000 02008001000000BE 0100D01900000001
0020: FE00FF03
.enddata
		Internal Functions
		Named Menus
...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmFinalidadeVistoriaTipoVistoria
.data INHERITPROPS
0000: 0100
.enddata
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Finalidade Vistoria associada ao Tipo de Vistoria
		Icon File:
		...
		Tool Bar
			...
			Contents
		Contents
			Child Table: tblFinalidadeVistoria
.data INHERITPROPS
0000: 0100
.enddata
.data CLASSPROPS
...
.enddata
				...
				Contents
					Column: colnFinalidade
						...
						Message Actions
							On SAM_Create
								Set _sTextoStatusBar = 'Código da Finalidade Vistoria'
								Set _bPermiteNulos = FALSE
								Set _sNroCamposIgnorados = 'NENHUM'
								Set _bComponenteChave = TRUE
								Set _bVisivel = TRUE
								Set _sNomeParaMsgs = 'Finalidade Vistoria'
								Set _sMsgValidacao = 'Finalidade já cadastrada ou digitada!'
								Set _sTipoMsgValidacao = 'ESPECIFICA'
								Call SalSendClassMessage( SAM_Create, wParam, lParam )
							On UDM_ValidaCampo
								If NOT SalIsNull( hWndItem)
									If ProcuraNJaDigitado( hWndForm, SalTblQueryColumnID( colnFinalidade ), lParam, colnFinalidade, '' )
										Return FALSE
								Return TRUE
							On WMSG_KEYDOWN
								Select Case (wParam)
									Case WKEY_F2
										Call SalModalDialog( dlgProcura, hWndForm, hWndItem, 'Exec dbvcen..FinalidadeVistoriaCodDescS',
												'', 'SP', NUMBER_Null, _sColunasAdicionais)
										Call SalSendMsg( hWndItem, SAM_User, lParam, wParam )
										Break
									Case WKEY_TAB
										Call SalSendMsg( hWndItem, SAM_User, lParam, wParam )
										Break
							On SAM_User
								If tblFinalidadeVistoria.colnFinalidade != NUMBER_Null
									If SqlConnect( tblFinalidadeVistoria.hSqlFinalidade )
										If fMPSPrepareProc( tblFinalidadeVistoria.hSqlFinalidade, 'dbvcen..FinalidadeVistoriaDescS @nCod =:tblFinalidadeVistoria.colnFinalidade', ':tblFinalidadeVistoria.colsDescricao' )
											If SqlExecute( tblFinalidadeVistoria.hSqlFinalidade )
												Call SqlFetchNext( tblFinalidadeVistoria.hSqlFinalidade, lParam )
										Call SqlDisconnect( tblFinalidadeVistoria.hSqlFinalidade )
										Return VALIDATE_Ok
					Column: colsDescricao
						...
						Message Actions
							On SAM_Create
								...
								Set _sTextoStatusBar = 'Descrição da Finalidade Vistoria'
								Call SalSendClassMessage( SAM_Create, wParam, lParam )
					Column: colsExigeCaracteristica
						Class Child Ref Key: 0
						Class ChildKey: 0
						Class: cQCK2Column
						Property Template:
						Class DLL Name:
						Title: Exige Característica Alterada
						Visible? Class Default
						Editable? Class Default
						...
						Message Actions
							On SAM_Create
								...
								Set _bÉDependente = FALSE
								Set _sTextoStatusBar = 'Clique para indicar se a finalidade exige característica alterada'
								Set _sValorDefault = 'N'
								Call SalSendClassMessage( SAM_Create, wParam, lParam )
					Column: colsExigeCsv
						Class Child Ref Key: 0
						Class ChildKey: 0
						...
						Message Actions
							On SAM_Create
								...
								Set _bNuncaHabilitado = FALSE
								Set _bÉDependente = FALSE
								Set _sTextoStatusBar = 'Clique para indicar se gera laudo policial'
								Set _sValorDefault = 'N'
								Call SalSendClassMessage( SAM_Create, wParam, lParam )
					Column: colsLaudoPolicial
						Class Child Ref Key: 0
						Class ChildKey: 0
						Class: cQCK2Column
						Property Template:
						Class DLL Name:
						Title: Gera Laudo Policial
						Visible? Class Default
						Editable? Class Default
						Maximum Data Length: 1
						Data Type: String
				...
				Functions
				Window Variables
					Sql Handle: hSqlFinalidade
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Finalidade de Vistoria associado ao Tipo de Vistoria'
						Set _sIdUsuario = ''
						...
						Set _sPwdUsuario = ''
						Set _sNomeBD = ''
						Set _sComandoAtualiza = 'exec FinalidadeVistoriaTipoVisA @nTipoVistoria = :frmTipoVistoria.dfnCodigo, @nFinalidade = :tblFinalidadeVistoria.colnFinalidade,
								@siExigeCaracteristicaAlterada = :tblFinalidadeVistoria.colsExigeCaracteristica, @siLaudoPolicial = :tblFinalidadeVistoria.colsLaudoPolicial, @siExigeCsv = :tblFinalidadeVistoria.colsExigeCsv'
						Set _sComandoInsere = 'exec FinalidadeVistoriaTipoVisI @nTipoVistoria = :frmTipoVistoria.dfnCodigo, @nFinalidade = :tblFinalidadeVistoria.colnFinalidade,
								@siExigeCaracteristicaAlterada = :tblFinalidadeVistoria.colsExigeCaracteristica, @siLaudoPolicial = :tblFinalidadeVistoria.colsLaudoPolicial, @siExigeCsv = :tblFinalidadeVistoria.colsExigeCsv'
						Set _sComandoExclui = 'exec FinalidadeVistoriaTipoVisE @nTipoVistoria = :frmTipoVistoria.dfnCodigo, @nFinalidade = :tblFinalidadeVistoria.colnFinalidade'
						Set _sComandoPesquisa = 'exec FinalidadeVistoriaTipoVisS @nTipoVistoria = :frmTipoVistoria.dfnCodigo'
						Set _sIntoPesquisa = ':frmFinalidadeVistoriaTipoVistoria.tblFinalidadeVistoria.colnFinalidade, :frmFinalidadeVistoriaTipoVistoria.tblFinalidadeVistoria.colsDescricao, :frmFinalidadeVistoriaTipoVistoria.tblFinalidadeVistoria.colsExigeCaracteristica,
								:frmFinalidadeVistoriaTipoVistoria.tblFinalidadeVistoria.colsLaudoPolicial, :frmFinalidadeVistoriaTipoVistoria.tblFinalidadeVistoria.colsExigeCsv'
						Set _sIntoAtualiza = ''
						Set _sIntoInsere = ''
						Set _sIntoExclui = ''
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
					On MSG_NovaLinha
						...
						! Set colsExigeCaracteristica = 'N'
						! Set colsLaudoPolicial = 'N'
						! Posiciona na linha nova e na coluna inicial
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Set _sTabela = 'tblFinalidadeVistoria'
...
.enddata
			...
			Background Text: Tipo de Vistoria:
				Resource Id: 40360
				Class Child Ref Key: 0
				Class ChildKey: 0
		...
		Window Parameters
			...
			String: sTipoVistoria
		Window Variables
		Message Actions
			On SAM_Create
				Set _sTextoStatusBar = 'Finalidade de Vistoria Associada ao Tipo de Vistoria'
			...
			On SAM_CreateComplete
				...
				Set dfsTipoVistoria = sTipoVistoria
				If NOT SalTblAnyRows( tblFinalidadeVistoria, 0, 0 )
					Call SalPostMsg( tblFinalidadeVistoria, MSG_MudaEstadoForm, EF_RegistroExistente, 0 )
					Call SalPostMsg( tblFinalidadeVistoria, MSG_NovaLinha, 0, 0 )
				If frmFinalidadeVistoriaTipoVistoria.fObtemPermissao('frmFinalidadeVistoriaTipoVistoria') = 1
					Call SalDisableWindow( pbArquivar )
				Else If frmFinalidadeVistoriaTipoVistoria.fObtemPermissao('frmFinalidadeVistoriaTipoVistoria') = 15
