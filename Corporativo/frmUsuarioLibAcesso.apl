...
0080: 6D5573756172696F 4C69624163657373 6F
.enddata
...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmUsuarioLibAcesso
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Tipos de Restrição de Processo Associados ao Usuário
		Icon File:
		...
		Contents
			...
			Background Text: Tipo de Restrição
				Resource Id: 10588
				Class Child Ref Key: 0
				Class ChildKey: 0
				...
				Text Color: Class Default
				Background Color: Class Default
			Background Text: Tipo de Restrição Associada
				Resource Id: 10589
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class: cQCK1BackgroundText
				...
				Text Color: Class Default
				Background Color: Class Default
			List Box: lbTipoLibRestricaoDisponivel
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class: bListBox
				Property Template:
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Tipo de Restrição disponível'
						Set _sComandoPesquisa = 'exec dbvcen..UsuarioRestricaoNaoAssocS @sUsuario = :frmUsuario.dfsCod'
						Set _bPopulaNaCriacao = TRUE
						Set _sCmdTransfEntreListas = 'pbDireita'
						Set _bVisivel = TRUE
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			List Box: lbTipoLibRetricaoAssociado
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class: bListBox
				Property Template:
				...
				Message Actions
					On SAM_Create
						...
						Set _sComandoPesquisa = 'exec dbvcen..UsuarioRestricaoAssocS @Usuario = :frmUsuario.dfsCod'
						Set _sComandoInclusao = 'exec dbvcen..UsuarioRestricaoI @nCodigo = ^, @sUsuario = :frmUsuario.dfsCod'
						Set _sComandoRemocao = 'exec dbvcen..UsuarioRestricaoE @nRestricao = ^, @sUsuario = :frmUsuario.dfsCod'
			...
			Pushbutton: pbDireita
				...
				Message Actions
					On SAM_Create
						Set _sListaOrigem = 'lbTipoLibRestricaoDisponivel'
						Set _sListaDestino = 'lbTipoLibRetricaoAssociado'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			Pushbutton: pbEsquerda
				...
				Message Actions
					On SAM_Create
						Set _sListaOrigem = 'lbTipoLibRetricaoAssociado'
						Set _sListaDestino = 'lbTipoLibRestricaoDisponivel'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
		...
		Message Actions
			On SAM_Create
				Set _sTextoStatusBar = 'Tela de associação do Tipo de Restrição de Processo'
			...
			! On SAM_CreateComplete
				Call SalSendMsgToChildren(hWndItem, MSG_Habilita1, wParam, lParam)
