...
0020: 0000000000070100 002C000000020000 0003000000FFFFFF FFFFFFFFFFF8FFFF
...
0080: 6D4C6F675469706F 5365727669636F43 6174656756656963 53
.enddata
...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmLogTipoServicoCategVeicS
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Log das Alterações da Categoria de Veículo dos Serviços
		Icon File:
		...
		Description: --------------------------------------------------------------------------------------------------------
				Criação: Consulta das alterações (logs) dos Serviços por Categoria.
				Autor-Data: Djalma Júnior - 12/09/2012
				--------------------------------------------------------------------------------------------------------
		Named Menus
		Menu
		Tool Bar
			...
			Data Field: dfsNome
				...
				Message Actions
					On SAM_Create
						...
						Set _sConsultaDescrição = 'exec UsuarioS_nome @Cod = :frmLogTipoServicoCategVeicS.dfsCod'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			...
			Child Table: tblLogServicoTaxa
				...
				Message Actions
					On SAM_Create
						...
						Set _sComandoPesquisa = 'exec dbvcen..LogTipoServicoCategVeicS
								@Usuario =:frmLogTipoServicoCategVeicS.dfsCod,  
								@Servico =:frmLogTipoServicoCategVeicS.dfnCodigo, 
								@DataInicial =:frmLogTipoServicoCategVeicS.dfdDataIni,
								@DataFinal =:frmLogTipoServicoCategVeicS.dfdDataFim'
								
						Set _sIntoPesquisa = 
								':frmLogTipoServicoCategVeicS.tblLogServicoTaxa.colsOperador,
								:frmLogTipoServicoCategVeicS.tblLogServicoTaxa.coldDataOperacao,
								:frmLogTipoServicoCategVeicS.tblLogServicoTaxa.colsDescricaoOperacao,
								:frmLogTipoServicoCategVeicS.tblLogServicoTaxa.colsServico,
								:frmLogTipoServicoCategVeicS.tblLogServicoTaxa.colsCategoria'
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Set _sTabela = 'tblLogServicoTaxa'
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Set _bÉDependente = TRUE
						Set _sCamposResponsaveis[0] = 'dfnCodigo'
						Set _sConsultaDescrição = 'exec TipoServicoS_desc @Cod = :frmLogTipoServicoCategVeicS.dfnCodigo'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
...
.enddata
		...
		Message Actions
			On SAM_Create
				...
				Call SalSendClassMessage( SAM_Create, wParam, lParam )
				Call SalCenterWindow( frmLogTipoServicoCategVeicS )
