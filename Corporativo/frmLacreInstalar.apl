...
0080: 6D4C61637265496E 7374616C61720D43 68696C642057696E 646F77730A64666E
00A0: 52656E6176616D
.enddata
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Set _sNomeParaMsgs = 'Número do RENAVAM'
						!
						Set _bNuncaHabilitado = FALSE
						Set _bPermiteNulos = FALSE
						Set _bSempreHabilitado = TRUE
...
.enddata
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Número do Lacre'
						Set _sNomeParaMsgs = 'Número do Lacre'
						Set _sNroCamposIgnorados = 'NENHUM'
						!
						Set _bNuncaHabilitado = FALSE
						Set _bPermiteNulos = FALSE
...
.end
		...
		Message Actions
			On SAM_Create
				...
				Set _sTextoStatusBar = 'Tela de Registro da Instalçao do Lacre'
				!
				Set _sCriacaoConexao = 'Default'
				Set _sComandoPesquisa = ''
				Set _sListaINTOPesquisa = ''
				! Set _sComandoPesquisa = 'exec MotivoCancelamentoLacreS @nCod = :frmLacreInstalar.dfnCodigo'
				! Set _sListaINTOPesquisa = ':frmLacreInstalar.dfnCodigo, :frmLacreInstalar.dfsDescricao'
				!
				! Set _bLimpaTelaAposInclusao = FALSE
				! Set _sComandoInclusao = 'exec MotivoCancelamentoLacreI @nCod = :frmLacreInstalar.dfnCodigo,
						@sDescricao = :frmLacreInstalar.dfsDescricao'
				! Set _sListaINTOInclusao = ':frmLacreInstalar.dfnCodigo'
				!
				Set _bLimpaTelaAposAtualizacao = FALSE
				Set _sComandoAtualizacao = 'exec dbvcen..LacreVeiculo_InstDetranA  @Placa = :frmLacreInstalar.dfsPlaca,
						@Renavam = :frmLacreInstalar.dfnRenavam, @Lacre = :frmLacreInstalar.dfnLacre'
				Set _sListaINTOAtualizacao = ''
				!
				! Set _bLimpaTelaAposRemocao = TRUE
				! Set _sComandoRemocao = 'exec MotivoCancelamentoLacreE @nCod = :frmLacreInstalar.dfnCodigo'
			...
			On SAM_CreateComplete
				...
				!
				If frmLacreInstalar.fObtemPermissao('frmLoteLacreEntrega') = 1
					Call SalDisableWindow( pbArquivar )
					! Call SalDisableWindow( pbExcluir )
				Else If frmLacreInstalar.fObtemPermissao('frmLoteLacreEntrega') = 15
			...
			On UDM_AposAtualizacao
				...
				! ! ! ! ! ! ! Arquivamento realizado com sucesso
