...
0080: 6D5365727669636F 52617069646F0D43 68696C642057696E 646F777311646673
00A0: 5365727669636F44 657374696E6F
.enddata
		...
		Contents
			...
			Data Field: dfnServicoOrigem
				...
				Message Actions
					On SAM_Create
						Set _bVisivel = TRUE
						Set _sTextoStatusBar = 'Código do serviço origem'
						...
						Set _sConsultaFrmOpcoesColunaOuParam = ''
			...
			Data Field: dfsServicoOrigem
				...
				Message Actions
					On SAM_Create
						...
						Set _sConsultaDescrição = 'exec TipoServicoS_desc @Cod = :frmServicoRapido.dfnServicoOrigem'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			Data Field: dfnServicoDestino
				...
				Message Actions
					On SAM_Create
						Set _bVisivel = TRUE
						Set _sTextoStatusBar = 'Código do novo serviço'
						Set _sNomeParaMsgs = 'Serviço'
						Set _bPermiteNulos = TRUE
						Set _bSempreHabilitado = FALSE
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
...
.enddata
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Descrição do novo tipo de serviço'
						...
						Set _bVisivel = TRUE
						!
						Set _sNomeParaMsgs = 'Descrição do Tipo de serviço'
			...
			Pushbutton: pbNovo
				...
				Message Actions
					...
					On SAM_Click
						...
						! Call SalSetFocus( frmServicoRapido.dfsUsuarioOrigem )
...
.enddata
		...
		Message Actions
			On SAM_Create
				...
				! ----------------------------------------Inclusão-------------------------------------
				Set _sComandoInclusao = 'Exec ServicoRapidoI
						@nServicoOrigem  	=:frmServicoRapido.dfnServicoOrigem,
						@nServicoDestino 	=:frmServicoRapido.dfnServicoDestino,
						@sDescricao =:frmServicoRapido.dfsServicoDestino'
				!
