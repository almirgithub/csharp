...
0080: 6D4D6F7469766F43 616E63656C616D65 6E746F566973746F 726961
.enddata
...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmMotivoCancelamentoVistoria
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Motivo de Cancelamento de Vistoria
		Icon File:
		...
		Description: Alterado: 20/06/2013 - Marcelo Silva(marcelom)  - adicionado Pesquisa Instantânea para os campos Código
		Named Menus
		Menu
		Tool Bar
			Display Settings
		...
		Contents
			Data Field: dfnCodigo
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Código do Motivo de Cancelamento de Vistoria'
						...
						Set _sConsultaFrmOpcoesCampo = 'Exec dbvcen..MotivoCancelamVistoriaCodDescS'
						Set _bVisivel = TRUE
			...
			Data Field: dfsDescricao
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Descrição do Motivo de Cancelamento de Vistoria'
						Set _sNroCamposIgnorados = 'NENHUM'
						!
...
.enddata
		...
		Message Actions
			On SAM_Create
				...
				Set _sTextoStatusBar = 'Tela de cadastro de Motivos de Cancelamento de Vistoria'
				!
				Set _sCriacaoConexao = 'Default'
				Set _sComandoPesquisa = 'exec MotivoCancelamentoVistoriaS @nCod = :frmMotivoCancelamentoVistoria.dfnCodigo'
				Set _sListaINTOPesquisa = ':frmMotivoCancelamentoVistoria.dfnCodigo, :frmMotivoCancelamentoVistoria.dfsDescricao'
				!
				Set _bLimpaTelaAposInclusao = FALSE
				Set _sComandoInclusao = 'exec MotivoCancelamentoVistoriaI @nCod = :frmMotivoCancelamentoVistoria.dfnCodigo,
						@sDescricao = :frmMotivoCancelamentoVistoria.dfsDescricao'
				Set _sListaINTOInclusao = ':frmMotivoCancelamentoVistoria.dfnCodigo'
				!
				Set _bLimpaTelaAposAtualizacao = FALSE
				Set _sComandoAtualizacao = 'exec MotivoCancelamentoVistoriaA @nCod = :frmMotivoCancelamentoVistoria.dfnCodigo,
						@sDescricao = :frmMotivoCancelamentoVistoria.dfsDescricao'
				Set _sListaINTOAtualizacao = ''
				!
				Set _bLimpaTelaAposRemocao = TRUE
				Set _sComandoRemocao = 'exec MotivoCancelamentoVistoriaE @nCod = :frmMotivoCancelamentoVistoria.dfnCodigo'
			...
			On SAM_CreateComplete
				...
				!
				If frmMotivoCancelamentoVistoria.fObtemPermissao('frmMotivoCancelamentoVistoria') = 1
					Call SalDisableWindow( pbArquivar )
					Call SalDisableWindow( pbExcluir )
				Else If frmMotivoCancelamentoVistoria.fObtemPermissao('frmMotivoCancelamentoVistoria') = 15
