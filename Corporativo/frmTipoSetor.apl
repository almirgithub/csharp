...
.head 1 +  Form Window: frmTipoSetor
.head 2 -  Class: cQCK1Form
.head 2 -  Property Template:
.head 2 -  Class DLL Name:
.head 2 -  Title: Tipo de Setor
.head 2 -  Icon File:
...
.head 2 -  Description: --------------------------------------------------------------------------------------------------------------------------------------------------------------
Tela de parâmetros do Relatório de totais da frota de veículo por município, categoria e complemento 
Data-Autor: 09/09/2013 [marcelom] Marcelo Silva
--------------------------------------------------------------------------------------------------------------------------------------------------------------
.head 2 -  Named Menus
.head 2 -  Menu
.head 2 +  Tool Bar
...
.head 6 -  Set _sTextoStatusBar = 'Código do Tipo de Setor'
...
.head 4 +  Message Actions
.head 5 +  On SAM_Create
.head 6 -  Set _sTextoStatusBar = 'Descrição do Tipo de Setor'
.head 6 -  Set _sNroCamposIgnorados = 'NENHUM'
.head 6 -  !
...
.head 4 -  Text Color: Class Default
.head 4 -  Background Color: Class Default
.head 3 +  Check Box: cbSetorExterno
.data CLASSPROPSSIZE
0000: 1900
.enddata
.data CLASSPROPS
...
.head 4 -  Property Template:
.head 4 -  Class DLL Name:
.head 4 -  Title: Tipo Setor Externo
.head 4 -  Window Location and Size
.head 5 -  Left: 4.388"
.head 5 -  Top: 0.156"
.head 5 -  Width:  1.8"
...
.head 6 -  !
.head 6 -  Set _bVisivel = TRUE
.head 6 -  Set _sNomeCampoFonte = 'dfsSetorExterno'
.head 6 -  Set _sValorCHECKED = 'S'
.head 6 -  Set _sValorNOTCHECKED = 'N'
.head 6 -  !
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 +  Data Field: dfsSetorExterno
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class: cQCK1DataField
.head 4 -  Property Template:
...
.head 4 -  Set _sTextoStatusBar = 'Tela de cadastro de tipos de Setor'
.head 4 -  !
.head 4 -  Set _sCriacaoConexao = 'Default'
.head 4 -  Set _sComandoPesquisa = 'exec dbvcen..TipoSetorS @TipoSetor= :frmTipoSetor.dfsCodigo'
.head 4 -  Set _sListaINTOPesquisa = '	:frmTipoSetor.dfsCodigo, 
		              	:frmTipoSetor.dfsDescricao,
			:frmTipoSetor.dfsSetorExterno'
.head 4 -  !
.head 4 -  Set _bLimpaTelaAposInclusao = FALSE
.head 4 -  Set _sComandoInclusao = 'exec dbvcen..TipoSetorI	@TipoSetor = :frmTipoSetor.dfsCodigo,
					@Descricao = :frmTipoSetor.dfsDescricao, 
					@iSetorExterno = :frmTipoSetor.dfsSetorExterno'
.head 4 -  Set _sListaINTOInclusao = ':frmTipoSetor.dfsCodigo'
.head 4 -  !
.head 4 -  Set _bLimpaTelaAposAtualizacao = FALSE
.head 4 -  Set _sComandoAtualizacao = 'exec dbvcen..TipoSetorA 	@TipoSetor = :frmTipoSetor.dfsCodigo,
						@Descricao = :frmTipoSetor.dfsDescricao,
						@iSetorExterno = :frmTipoSetor.dfsSetorExterno'
.head 4 -  Set _sListaINTOAtualizacao = ''
.head 4 -  !
.head 4 -  Set _bLimpaTelaAposRemocao = TRUE
.head 4 -  Set _sComandoRemocao = 'exec dbvcen..TipoSetorE @TipoSetor = :frmTipoSetor.dfsCodigo'
...
.head 4 -  !
.head 4 +  If frmTipoSetor.fObtemPermissao('frmTipoSetor') = 1
.head 5 -  Call SalDisableWindow( pbArquivar )
.head 5 -  Call SalDisableWindow( pbExcluir )
.head 4 +  Else If frmTipoSetor.fObtemPermissao('frmTipoSetor') = 15
