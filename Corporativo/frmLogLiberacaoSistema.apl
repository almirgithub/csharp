...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmLogLiberacaoSistema
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Log liberação Acessos por Sistemas
		Icon File:
		...
		Description: --------------------------------------------------------------------------------------------------------
				Criação: Consulta do LOG de liberação de acesso dos Sistema.
				Autor-Data: Fernando Veras - 08/08/2015
				--------------------------------------------------------------------------------------------------------
		Named Menus
		Menu
		Tool Bar
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Set _sTabela = 'tblLogLiberacaoSistema'
...
.enddata
			...
			Pushbutton: pbSair
				...
				Message Actions
					On SAM_Create
						...
						Set _sTabela = ''
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			Child Table: tblLogLiberacaoSistema
				Class Child Ref Key: 0
				Class ChildKey: 0
				...
				Contents
					...
					Column: colsUsuario
						...
						List Values
						Message Actions
					Column: colsSistemaPermissao
						Class Child Ref Key: 0
						Class ChildKey: 0
						Class:
						Property Template:
						Class DLL Name:
						Title: Sistema Permissão
						Visible? Yes
						Editable? No
						Maximum Data Length: Default
						Data Type: String
						...
						List Values
						Message Actions
					Column: colsItemPermissao
						Class Child Ref Key: 0
						Class ChildKey: 0
						Class:
						Property Template:
						Class DLL Name:
						Title: Item Permissão
						Visible? Yes
						Editable? No
						Maximum Data Length: Default
						Data Type: String
						...
						List Values
						Message Actions
					Column: colnValorPermissao
						Class Child Ref Key: 0
						Class ChildKey: 0
						Class:
						Property Template:
						Class DLL Name:
						Title: Valor Permissão
						Visible? Yes
						Editable? No
						Maximum Data Length: Default
						Data Type: Number
				...
				Message Actions
					On SAM_Create
						...
						Set _sComandoPesquisa = 'exec MPS..LogPermissaoS
								@DataInicial =:frmLogLiberacaoSistema.dfdDataIni,
								@DataFinal =:frmLogLiberacaoSistema.dfdDataFim,
								@Login =:frmLogLiberacaoSistema.dfsCod,
								@UsuarioPermissao =:frmLogLiberacaoSistema.dfsUsuario' 
						Set _sIntoPesquisa = 
								':frmLogLiberacaoSistema.tblLogLiberacaoSistema.colsOperador,
								:frmLogLiberacaoSistema.tblLogLiberacaoSistema.coldDataOperacao,
								:frmLogLiberacaoSistema.tblLogLiberacaoSistema.colsDescricaoOperacao,
								:frmLogLiberacaoSistema.tblLogLiberacaoSistema.colsUsuario,
								:frmLogLiberacaoSistema.tblLogLiberacaoSistema.colsSistemaPermissao,
								:frmLogLiberacaoSistema.tblLogLiberacaoSistema.colsItemPermissao,
								:frmLogLiberacaoSistema.tblLogLiberacaoSistema.colnValorPermissao'
								
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
					On UDM_AposPesquisa
						Call SalSendClassMessage(UDM_AposPesquisa, wParam, lParam )
						If nRowCount <=0
							Call SalMessageBox( 'Nenhum registro foi localizado para os parâmetros informados na pesquisa.', 'Atenção', MB_IconExclamation | MB_Ok )
							Return FALSE
						Return TRUE
		...
		Window Variables
			Number: nNumeroLinhas
		Message Actions
			On SAM_Create
				Set _sCriacaoConexao = 'default'
				Call SalSendClassMessage( SAM_Create, wParam, lParam )
				Call SalCenterWindow( frmLogLiberacaoSistema )
