...
0020: 0000000000400100 002C000000020000 0003000000FFFFFF FFFFFFFFFFFCFFFF
...
0080: 6D52656769616F4D 756E69636970696F
.enddata
...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmRegiaoMunicipio
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Região de Município
		Icon File:
		...
		Contents
			...
			Data Field: dfnCodigo
				...
				Message Actions
					On SAM_Create
						! Copie este codigo e cole no SQLWindows
						Set _sTextoStatusBar = 'Código da região'
...
.enddata
.data CLASSPROPS
0000: 5461624368696C64 4E616D6573003A00 7461627353657276 69636F0974616273
0020: 446F63756D656E74 6F09746162735072 6F636564696D656E 746F09746162734F
0040: 6273657276616361 6F00000000
.enddata
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class: cQCK1PushButton
...
.enddata
				...
				Message Actions
					On SAM_Create
						Set _sTipoComando = 'Novo'
						Set _sTextoStatusBar = 'Inclui novo registro'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			Pushbutton: pbLimpar
.data INHERITPROPS
0000: 0100
...
.enddata
		...
		Window Parameters
		Window Variables
			Number: nNivelSuperior
			Number: nNumCodGrupo
		Message Actions
			On SAM_Create
				Set _sTextoStatusBar = 'Tela de cadastro de região de município'
				Set _sNroCamposIgnorados = 'NENHUM'
				!
				Set _sCriacaoConexao = 'Default'
				Set _nEstadoInicialForm = EF_PesquisaHabilitada
				Set _sComandoPesquisa = 'exec RegiaoMunicipioS @Cod = :frmRegiaoMunicipio.dfnCodigo'
				Set _sListaINTOPesquisa = ':frmRegiaoMunicipio.dfnCodigo, :frmRegiaoMunicipio.dfsDescricao'
				Set _sComandoInclusao = 'exec RegiaoMunicipoI @Descricao = :frmRegiaoMunicipio.dfsDescricao'
				Set _sListaINTOInclusao = ':frmRegiaoMunicipio.dfnCodigo'
				Set _bLimpaTelaAposInclusao = FALSE
				Set _sComandoAtualizacao = 'exec RegiaoMunicipioU @Cod = :frmRegiaoMunicipio.dfnCodigo,
							@Descricao = :frmRegiaoMunicipio.dfsDescricao'
				Set _sListaINTOAtualizacao = ''
				Set _bLimpaTelaAposAtualizacao = FALSE
				Set _sComandoRemocao = 'exec RegiaoMunicipioD @Cod = :frmRegiaoMunicipio.dfnCodigo'
				Set _sListaINTORemocao = ''
				Set _bLimpaTelaAposRemocao = TRUE
				Call SalSendClassMessage( SAM_Create, wParam, lParam )
				Call SalCenterWindow( hWndForm )
			! On UDM_AntesAtualizacao
				If frmRegiaoMunicipio.dfnNivel != 1 and SalIsNull(frmRegiaoMunicipio.cmbGrupo)
					Call MsgErro('O grupo superior deve ser informado')
					Return FALSE
				Return TRUE
