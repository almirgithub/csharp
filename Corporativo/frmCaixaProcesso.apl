...
0020: 0000000000A60000 002C000000020000 0003000000FFFFFF FFFFFFFFFFFCFFFF
...
0080: 6D43616978615072 6F636573736F
.enddata
...
.enddata
		...
		Property Template:
		Class DLL Name:
		Title: Inclui a Caixa a um Processo
		Icon File:
		...
		Description: Autor
			! Inclui a Caixa a um Processo. Analista : Gerson Barreto Neto
								      Data : 15.05.2007
		Named Menus
		Menu
		Tool Bar
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						!
						Set _sNomeParaMsgs = 'Código do setor'
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Set _sConsultaDescrição = 'SetorS_desc @CodReduzido = :frmCaixaProcesso.' || _sCamposResponsaveis[0]
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			Data Field: dfnCaixa
.data INHERITPROPS
0000: 0100
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Set _sTextoStatusBar = 'Nome do setor'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			Background Text: Caixa:
				Resource Id: 13764
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class:
...
.enddata
		...
		Message Actions
			On SAM_Create
				! ----------------------------------------Inclusão-------------------------------------
				Set _sComandoInclusao = 'Exec CorrigeCaixaProcessoI
						@Setor		=:frmCaixaProcesso.dfnSetor,
						@Caixa		=:frmCaixaProcesso.dfnCaixa,
						@Processo	=:frmCaixaProcesso.dfnProcesso'
				!
				...
				Set _sTextoStatusBar = 'Inclui a caixa a um processo'
				Call SalSendClassMessage( SAM_Create, wParam, lParam )
