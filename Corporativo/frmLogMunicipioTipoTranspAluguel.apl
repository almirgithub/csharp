...
0020: 0000000000070100 002C000000020000 0003000000FFFFFF FFFFFFFFFFFCFFFF
0040: FFE9FFFFFFFFFFFF FF000000007C0200 004D010000010000 0001000000010000
0060: 000F4170706C6963 6174696F6E497465 6D02000000075769 6E646F7773206672
0080: 6D4C6F674D756E69 636970696F546970 6F5472616E737041 6C756775656C
.enddata
...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmLogMunicipioTipoTranspAluguel
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Consulta de log de configuração por tipo de transporte de aluguel
		Icon File:
		...
		Description: --------------------------------------------------------------------------------------------------------
				Criação: Consulta por Municipio (logs) por tipo de transporte de aluguel.
				Autor-Data: [fhv] Fernando Veras - 02/07/2015
				--------------------------------------------------------------------------------------------------------
		Named Menus
		Menu
		Tool Bar
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Set _sNomeParaMsgs = 'Data Inicial do Período'
						Set _sTextoStatusBar = 'Data Inicial do Período'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
					On SAM_Validate
						If NOT SalIsNull( dfdDataIni )
							If NOT (SalIsValidDateTime( dfdDataIni ))
								Call SalMessageBeep( 0 )
								Call SalMessageBox( 'Data inválida.', 'Atenção', MB_Ok | MB_IconExclamation )
								Call SalClearField( dfdDataIni )
								Return VALIDATE_Cancel
							Else If (SalDateYear( dfdDataIni ) < 1753)
								Call SalMessageBeep( 0 )
								Call SalMessageBox( 'Ano inválido.', 'Atenção', MB_Ok | MB_IconExclamation )
								Call SalClearField( dfdDataIni )
								Return VALIDATE_Cancel
							If dfdDataFim < dfdDataIni AND NOT SalIsNull( dfdDataFim )
								Call SalMessageBeep( 0 )
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Set _bPermiteNulos = FALSE
						Set _bComponenteChave = TRUE
						Set _sNomeParaMsgs = 'Data Final do Período'
						Set _sTextoStatusBar = 'Data Final do Período'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
					On SAM_Validate
						If NOT SalIsNull( dfdDataFim )
							If NOT (SalIsValidDateTime( dfdDataFim ))
								Call SalMessageBeep( 0 )
								Call SalMessageBox( 'Data inválida.', 'Atenção', MB_Ok | MB_IconExclamation )
								Call SalClearField( dfdDataFim )
								Return VALIDATE_Cancel
							Else If SalDateYear( dfdDataFim ) < 1753
								Call SalMessageBeep( 0 )
								Call SalMessageBox( 'Ano inválido.', 'Atenção', MB_Ok | MB_IconExclamation )
								Call SalClearField( dfdDataFim )
								Return VALIDATE_Cancel
							Else If dfdDataFim < dfdDataIni
								Call SalMessageBeep( 0 )
								Call SalMessageBox( 'Data Final do período deve ser maior ou igual à data Inicial.', 'Atenção', MB_Ok | MB_IconExclamation )
								Call SalClearField( dfdDataFim )
								Return VALIDATE_Cancel
						! Call SalSendClassMessage( SAM_Validate, wParam, lParam )
			Child Table: tblLogMunicipioTipoTranspAluguel
				Class Child Ref Key: 0
				Class ChildKey: 0
				...
				Contents
					...
					Column: colsCategoria
						...
						List Values
						Message Actions
					Column: colsComplCategoria
						Class Child Ref Key: 0
						Class ChildKey: 0
						Class:
						Property Template:
						Class DLL Name:
						Title: ComplCategoria
						Visible? Yes
						Editable? No
						Maximum Data Length: Default
						Data Type: String
					...
					Column: colnIdadeMaxima
						...
						List Values
						Message Actions
					Column: colnIdadeMaximaSubst
						Class Child Ref Key: 0
						Class ChildKey: 0
						Class:
						Property Template:
						Class DLL Name:
						Title: IdadeMaximaSubst
						Visible? Yes
						Editable? No
						Maximum Data Length: Default
						Data Type: Number
					...
					Column: colnCapacidMaxPassag
						...
						List Values
						Message Actions
					Column: colsExigeAutorizacao
						Class Child Ref Key: 0
						Class ChildKey: 0
						Class:
						Property Template:
						Class DLL Name:
						Title: ExigeAutorizacao
						Visible? Yes
						Editable? No
						Maximum Data Length: Default
						Data Type: String
				...
				Message Actions
					On SAM_Create
						...
						Set _sComandoPesquisa = 'exec dbvcen..LogMunicipioTipoTranspAluguelS
								@DataInicial =:frmLogMunicipioTipoTranspAluguel.dfdDataIni,
								@DataFinal =:frmLogMunicipioTipoTranspAluguel.dfdDataFim,
								@Municipio =:frmLogMunicipioTipoTranspAluguel.dfnMunicipio,  
								@Categoria =:frmLogMunicipioTipoTranspAluguel.dfnCategoria,
								@ComplCategoria =:frmLogMunicipioTipoTranspAluguel.dfnComplCategoria'
								
						Set _sIntoPesquisa = 
								':frmLogMunicipioTipoTranspAluguel.tblLogMunicipioTipoTranspAluguel.colsUsuario,
								:frmLogMunicipioTipoTranspAluguel.tblLogMunicipioTipoTranspAluguel.coldDataOperacao,
								:frmLogMunicipioTipoTranspAluguel.tblLogMunicipioTipoTranspAluguel.colsDescricaoOperacao,
								:frmLogMunicipioTipoTranspAluguel.tblLogMunicipioTipoTranspAluguel.colsMunicipio,
								:frmLogMunicipioTipoTranspAluguel.tblLogMunicipioTipoTranspAluguel.colsCategoria,
								:frmLogMunicipioTipoTranspAluguel.tblLogMunicipioTipoTranspAluguel.colsComplCategoria,
								:frmLogMunicipioTipoTranspAluguel.tblLogMunicipioTipoTranspAluguel.colsTipo,
								:frmLogMunicipioTipoTranspAluguel.tblLogMunicipioTipoTranspAluguel.colnIdadeMaxima,
								:frmLogMunicipioTipoTranspAluguel.tblLogMunicipioTipoTranspAluguel.colnIdadeMaximaSubst,
								:frmLogMunicipioTipoTranspAluguel.tblLogMunicipioTipoTranspAluguel.colnCapacidMaxPassag,
								:frmLogMunicipioTipoTranspAluguel.tblLogMunicipioTipoTranspAluguel.colsExigeAutorizacao,
								:frmLogMunicipioTipoTranspAluguel.tblLogMunicipioTipoTranspAluguel.colsExigeOficio,
								:frmLogMunicipioTipoTranspAluguel.tblLogMunicipioTipoTranspAluguel.colnCorVeiculo ,
								:frmLogMunicipioTipoTranspAluguel.tblLogMunicipioTipoTranspAluguel.colnRestricao'
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Set _sTabela = 'tblLogMunicipioTipoTranspAluguel'
...
.enddata
				...
				Message Actions
					! On SAM_Create
						Set _sTextoStatusBar = 'Código do tipo de serviço a ser alterado ou incluído'
						Set _sNroCamposIgnorados = 'NENHUM'
						!
						...
						Set _bÉDependenteLimpeza = FALSE
						Set _bNuncaHabilitado = FALSE
						Set _bSempreHabilitado = FALSE
						Set _bVisivel = TRUE
						!
						Set _sNomeParaMsgs = 'Código do Tipo de serviço'
						! Procedure para popular a tabela na consulta de F2
						Set _sConsultaFrmOpcoesCampo = 'Exec TipoServicoS_cod_nome'
						Set _sConsultaFrmOpcoesSQLOuSP = 'SP'
						! Se for setada a próxima variável, então será habilitado a pesquisa aproximada por nome
					...
					On SAM_Create
						...
						Set _bNuncaHabilitado = TRUE
						Set _bVisivel = FALSE
						Set _sNomeParaMsgs = 'Complemento Categoria'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
...
.enddata
			...
			Combo Box: cmbCategoria
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Categoria'
						!
						Set _bVisivel = TRUE
						Set _bPermiteNulos = FALSE
			...
			Combo Box: cmbComplemento
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Complemento Categoria'
						!
						Set _bVisivel = TRUE
						Set _bPermiteNulos = FALSE
						Set _bSempreHabilitado = TRUE
						...
						!
						Set _sRefresh = 'Create'
						Set _sNomeCampoCodigo = 'dfnComplCategoria'
						!
						Set _sConsultaBD = 'exec ComplementoCategoriaS_coddesc @Categoria = :frmLogMunicipioTipoTranspAluguel.dfnCategoria'
						!
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			Data Field: dfnMunicipio
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Código do município do proprietário'
						Set _bPermiteNulos = FALSE
						Set _bVisivel = TRUE
						Set _bSempreHabilitado = TRUE
						Set _sConsultaFrmOpcoesCampo = 'MunicipioS_coddesc @UF = PE'
						Set _sConsultaFrmOpcoesSQLOuSP = 'SP'
						Set _sMsgValidacao = 'Digito Invalido.'
						Set _sConsultaFrmOpcoesColunaOuParam = '@Desc'
						Set _sNomeParaMsgs = 'Código do Município'
						Set _sValorDefault = ''
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
					! On UDM_ValidaCampo
			...
			Data Field: dfsMunicipio
				...
				Message Actions
					On SAM_Create
						...
						! Set _vsCamposResponsaveisLimpeza[0] = 'cmbUF'
						Set _sConsultaDescrição = 'exec MunicipioS_nome @UF = ' || 'PE' || ', @Cod = :frmLogMunicipioTipoTranspAluguel.dfnMunicipio'
		...
		Functions
		Window Parameters
			! Window Handle: hWndJanela
		Window Variables
		Message Actions
			On SAM_Create
				Set _sCriacaoConexao = 'default'
				Call SalSendClassMessage( SAM_Create, wParam, lParam )
				Call SalCenterWindow( frmLogMunicipioTipoTranspAluguel )
