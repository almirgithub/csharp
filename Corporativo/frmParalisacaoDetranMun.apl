...
0020: 00000000002A0100 002C000000020000 0003000000FFFFFF FFFFFFFFFFFCFFFF
...
0080: 6D506172616C6973 6163616F44657472 616E4D756E0D4368 696C642057696E64
00A0: 6F77730D6C624D75 6E69634573746164 6F
.enddata
...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmParalisacaoDetranMun
.data INHERITPROPS
0000: 0100
.enddata
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Municípios Associados a Paralisacao
		Icon File:
...
.enddata
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Associa o município do estado ao setor'
						! Set _nPermissao = EF_RegistroExistente
						Set _sListaOrigem = 'lbMunicEstado'
						Set _sListaDestino = 'lbMunicAssoc'
...
.enddata
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Desassocia o múnicipio ao setor'
						! Set _nPermissao = EF_RegistroExistente
						Set _sListaOrigem = 'lbMunicAssoc'
						Set _sListaDestino = 'lbMunicEstado'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			List Box: lbMunicEstado
.data CLASSPROPSSIZE
0000: 1D00
.enddata
.data CLASSPROPS
...
.enddata
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Lista dos municípios do estado'
						Set _bVisivel = TRUE
						! ! Set _bSempreHabilitado = TRUE
						Set _bPermiteNulos = TRUE
						Set _sNomeParaMsgs = 'Municípios do Estado'
						Set _sTipoMsgNulo = 'PADRAO'
						Set _sNomeCampoFonte = 'dfnlb1'
						Set _sComandoPesquisa = 'exec MunicipioParalisacaoOutrosS @ParalisacaoDetran = :frmParalisacaoDetranMun.nParalisacaoDetran, @UF = :sGlobalUF'
						Set _bPopulaNaCriacao = TRUE
						Set _sCmdTransfEntreListas = 'pbDireita'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
					On SAM_CreateComplete
						Set _sNomeCampoFonte = 'dfnlb1'
						Set _sComandoPesquisa = 'exec MunicipioParalisacaoOutrosS @ParalisacaoDetran = :frmParalisacaoDetranMun.nParalisacaoDetran, @UF = :frmParalisacaoDetranMun.cmbUF'
						Set _bPopulaNaCriacao = TRUE
						Set _sCmdTransfEntreListas = 'pbDireita'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			List Box: lbMunicAssoc
.data CLASSPROPSSIZE
0000: 1D00
.enddata
.data CLASSPROPS
...
.enddata
				...
				Message Actions
					On SAM_Create
						Set _bVisivel = TRUE
						Set _sTextoStatusBar = 'Lista dos municípios associados ao setor'
						Set _sNomeParaMsgs = 'Municípios Associados ao Setor'
						Set _sTipoMsgNulo = 'PADRAO'
						Set _bPermiteNulos = TRUE
						Set _sNomeCampoFonte = 'dfnlb2'
						Set _sComandoPesquisa = 'exec MunicipioParalisacaoS @ParalisacaoDetran = :frmParalisacaoDetranMun.nParalisacaoDetran'
						Set _sComandoInclusao = 'exec MunicipioParalisacaoI @ParalisacaoDetran = :frmParalisacaoDetranMun.nParalisacaoDetran, @Municipio = ^'
						Set _sComandoRemocao = 'exec MunicipioParalisacaoD @ParalisacaoDetran = :frmParalisacaoDetranMun.nParalisacaoDetran, @Municipio = ^'
						Set _bPopulaNaCriacao = TRUE
						Set _sCmdTransfEntreListas = 'pbEsquerda'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
					On SAM_CreateComplete
						Set _sNomeCampoFonte = 'dfnlb2'
						Set _sComandoPesquisa = 'exec MunicipioParalisacaoPesquisaS @ParalisacaoDetran = :frmParalisacaoDetranMun.nParalisacaoDetran, @UF = :frmParalisacaoDetranMun.cmbUF '
						Set _bPopulaNaCriacao = TRUE
						Set _sCmdTransfEntreListas = 'pbEsquerda'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Set _sTipoMsgNulo = 'PADRAO'
						Set _sTextoStatusBar = 'Unidade federativa da nação (estado)'
						Set _sNomeParaMsgs = 'U.F.'
						Set _bPermiteNulos = TRUE
						Set _sMsgNulo = ''
						Set _sConsultaBD = 'exec EstadoS_codcod'
						Set _sNomeCampoCodigo = 'dfsUF'
						Set _bNuncaHabilitado = FALSE
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
					On SAM_Click
						Call SalListClear( lbMunicEstado )
						Call SalListClear( lbMunicAssoc )
						! Call SalWaitCursor( TRUE )
						! Call fMPSConnect( hSqlApp )
						! Call fMPSPrepareProc( hSqlApp, 'Exec MunicipioOutraUF @Setor = :frmParalisacaoDetranMun.sSetor, @UF = :frmParalisacaoDetranMun.cmbUF','
										:frmParalisacaoDetranMun.nSetorPesquisa, :frmParalisacaoDetranMun.sEstadoPesquisa')
						! If SqlExecute( hSqlApp )
							While SqlFetchNext( hSqlApp, nRetorno)
								Call SalListAdd( lbMunicEstado, sEstadoPesquisa )
							Call SalSendMsg( lbMunicAssoc, SAM_Create, 0, 0 )
						! Call SalWaitCursor( FALSE )
						Call SalSendMsg( lbMunicEstado, SAM_CreateComplete, 0, 0 )
						Call SalSendMsg( lbMunicAssoc, SAM_CreateComplete, 0, 0 )
			Background Text: Município de outras UF´s:
				Resource Id: 10554
				Class Child Ref Key: 0
				Class ChildKey: 0
				...
				Text Color: Class Default
				Background Color: Class Default
			Background Text: Municípios do Estado
				Resource Id: 10555
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class: cQCK1BackgroundText
				...
				Text Color: Class Default
				Background Color: Class Default
			Background Text: Municípios Associados a Paralisação
				Resource Id: 10556
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class: cQCK1BackgroundText
		...
		Functions
		Window Parameters
			Number: nParalisacaoDetran
			Receive Window Handle: hWndJanela
			Window Handle: hWndBotao
		Window Variables
			Number: nRetorno
			Number: nSetorPesquisa
			String: sEstadoPesquisa
		Message Actions
			On SAM_Create
				Set _nEstadoInicialForm = EF_RegistroExistente
				Set _sTextoStatusBar = 'Tela de municípios associados ao setor'
			...
			On SAM_CreateComplete
				...
				! If sTipo != 'C'
					Set nPermissao = nPermissao & H_SELECT
