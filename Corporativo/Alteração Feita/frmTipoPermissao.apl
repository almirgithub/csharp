...
0080: 6D5469706F506572 6D697373616F
.enddata
...
.head 1 +  Form Window: frmTipoPermissao
.data INHERITPROPS
0000: 0100
.enddata
...
.head 2 -  Title: Cadastro de Tipo de Permissão
.head 2 -  Icon File:
...
.head 3 +  Data Field: dfnTipoPermissao
.data INHERITPROPS
0000: 0100
.enddata
.head 4 -  Class Child Ref Key: 0
...
.head 6 -  Set _sTextoStatusBar = 'Código da Finalidade'
...
.head 6 -  Set _sTextoStatusBar = 'Descrição do tipo de permissão'
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 -  ! -
...
.head 6 -  Set _sNomeParaMsgs = 'Situacao'
.head 6 -  !
.head 6 -  Set _sValorCHECKED = 'A'
.head 6 -  Set _sValorNOTCHECKED = 'I'
.head 6 -  Set _sNomeCampoFonte = 'dfsSituacao'
.head 6 -  Set _sTextoStatusBar = 'Situação do tipo de permissão'
.head 6 -  !
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 -  ! -
.head 3 -  Group Box: Objetivo
.head 4 -  Resource Id: 56228
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class:
.head 4 -  Window Location and Size
...
.head 4 -  Text Color: Default
.head 4 -  Background Color: Default
.head 3 +  Multiline Field: mlObjetivo
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
...
.head 4 +  Message Actions
.head 5 +  On SAM_Create
.head 6 -  Set _sTextoStatusBar = 'Observação sobre  o documento roubado ou extraviado .'
...
.head 6 +  If hWndUsuarios != hWndNULL
.head 7 -  Call SalSendMsg(hWndUsuarios, SAM_Close, 0, 0)
.head 6 -  Set hWndUsuarios = SalCreateWindow( frmTipoPermissaoUsuario, hWndForm, hWndItem, dfnTipoPermissao, dfsDescricao)
.head 3 +  Pushbutton: pbSetores
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class: cQCK1PushButton
.head 4 -  Property Template:
.head 4 -  Class DLL Name:
.head 4 -  Title: Setores
.head 4 -  Window Location and Size
.head 5 -  Left: 1.588"
.head 5 -  Top: 2.74"
.head 5 -  Width:  1.013"
...
.head 5 +  On SAM_Click
.head 6 -  Call SalSendClassMessage( SAM_Click, wParam, lParam )
.head 6 +  If hWndSetores != hWndNULL
.head 7 -  Call SalSendMsg(hWndSetores, SAM_Close, 0, 0)
.head 6 -  Set hWndSetores = SalCreateWindow( frmTipoPermissaoSetor, hWndForm, hWndItem, dfnTipoPermissao, dfsDescricao)
.head 3 -  !
...
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 -  ! - campos auxiliares (hidden was included)
...
.head 3 -  Long String: lsObjetivo
.head 3 -  Window Handle: hWndUsuarios
.head 3 -  Window Handle: hWndSetores
.head 2 +  Message Actions
.head 3 +  On SAM_Create
.head 4 -  Set _nEstadoInicialForm = EF_PesquisaHabilitada
.head 4 -  ! -
.head 4 -  Set _sComandoPesquisa = 'exec dbvcen..TipoPermissaoS 
			@TipoPermissao 	= :frmTipoPermissao.dfnTipoPermissao,
			@Descricao 	= :frmTipoPermissao.dfsDescricao,
			@Situacao	= :frmTipoPermissao.dfsSituacao'
.head 4 -  Set _sListaINTOPesquisa = '
			:frmTipoPermissao.dfnTipoPermissao, 
			:frmTipoPermissao.dfsDescricao,
			:frmTipoPermissao.mlObjetivo,
			:frmTipoPermissao.dfsSituacao'
.head 4 -  Set _sComandoRemocao = 'exec TipoPermissaoE  
			@TipoPermissao 	= :frmTipoPermissao.dfnTipoPermissao'
...
.head 4 -  ! -
.head 4 -  Set _sTextoStatusBar = 'Tela de Cadastro de tipo de permissão'
.head 4 -  ! -
.head 4 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 4 -  ! -
.head 4 -  Call SalCenterWindow ( hWndForm )
.head 3 +  On UDM_AntesPesquisa
.head 4 -  Call SalStrSetBufferLength( frmTipoPermissao.mlObjetivo, 100000 )
...
.head 4 -  Call SalStrSetBufferLength( frmTipoPermissao.mlObjetivo, 100000 )
.head 4 -  ! Set frmTipoPermissao.mlObjetivo = lsObjetivo
.head 4 -  Call SalSendClassMessage( UDM_AposPesquisa, wParam, lParam )
.head 4 -  Call SalEnableWindow( pbUsuarios )
.head 4 -  Call SalEnableWindow( pbSetores )
.head 3 +  On UDM_AntesInclusao
.head 4 -  Call SalStrSetBufferLength( lsObjetivo, 100000 )
.head 4 -  Set lsObjetivo = frmTipoPermissao.mlObjetivo
.head 4 -  Set _sComandoInclusao = 'exec dbvcen..TipoPermissaoI
			@TipoPermissao 	= :frmTipoPermissao.dfnTipoPermissao,
			@Descricao 	= :frmTipoPermissao.dfsDescricao,
			@Situacao	= :frmTipoPermissao.dfsSituacao,
			@Objetivo 	= "'||lsObjetivo||'"'
...
.head 4 -  Call SalStrSetBufferLength( lsObjetivo, 100000 )
.head 4 -  Set lsObjetivo = frmTipoPermissao.mlObjetivo
.head 4 -  Set _sComandoAtualizacao = 'exec dbvcen..TipoPermissaoA  	
			@TipoPermissao 	= :frmTipoPermissao.dfnTipoPermissao,
			@Descricao 	= :frmTipoPermissao.dfsDescricao,
			@Situacao	= :frmTipoPermissao.dfsSituacao,
			@Objetivo 	= "'||lsObjetivo||'"'
...
.head 3 +  On MSG_Proximo
.head 4 -  Call SalStrSetBufferLength( frmTipoPermissao.mlObjetivo, 100000 )
.head 4 -  ! Set frmTipoPermissao.mlObjetivo = lsObjetivo
.head 4 -  Call SalSendClassMessage( MSG_Proximo, wParam, lParam )
.head 3 +  On MSG_Anterior
.head 4 -  Call SalStrSetBufferLength( frmTipoPermissao.mlObjetivo, 100000 )
.head 4 -  ! Set frmTipoPermissao.mlObjetivo = lsObjetivo
.head 4 -  Call SalSendClassMessage( MSG_Anterior, wParam, lParam )
.head 0 -  
.head 0 -  
