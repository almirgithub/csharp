...
.enddata
		...
		Resources
		Variables
.data RESOURCE 0 0 1 3964456981
0000: 2200000013000000 0000000000000000 0200000100000037 020000D019000000
0020: 01FE00FF03
.enddata
		Internal Functions
		Named Menus
...
.enddata
				...
				Message Actions
					On SAM_Create
						Set _bVisivel = FALSE
						Set _sTextoStatusBar = 'CPF do condutor do veículo'
						Set _sNomeParaMsgs = 'CPF Condutor'
		...
		Window Parameters
			...
			Number: nParCopias
		Window Variables
			! ----- Relatório de Autorização de Confecção de Lacre -----
			Number: nCredenciado
			String: sNome
			String: dDataLiberacao
			Number: nInicioLote
			Number: nFimLote
			String: sUsuario
			Number: nMatricula
		...
		Message Actions
			On SAM_CreateComplete
				Set _sStored = 'exec dbvcen..LoteLacre_Autorizacao 
						@nLojaPlaca = :frmLoteLacreAutoriza.dfnLoja, 
						@nLote = :frmLoteLacreAutoriza.dfnLote'
				Set _sNomeQRP		= 'Aut_Lacre.QRP'
				Set _sTituloRelatório	= 'Autorização para Confecção de Lacres'
				! Set _sPrimeiroRetorno	= 
						':frmLoteLacreForm.nCredenciado'
				! Set _sVarSQLWindows = 
						'frmLoteLacreForm.nCredenciado'
				! Set _sVarQRP = 
						'Credenciado'
				Set _sPrimeiroRetorno	= 
						':frmLoteLacreForm.nCredenciado, 
						:frmLoteLacreForm.sNome,
						:frmLoteLacreForm.dDataLiberacao, 
						:frmLoteLacreForm.nInicioLote, 
						:frmLoteLacreForm.nFimLote,
						:frmLoteLacreForm.sUsuario, 
						:frmLoteLacreForm.nMatricula, 
						:frmLoteLacreForm.sMunicipio,
						:frmLoteLacreForm.nLote,
						:frmLoteLacreForm.sCodAnoFab'
				Set _sVarSQLWindows = 
						'frmLoteLacreForm.nCredenciado, 
						frmLoteLacreForm.sNome,
						frmLoteLacreForm.dDataLiberacao, 
