...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmSetorTipoVistoria
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Setores Associadas ao Tipo de Vistoria
		Icon File:
...
.enddata
				...
				Message Actions
					On SAM_Create
						Set _sListaOrigem = 'lbSetor'
						Set _sListaDestino = 'lbSetorAssoc'
...
.enddata
				...
				Message Actions
					On SAM_Create
						Set _sListaOrigem = 'lbSetorAssoc'
						Set _sListaDestino = 'lbSetor'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			List Box: lbSetor
				Class Child Ref Key: 0
				Class ChildKey: 0
				...
				Message Actions
					On SAM_Create
						...
						! -------------------------------------------------------------------------
						Set _sTextoStatusBar = 'Setores que não estão associados ao tipo de vistoria'
						Set _sComandoPesquisa = 'exec .SetorTipoVistoriaNaoAssocS @nTipoVistoria = :frmTipoVistoria.dfnCodigo'
						Set _bPopulaNaCriacao = TRUE
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			List Box: lbSetorAssoc
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class: bListBox
				Property Template:
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Setores associados ao tipo de vistoria'
						Set _sComandoPesquisa = 'exec SetorTipoVistoriaS @nTipoVistoria = :frmTipoVistoria.dfnCodigo'
						Set _sComandoInclusao = 'exec SetorTipoVistoriaI @nSetor = ^, @nTipoVistoria = :frmTipoVistoria.dfnCodigo'
						Set _sComandoRemocao = 'exec SetorTipoVistoriaE @nSetor = ^, @nTipoVistoria = :frmTipoVistoria.dfnCodigo'
						! Nayche 19/06/03 (Botao para passar todos de uma vez só)
						Set _sNroCamposIgnorados = 'NENHUM'
						!
						Set _bPermiteNulos = TRUE
			...
			Background Text: Tipo de Vistoria:
				...
				Text Color: Class Default
				Background Color: Class Default
			Background Text: Setores Associadas ao Tipo de Vistoria
				Resource Id: 40364
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class: cQCK1BackgroundText
		...
		Message Actions
			On SAM_Create
				Set _sTextoStatusBar = 'Tela de associação de setor a tipo de vistoria'
				Set _sNroCamposIgnorados = 'NENHUM'
				!
			...
			On SAM_CreateComplete
				...
				If frmSetorTipoVistoria.fObtemPermissao('frmSetorTipoVistoria') = 1
					Call SalDisableWindow( pbArquivar )
				Else If frmSetorTipoVistoria.fObtemPermissao('frmSetorTipoVistoria') = 15
