...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmTipoValidacaoAluguel
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Tipo de Validação para Veículos de Aluguel/Escolar
		Icon File:
		...
		Contents
			Data Field: dfnCodigo
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Código do Tipo de Validação'
			...
			Data Field: dfsDescricao
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Descrição do Tipo de Validação'
						Set _sNroCamposIgnorados = 'NENHUM'
						!
...
.enddata
		...
		Message Actions
			On SAM_Create
				...
				Set _sTextoStatusBar = 'Tela de cadastro de Tipos de validação de aluguel/escolar'
				!
				Set _sCriacaoConexao = 'Default'
				Set _sComandoPesquisa = 'exec TipoValidacaoAluguelS @nCod = :frmTipoValidacaoAluguel.dfnCodigo'
				Set _sListaINTOPesquisa = ':frmTipoValidacaoAluguel.dfnCodigo, :frmTipoValidacaoAluguel.dfsDescricao'
				!
				Set _bLimpaTelaAposInclusao = FALSE
				Set _sComandoInclusao = 'exec TipoValidacaoAluguelI @nCod = :frmTipoValidacaoAluguel.dfnCodigo,
						@sDescricao = :frmTipoValidacaoAluguel.dfsDescricao'
				Set _sListaINTOInclusao = ':frmTipoValidacaoAluguel.dfnCodigo'
				!
				Set _bLimpaTelaAposAtualizacao = FALSE
				Set _sComandoAtualizacao = 'exec TipoValidacaoAluguelA @nCod = :frmTipoValidacaoAluguel.dfnCodigo,
						@sDescricao = :frmTipoValidacaoAluguel.dfsDescricao'
				Set _sListaINTOAtualizacao = ''
				!
				Set _bLimpaTelaAposRemocao = TRUE
				Set _sComandoRemocao = 'exec TipoValidacaoAluguelE @nCod = :frmTipoValidacaoAluguel.dfnCodigo'
			...
			On SAM_CreateComplete
				...
				!
				If frmTipoValidacaoAluguel.fObtemPermissao('frmTipoValidacaoAluguel') = 1
					Call SalDisableWindow( pbArquivar )
					Call SalDisableWindow( pbExcluir )
				Else If frmTipoValidacaoAluguel.fObtemPermissao('frmTipoValidacaoAluguel') = 15
