...
0020: 0000000000FB0000 002C000000020000 0003000000A00000 0062020000F8FFFF
0040: FFE2FFFFFFFFFFFF FF000000007C0200 004D010000010000 0000000000010000
0060: 000F4170706C6963 6174696F6E497465 6D04000000075769 6E646F7773186672
0080: 6D5365727669636F 566172696F735573 756172696F730D43 68696C642057696E
00A0: 646F77730A74626C 5365746F726573
.enddata
...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmServicoVariosUsuarios
.data INHERITPROPS
0000: 0100
.enddata
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Acesso de Serviço para Vários Usuários
		Icon File:
		...
		Description: Autor
			! Tela de Acesso de Serviço para vários Usuários. Analista : Gerson Barreto Neto
								    		    Data : 26.09.2006
		Named Menus
		Menu
		Tool Bar
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Set _sNomeParaMsgs = 'Usuário'
						Set _bSempreHabilitado = FALSE
						Set _sTextoStatusBar = 'Login do usuário'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
					On SAM_KillFocus
						If Not SalIsNull( frmServicoVariosUsuarios.dfsUsuarioOrigem )
							If frmServicoVariosUsuarios.fRetornarDados( frmServicoVariosUsuarios.dfsUsuarioOrigem, 
									frmServicoVariosUsuarios.dfsNomeOrigem, frmServicoVariosUsuarios.nCodigoOrigem,
									frmServicoVariosUsuarios.sSetorOrigem )
								Call SalDisableWindow( frmServicoVariosUsuarios.dfsUsuarioOrigem )
			Data Field: dfnServicoOrigem
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class: cQCK1DataField
				Property Template:
				...
				Message Actions
					On SAM_Create
						Set _bVisivel = TRUE
						Set _sTextoStatusBar = 'Código do serviço'
						Set _sNomeParaMsgs = 'Serviço'
						Set _bPermiteNulos = TRUE
						Set _bSempreHabilitado = FALSE
						! Dados para a pesquisa de F2
						Set _sConsultaFrmOpcoesSQLOuSP = 'SP'
						Set _sConsultaFrmOpcoesColunaOuParam = '@Descricao'
						Set _sConsultaFrmOpcoesCampo = 'exec TipoServicoS_coddesc'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			Data Field: dfsServicoOrigem
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class: cQCK1DataField
				Property Template:
				...
				Message Actions
					On SAM_Create
						...
						Set _sCamposResponsaveis[0] = 'dfnServicoOrigem'
						Set _sConsultaDescrição = 'exec TipoServicoS_desc @Cod = :frmServicoVariosUsuarios.dfnServicoOrigem'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			Data Field: dfsUsuarioDestino
.data INHERITPROPS
0000: 0100
.enddata
				Class Child Ref Key: 0
				...
				Message Actions
					On SAM_Create
						...
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
					On SAM_KillFocus
						If Not SalIsNull( frmServicoVariosUsuarios.dfsUsuarioDestino )
							If frmServicoVariosUsuarios.fRetornarDados( frmServicoVariosUsuarios.dfsUsuarioDestino, 
									frmServicoVariosUsuarios.dfsNomeDestino, frmServicoVariosUsuarios.nCodigoDestino,
									frmServicoVariosUsuarios.sSetorDestino )
								Call SalDisableWindow( frmServicoVariosUsuarios.dfsUsuarioDestino )
			Combo Box: cmbTipoUsuario
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class: cQCK1ComboBox
				Property Template:
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Escolha um Tipo de usuário'
						!
						Set _sRefresh = 'Create'
						Set _bPermiteNulos = TRUE
						Set _sNomeParaMsgs = 'Tipo de Usuario'
						Set _sTipoMsgNulo = 'PADRAO'
						!
						Set _bVisivel = TRUE
						!
						Set _sNomeCampoCodigo = 'dfnTipoUsuario'
						Set _sConsultaBD = 'exec TipoUsuarioS'
						!
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			...
			Combo Box: cmbTipoSetor
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Tipo de setor'
						Set _sNomeParaMsgs = 'Tipo de Setor'
						Set _sTipoMsgNulo = 'PADRAO'
						Set _bVisivel = TRUE
						Set _bPermiteNulos = TRUE
						Set _sRefresh = 'Create'
						Set _sNomeCampoCodigo = 'dfsTipoSetor'
						Set _sConsultaBD = 'exec TipoSetorS_coddesc'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			Data Field: dfsServicoDestino
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class: cQCK1DataField
				Property Template:
				...
				Message Actions
					On SAM_Create
						...
						Set _bÉCampoDescrição = TRUE
						Set _bPermiteNulos = TRUE
						Set _sCamposResponsaveis[0] = 'dfnServicoDestino'
						Set _sConsultaDescrição = 'exec TipoServicoS_desc @Cod = :frmServicoVariosUsuarios.dfnServicoDestino'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			Data Field: dfnServicoDestino
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class: cQCK1DataField
				Property Template:
...
.enddata
			...
			Background Text: Serviço :
				...
				Text Color: Default
				Background Color: Default
			Background Text: Tipo de Usuário:
				Resource Id: 64335
				Class Child Ref Key: 0
				Class ChildKey: 0
				Class:
...
.enddata
			...
			Pushbutton: pbNovo
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Habilita a tela para inserção de um novo motivo.'
						Set _sTipoComando = 'Comum'
						Set _nPermissao = EF_Vazio
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
					On SAM_Click
						...
						! Call SalSetFocus( frmServicoVariosUsuarios.dfsUsuarioOrigem )
...
.enddata
			...
			Picture: picSemaforo
				...
				Message Actions
		Functions
			Function: fRetornarDados
				Description: Retorna o setor e nome do login informado.
				Returns
					Boolean:
				Parameters
					String: psUsuario
					Receive String: prsNome
					Receive Number: prnSetor
					Receive String: prsSetor
				Static Variables
				Local variables
					Sql Handle: hSql
				Actions
		...
		Window Parameters
		Window Variables
			Number: nCodigoOrigem
			Number: nCodigoDestino
			String: sSetorOrigem
			String: sSetorDestino
			Number: nID
		Message Actions
			On SAM_Create
				Set _sNomeBD = ''
				...
				! ----------------------------------------Inclusão-------------------------------------
				Set _sComandoInclusao = 'Exec ServicoUsuarioVariosI
						@sUsuarioOrigem  	=:frmServicoVariosUsuarios.dfsUsuarioOrigem,
						@sUsuarioDestino 	=:frmServicoVariosUsuarios.dfsUsuarioDestino,
						@nServicoOrigem  	=:frmServicoVariosUsuarios.dfnServicoOrigem,
						@nServicoDestino 	=:frmServicoVariosUsuarios.dfnServicoDestino,
						@nTipoUsuario = :frmServicoVariosUsuarios.dfnTipoUsuario,
						@sTipoSetor = :frmServicoVariosUsuarios.dfsTipoSetor,
						@ID = :frmServicoVariosUsuarios.nID'
				...
				Set _bCriacaoConexaoAuxiliar = FALSE
				Set _sTextoStatusBar = 'Acesso de Serviço para vários Usuários'
				Call SalSendClassMessage( SAM_Create, wParam, lParam )
