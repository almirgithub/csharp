...
0080: 6D446F6345787465 726E6F5365727669 636F4173736F63
.enddata
...
.head 1 +  Form Window: frmDocExternoServicoAssoc
.data INHERITPROPS
0000: 0100
.enddata
...
.head 2 -  Title: Associação Tipo de Documento Externo com Tipo de Serviço
.head 2 -  Icon File:
...
.head 3 -  ! -
.head 3 -  Background Text: Doc Externo:
.head 4 -  Resource Id: 53909
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class:
.head 4 -  Window Location and Size
...
.head 4 -  Text Color: Default
.head 4 -  Background Color: Default
.head 3 +  Data Field: dfsTipoDocumento
.data INHERITPROPS
0000: 0100
.enddata
.data CLASSPROPS
...
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 -  ! -
.head 3 -  Background Text: Tipo Serviço:
.head 4 -  Resource Id: 53911
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class:
.head 4 -  Window Location and Size
...
.head 4 -  Text Color: Default
.head 4 -  Background Color: Default
.head 3 +  Data Field: dfnTipoServico
.data INHERITPROPS
0000: 0100
.enddata
.data CLASSPROPS
...
.head 4 +  Message Actions
.head 5 +  On SAM_Create
.head 6 -  Set _sTextoStatusBar = 'Código do tipo de serviço a ser alterado ou incluído'
...
.head 6 -  Set _bVisivel = TRUE
.head 6 -  ! -
.head 6 -  Set _sConsultaFrmOpcoesCampo = 'Exec TipoServicoS_cod_nome'
.head 6 -  Set _sConsultaFrmOpcoesSQLOuSP = 'SP'
.head 6 -  Set _sConsultaFrmOpcoesColunaOuParam = '@Descricao'
.head 6 -  Set _nNroColunasAdicionais = 0
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 +  Data Field: dfsTipoServico
.data INHERITPROPS
0000: 0100
.enddata
.data CLASSPROPS
...
.head 4 +  Message Actions
.head 5 +  On SAM_Create
.head 6 -  Set _sTextoStatusBar = 'Descrição do tipo de serviço'
.head 6 -  Set _bVisivel = TRUE
.head 6 -  Set _bPermiteNulos = TRUE
.head 6 -  Set _sCamposResponsaveisLimpeza[0] = 'dfnTipoServico'
.head 6 -  Set _bÉDependenteLimpeza = FALSE
.head 6 -  Set _bÉCampoDescrição = TRUE
.head 6 -  Set _sTipoMsgNulo = 'PADRAO'
.head 6 -  Set _bNuncaHabilitado = TRUE
.head 6 -  Set _sConsultaFrmOpcoesSQLOuSP = 'SP'
.head 6 -  Set _sCamposResponsaveis[0] = 'dfnTipoServico'
.head 6 -  Set _bÉDependente = TRUE
.head 6 -  Set _sConsultaDescrição = 'exec TipoServicoS_desc @Cod = :frmDocExternoServicoAssoc.dfnTipoServico'
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 -  ! -
.head 3 -  Group Box: Configurações
.head 4 -  Resource Id: 53908
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
...
.head 4 -  Text Color: Class Default
.head 4 -  Background Color: Class Default
.head 3 +  Check Box: cbExigeDocExterno
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class: cQCK1CheckBox
.head 4 -  Property Template:
.head 4 -  Class DLL Name:
.head 4 -  Title: Exige Doc Externo 
.head 4 -  Window Location and Size
.head 5 -  Left: 0.688"
.head 5 -  Top: 1.771"
.head 5 -  Width:  1.9"
...
.head 4 +  Message Actions
.head 5 +  On SAM_Create
.head 6 -  Set _sTextoStatusBar = 'Define a situação do tipo de permissão'
.head 6 -  !
.head 6 -  Set _bVisivel = TRUE
.head 6 -  Set _bPermiteNulos = TRUE
...
.head 6 -  !
.head 6 -  Set _sTipoMsgNulo = 'PADRAO'
.head 6 -  Set _sNomeParaMsgs = 'ExigeDocExterno'
.head 6 -  !
.head 6 -  Set _sValorCHECKED = 'S'
.head 6 -  Set _sValorNOTCHECKED = 'N'
.head 6 -  Set _sNomeCampoFonte = 'dfsExigeDocExterno'
.head 6 -  Set _sTextoStatusBar = 'Situação do tipo de permissão'
.head 6 -  !
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 +  Check Box: cbAlertaDocExterno
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class: cQCK1CheckBox
.head 4 -  Property Template:
.head 4 -  Class DLL Name:
.head 4 -  Title: Alertar Existência Doc Externo
.head 4 -  Window Location and Size
.head 5 -  Left: 2.788"
.head 5 -  Top: 1.771"
.head 5 -  Width:  2.8"
...
.head 6 -  !
.head 6 -  Set _sTipoMsgNulo = 'PADRAO'
.head 6 -  Set _sNomeParaMsgs = 'AlertaDocExterno'
.head 6 -  !
.head 6 -  Set _sValorCHECKED = 'S'
.head 6 -  Set _sValorNOTCHECKED = 'N'
.head 6 -  Set _sNomeCampoFonte = 'dfsAlertaDocExterno'
.head 6 -  Set _sTextoStatusBar = 'Situação do tipo de permissão'
.head 6 -  !
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 +  Check Box: cbImprimeDocumento
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class: cQCK1CheckBox
.head 4 -  Property Template:
.head 4 -  Class DLL Name:
.head 4 -  Title: Imprime Documento
.head 4 -  Window Location and Size
.head 5 -  Left: 5.788"
.head 5 -  Top: 1.771"
.head 5 -  Width:  1.9"
...
.head 4 +  Message Actions
.head 5 +  On SAM_Create
.head 6 -  Set _sTextoStatusBar = 'Obriga imprimir o documento ao finalizar o atedimento'
.head 6 -  !
.head 6 -  Set _bVisivel = TRUE
.head 6 -  Set _bPermiteNulos = TRUE
.head 6 -  Set _bNuncaHabilitado = FALSE
.head 6 -  !
.head 6 -  Set _sTipoMsgNulo = 'PADRAO'
.head 6 -  Set _sNomeParaMsgs = 'ImprimeDocumento'
.head 6 -  !
.head 6 -  Set _sValorCHECKED = 'S'
.head 6 -  Set _sValorNOTCHECKED = 'N'
.head 6 -  Set _sNomeCampoFonte = 'dfsImprimeDocumento'
.head 6 -  !
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
.head 3 -  ! -
.head 3 -  Background Text: Data Cadastro:
.head 4 -  Resource Id: 53906
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
...
.head 4 +  Message Actions
.head 5 +  On SAM_Create
.head 6 -  Set _sTextoStatusBar = 'Data de cadastro do tipo de documento'
.head 6 -  !
.head 6 -  Set _bVisivel = TRUE
.head 6 -  Set _bNuncaHabilitado = TRUE
.head 6 -  !
...
.head 5 -  Text Color: Class Default
.head 5 -  Background Color: Class Default
.head 5 -  Input Mask: aaaaaaaa
.head 4 +  Message Actions
.head 5 +  On SAM_Create
.head 6 -  Set _sTextoStatusBar = 'Data de validade do tipo de documento'
.head 6 -  !
.head 6 -  Set _bVisivel = TRUE
.head 6 -  Set _bNuncaHabilitado = TRUE
.head 6 -  !
...
.head 4 +  Message Actions
.head 5 +  On SAM_Create
.head 6 -  Set _sTextoStatusBar = 'Habilita a tela para inserção de um novo tipo de documento'
...
.head 3 +  Data Field: dfsExigeDocExterno
.data INHERITPROPS
0000: 0100
.enddata
.head 4 -  Class Child Ref Key: 0
...
.head 5 -  Input Mask: Class Default
.head 4 -  Message Actions
.head 3 +  Data Field: dfsAlertaDocExterno
.data INHERITPROPS
0000: 0100
.enddata
.head 4 -  Class Child Ref Key: 0
...
.head 5 -  Input Mask: Class Default
.head 4 -  Message Actions
.head 3 +  Data Field: dfsImprimeDocumento
.data INHERITPROPS
0000: 0100
.enddata
.head 4 -  Class Child Ref Key: 0
...
.head 4 -  Message Actions
.head 2 +  Functions
.head 3 +  Function: fPreencheCamposFixos
.head 4 -  Description:
.head 4 -  Returns
.head 4 -  Parameters
...
.head 4 +  Actions
.head 5 -  Set dfsSetor = SalNumberToStrX(pnCodSetor, 0) || " - " ||psNomeSetor
.head 5 -  Set dfsTipoDocumento = SalNumberToStrX(pnCodTipoDocExt, 0) || " - " || psNomeTipoDocExt
.head 2 +  Window Parameters
.head 3 -  Window Handle: phWndBotao
.head 3 -  Number: pnCodSetor
.head 3 -  String: psNomeSetor
.head 3 -  Number: pnCodTipoDocExt
.head 3 -  String: psNomeTipoDocExt
.head 2 -  Window Variables
.head 2 +  Message Actions
.head 3 +  On SAM_Create
.head 4 -  Set _nEstadoInicialForm = EF_PesquisaHabilitada
.head 4 -  ! -
.head 4 -  Set _sComandoPesquisa = 'exec dbvcen..TipoServicoTipoDocExternoS
			@Setor 		= :frmDocExternoServicoAssoc.pnCodSetor,
			@TipoDocExterno     	= :frmDocExternoServicoAssoc.pnCodTipoDocExt,
			@TipoServico 	= :frmDocExternoServicoAssoc.dfnTipoServico'
.head 4 -  Set _sListaINTOPesquisa = '	:frmDocExternoServicoAssoc.dfnTipoServico,
			:frmDocExternoServicoAssoc.dfsTipoServico, 
			:frmDocExternoServicoAssoc.dfsAlertaDocExterno,
			:frmDocExternoServicoAssoc.dfsExigeDocExterno,
			:frmDocExternoServicoAssoc.dfsImprimeDocumento,
			:frmDocExternoServicoAssoc.dfdCadastro,
			:frmDocExternoServicoAssoc.dfsUsuarioCadastro'
.head 4 -  !
.head 4 -  Set _sComandoInclusao = 'exec dbvcen..TipoServicoTipoDocExternoI
			@Setor 			= :frmDocExternoServicoAssoc.pnCodSetor,
			@TipoDocExterno     		= :frmDocExternoServicoAssoc.pnCodTipoDocExt,
			@TipoServico    		= :frmDocExternoServicoAssoc.dfnTipoServico,
			@iExibeAlertaSeExistir 	= :frmDocExternoServicoAssoc.dfsAlertaDocExterno,
			@iExigeDocumento  		= :frmDocExternoServicoAssoc.dfsExigeDocExterno,
			@iImprimeDocumento	= :frmDocExternoServicoAssoc.dfsImprimeDocumento'
.head 4 -  Set _sListaINTOInclusao = '	:frmDocExternoServicoAssoc.dfdCadastro, :frmDocExternoServicoAssoc.dfsUsuarioCadastro'
.head 4 -  !
.head 4 -  Set _sComandoAtualizacao = 'exec dbvcen..TipoServicoTipoDocExternoA
			@Setor 			= :frmDocExternoServicoAssoc.pnCodSetor,
			@TipoDocExterno     		= :frmDocExternoServicoAssoc.pnCodTipoDocExt,
			@TipoServico    		= :frmDocExternoServicoAssoc.dfnTipoServico,
			@iExibeAlertaSeExistir 	= :frmDocExternoServicoAssoc.dfsAlertaDocExterno,
			@iExigeDocumento  		= :frmDocExternoServicoAssoc.dfsExigeDocExterno,
			@iImprimeDocumento	= :frmDocExternoServicoAssoc.dfsImprimeDocumento'
.head 4 -  Set _sComandoRemocao = 'exec TipoServicoTipoDocExternoE
			@Setor 		= :frmDocExternoServicoAssoc.pnCodSetor,
			@TipoDocExterno     	= :frmDocExternoServicoAssoc.pnCodTipoDocExt,
			@TipoServico 	= :frmDocExternoServicoAssoc.dfnTipoServico'
...
.head 4 -  ! - 
.head 4 -  Set _sTextoStatusBar = "Cadastro de Tipo de Documento Externo (Setor: " || SalNumberToStrX(pnCodSetor,0) || " - " || psNomeSetor || ")"
.head 4 -  ! -
.head 4 +  If phWndBotao != hWndNULL
.head 5 -  Call SalDisableWindow( phWndBotao )
.head 4 -  !
.head 4 -  Call fPreencheCamposFixos()
.head 4 -  ! -
.head 4 -  Call SalPostMsg(hWndForm, MSG_Pesquisa, 0, 0)
.head 3 +  On SAM_Destroy
.head 4 -  Call SalSendClassMessage( SAM_Destroy, wParam, lParam )
.head 4 +  If phWndBotao != hWndNULL
.head 5 -  Call SalEnableWindow( phWndBotao )
.head 3 -  !
.head 3 +  On MSG_Limpa
.head 4 -  Call SalSendClassMessage( MSG_Limpa, wParam, lParam )
.head 4 -  Call fPreencheCamposFixos()
.head 3 +  On MSG_Novo
.head 4 -  Call SalSendClassMessage( MSG_Novo, wParam, lParam )
.head 4 -  Call fPreencheCamposFixos()
.head 0 -  
.head 0 -  
  