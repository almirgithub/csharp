...
0020: 0000000000A90000 002C000000020000 0003000000FFFFFF FFFFFFFFFFFCFFFF
...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmLoteLacreEntrega
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Entrega Lote de Lacre
		Icon File:
...
.enddata
				...
				Message Actions
					On SAM_Create
						!
						Set _sTextoStatusBar = 'Código da Loja'
						Set _sNomeParaMsgs = 'Código da Loja'
						!
						Set _bVisivel = TRUE
						...
						!
						Set _sMsgValidacao = 'Loja incorreta'
						Set _sTipoMsgValidacao = 'ESPECIFICA'
						!
						Set _sConsultaFrmOpcoesSQLOuSP = 'SP'
						Set _sConsultaFrmOpcoesCampo = 'exec EstabelecimentoCredS_Loja'
						!
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
						!
			Data Field: dfsLoja
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Set _sCamposResponsaveis[0] = 'dfnLoja'
						Set _sConsultaDescrição = 'exec EstabelecimentoCredS_LojaDesc @nCredenciado = :frmLoteLacreEntrega.dfnLoja'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			Data Field: dfnLote
.data INHERITPROPS
0000: 0100
...
.enddata
				...
				Message Actions
					On SAM_Create
						!
						Set _sTextoStatusBar = 'Código do Lote'
						Set _sNomeParaMsgs = 'Código da Lote'
						!
						Set _bVisivel = TRUE
						Set _bPermiteNulos = FALSE
...
.enddata
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Data de Liberação'
						Set _sNomeParaMsgs = 'Data'
						Set _bVisivel = TRUE
						!
...
.enddata
				...
				Message Actions
					On SAM_Create
						Set _sTextoStatusBar = 'Número do RENAVAM do veículo apreendido'
						...
						Set _sMsgValidacao = 'Veículo inexistente!'
						Set _sTipoMsgValidacao = 'ESPECIFICA'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
			Data Field: dfnFim
.data CLASSPROPSSIZE
...
.enddata
				...
				Message Actions
					On SAM_Create
						!
						Set _sTextoStatusBar = 'Código do Fornecedor'
						Set _sNomeParaMsgs = 'Código do Fornecedor'
						!
						Set _bNuncaHabilitado = FALSE
						...
						Set _bCompChaveOpcionalParaPesquisa = TRUE
						!
						Set _sMsgValidacao = 'Fornecedor incorreto'
						Set _sTipoMsgValidacao = 'ESPECIFICA'
						!
						Set _sConsultaFrmOpcoesSQLOuSP = 'SP'
						Set _sConsultaFrmOpcoesCampo = 'exec EstabelecimentoCredS_Fornec'
						!
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
						!
			Data Field: dfsFornecedor
.data INHERITPROPS
0000: 0100
.enddata
.data CLASSPROPS
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Set _bÉDependente = TRUE
						Set _bPermiteNulos = TRUE
						Set _sCamposResponsaveis[0] = 'dfnFornecedor'
						Set _sConsultaDescrição = 'exec EstabelecimentoCredS_FornDesc @nCredenciado = :frmLoteLacreEntrega.dfnFornecedor'
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
...
.end
				Message Actions 
					On SAM_Create
						Set _sTextoStatusBar = 'Código do Motivo de Cancelamento de Lacre'
						Set _sNomeParaMsgs = 'Código'
						Set _sNroCamposIgnorados = 'NENHUM'
						!
						Set _bCompChaveOpcionalParaPesquisa = TRUE
						Set _bComponenteChave = TRUE
...
.end
				Message Actions 
					On SAM_Create
						Set _sTextoStatusBar = 'Descrição do Motivo de Cancelamento de Lacre'
						Set _sNroCamposIgnorados = 'NENHUM'
						!
						Set _bNuncaHabilitado = FALSE
						Set _bPermiteNulos = FALSE
...
.end
		...
		Message Actions
			On SAM_Create
				...
				Set _sTextoStatusBar = 'Tela de cadastro de Motivos de Cancelamento de Lacre'
				!
				Set _sCriacaoConexao = 'Default'
				Set _sComandoPesquisa = 'exec LoteLacreS @nLojaPlaca = :frmLoteLacreEntrega.dfnLoja,
						@nLote = :frmLoteLacreEntrega.dfnLote'
				Set _sListaINTOPesquisa = ':frmLoteLacreEntrega.dfnLoja, :frmLoteLacreEntrega.dfnLote, 
						:frmLoteLacreEntrega.dfsLoja, :frmLoteLacreEntrega.dfdDataLiberacao, 
						:frmLoteLacreEntrega.dfsUsuario, :frmLoteLacreEntrega.dfnInicio, :frmLoteLacreEntrega.dfnFim,
						:frmLoteLacreEntrega.dfnFornecedor, :frmLoteLacreEntrega.dfsFornecedor, 
						:frmLoteLacreEntrega.dfdDataEntrega, :frmLoteLacreEntrega.dfsUsuarioEntrega'
				! Set _sComandoPesquisa = 'exec MotivoCancelamentoLacreS @nCod = :frmLoteLacreEntrega.dfnCodigo'
				! Set _sListaINTOPesquisa = ':frmLoteLacreEntrega.dfnCodigo, :frmLoteLacreEntrega.dfsDescricao'
				!
				! Set _bLimpaTelaAposInclusao = FALSE
				! Set _sComandoInclusao = 'exec MotivoCancelamentoLacreI @nCod = :frmLoteLacreEntrega.dfnCodigo,
						@sDescricao = :frmLoteLacreEntrega.dfsDescricao'
				! Set _sListaINTOInclusao = ':frmLoteLacreEntrega.dfnCodigo'
				!
				Set _bLimpaTelaAposAtualizacao = FALSE
				Set _sComandoAtualizacao = 'exec dbvcen..LoteLacre_Entrega  @nLojaPlaca = :frmLoteLacreEntrega.dfnLoja,
						@nLote = :frmLoteLacreEntrega.dfnLote, @nFornecedorLacre = :frmLoteLacreEntrega.dfnFornecedor'
				Set _sListaINTOAtualizacao = ':frmLoteLacreEntrega.dfdDataEntrega, :frmLoteLacreEntrega.dfsUsuarioEntrega'
				!
				! Set _bLimpaTelaAposRemocao = TRUE
				! Set _sComandoRemocao = 'exec MotivoCancelamentoLacreE @nCod = :frmLoteLacreEntrega.dfnCodigo'
			...
			On SAM_CreateComplete
				...
				!
				If frmLoteLacreEntrega.fObtemPermissao('frmLoteLacreEntrega') = 1
					Call SalDisableWindow( pbArquivar )
					! Call SalDisableWindow( pbExcluir )
				Else If frmLoteLacreEntrega.fObtemPermissao('frmLoteLacreEntrega') = 15
					Call SalEnableWindow( pbArquivar )
					! Call SalEnableWindow( pbExcluir )
			On UDM_AposPesquisa
				Call SalSendClassMessage( UDM_AposPesquisa, wParam, lParam )
				If frmLoteLacreEntrega.dfnFornecedor != NUMBER_Null
					Call SalDisableWindow( dfnFornecedor )
				Else
					Call SalEnableWindow( dfnFornecedor )
			On MSG_Anterior
			...
			On UDM_AposAtualizacao
				Call SalSendClassMessage( UDM_AposAtualizacao, wParam, lParam )
				If frmLoteLacreEntrega.dfnFornecedor != NUMBER_Null
					Call SalDisableWindow( dfnFornecedor )
				Else
					Call SalEnableWindow( dfnFornecedor )
