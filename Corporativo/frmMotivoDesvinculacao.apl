Application Description: **************************************************************************************
		...
		Djalma Júnior - 06/05/2013 - Acrescentado Variaveis que recebe dados vindos da tela pai (nCodMunicipio,nCodDetran) e nova variavel para as procedures
		AutorizacaoCondutorA,RpcAutorizacaoCondutorI,AutorizacaoCondutorE e RpcAutorizacaoCondutorS para identificar se os dados procedem da tela do atendimento ou não.
		*************************************************************************************
	Outline Version - 4.0.28
	Design-time Settings
.data VIEWINFO
0000: 6F00000001000000 FFFF01000D004347 5458566965775374 6174650400010000
0020: 0000000000F40000 002C000000020000 0003000000FFFFFF FFFFFFFFFFF8FFFF
...
0080: 6D4D6F7469766F44 657376696E63756C 6163616F
.enddata
...
.enddata
		Default Classes
			...
			ActiveX:
		Application Actions
	Form Window: frmMotivoDesvinculacao
.data INHERITPROPS
0000: 0100
.enddata
		Class: cQCK1Form
		Property Template:
		Class DLL Name:
		Title: Cadastro Motivo de Desvinculação
		Icon File:
		...
		Contents
			...
			! -
			Child Table: tblMotivoDesvinculacao
.data INHERITPROPS
0000: 0100
.enddata
.data CLASSPROPS
					...
					Column: colnCodigo
						...
						Message Actions
							On SAM_Create
								...
								Set _sTextoStatusBar = 'Códigodo Motivo da Desvinculação'
					...
					Column: colsDescricao
						...
						Message Actions
							On SAM_Create
								...
								Set _sTextoStatusBar = 'Descrição'
								Call SalSendClassMessage( SAM_Create, wParam, lParam )
					Column: colsiExigeProtocolo
						Class Child Ref Key: 0
						Class ChildKey: 0
						Class: cQCK1Column
						Property Template:
						Class DLL Name:
						Title: Exige Protocolo
						Visible? Class Default
						Editable? Class Default
						Maximum Data Length: Class Default
						Data Type: String
						...
						Message Actions
							On SAM_Create
								...
								Set _bPermiteNulos = TRUE
								Set _bSempreHabilitado = TRUE
								Set _sTextoStatusBar = 'Exige protocolo'
								Call SalSendClassMessage( SAM_Create, wParam, lParam )
					Column: colsiLeilao
						Class Child Ref Key: 0
						Class ChildKey: 0
						...
						Message Actions
							On SAM_Create
								...
								Set _bPermiteNulos = TRUE
								Set _bSempreHabilitado = TRUE
								Set _sTextoStatusBar = 'Leilão'
								Call SalSendClassMessage( SAM_Create, wParam, lParam )
				Functions
				Window Variables
					Sql Handle: hSqlCondutor
				Message Actions
					On SAM_Create
						...
						! - -
						Set _sComandoPesquisa = 'exec dbvcen..MotivoDesvinculacaoS
											@nCodigo 	= :frmMotivoDesvinculacao.tblMotivoDesvinculacao.colnCodigo'
						Set _sIntoPesquisa = '	:frmMotivoDesvinculacao.tblMotivoDesvinculacao.colnCodigo,
											:frmMotivoDesvinculacao.tblMotivoDesvinculacao.colsDescricao,
											:frmMotivoDesvinculacao.tblMotivoDesvinculacao.colsiExigeProtocolo,
											:frmMotivoDesvinculacao.tblMotivoDesvinculacao.colsiLeilao'
						! - - 
						Set _sComandoInsere = 'exec dbvcen..MotivoDesvinculacaoI
											@sDescricao 	= :frmMotivoDesvinculacao.tblMotivoDesvinculacao.colsDescricao,
											@iExigeProtocolo 	= :frmMotivoDesvinculacao.tblMotivoDesvinculacao.colsiExigeProtocolo,
											@iLeilao 		= :frmMotivoDesvinculacao.tblMotivoDesvinculacao.colsiLeilao'
						Set _sIntoInsere = ''
						! - -
						Set _sComandoAtualiza = 'exec dbvcen..MotivoDesvinculacaoA
											@nCodigo 	= :frmMotivoDesvinculacao.tblMotivoDesvinculacao.colnCodigo,
											@sDescricao	= :frmMotivoDesvinculacao.tblMotivoDesvinculacao.colsDescricao,
											@iExigeProtocolo 	= :frmMotivoDesvinculacao.tblMotivoDesvinculacao.colsiExigeProtocolo,
											@iLeilao 		= :frmMotivoDesvinculacao.tblMotivoDesvinculacao.colsiLeilao'
						Set _sIntoAtualiza = ''
						Set _sComandoExclui = 'exec MotivoDesvinculacaoE 
											@nCodigo 	= :frmMotivoDesvinculacao.tblMotivoDesvinculacao.colnCodigo'
						Set _sIntoExclui = ''
						! - -
						Set _sTextoStatusBar = 'Tabela de Motivos de Desvinculação'
						! - - 
						Call SalSendClassMessage( SAM_Create, wParam, lParam )
					On MSG_NovaLinha
					...
					On MSG_Limpa
						...
						Call SalPostMsg( tblMotivoDesvinculacao, MSG_PesquisaTabela, 0, 0 )
					On UDM_AposInclusao
						Call SalPostMsg( tblMotivoDesvinculacao, MSG_PesquisaTabela, 0, 0 )
						Return TRUE
			! - 
...
.enddata
				...
				Message Actions
					On SAM_Create
						...
						Set _sTabela = 'tblMotivoDesvinculacao'
...
.enddata
		...
		Message Actions
			On SAM_Create
				...
				Set _sTextoStatusBar = 'Motivo de Desvinculação'
				Call SalSendClassMessage( SAM_Create, wParam, lParam )
				! - 
