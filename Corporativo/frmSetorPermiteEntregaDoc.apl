...
0080: 6D5365746F725065 726D697465456E74 72656761446F63
.enddata
...
.head 2 -  ! File Include: frmMunicipio.apl
...
.head 1 +  Form Window: frmSetorPermiteEntregaDoc
.data INHERITPROPS
0000: 0100
.enddata
...
.head 2 -  Title: Cadastro de Associação de Setores permitidos a entregar documentos de outro Setor
.head 2 -  Icon File:
...
.head 3 -  !
.head 3 +  Data Field: dfsNomeSetor
.data INHERITPROPS
0000: 0100
.enddata
.data CLASSPROPSSIZE
...
.head 6 -  Call SalColorSet( hWndItem, COLOR_IndexWindow,  SalColorFromRGB( 240, 240, 240) )
.head 3 -  !
.head 3 +  List Box: lbSetor
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
...
.head 6 -  ! -------------------------------------------------------------------------
.head 6 -  Set _sTextoStatusBar = 'Setores que não estão associados ao município'
.head 6 -  Set _sComandoPesquisa = 'exec SetorPermiteEntregDocNaoAssocS @SetorEmissao = :frmSetorPermiteEntregaDoc.nSetorEmissao'
...
.head 4 +  Message Actions
.head 5 +  On SAM_Create
.head 6 -  Set _sListaOrigem = 'lbSetor'
.head 6 -  Set _sListaDestino = 'lbSetorAssoc'
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
...
.head 4 +  Message Actions
.head 5 +  On SAM_Create
.head 6 -  Set _sListaOrigem = 'lbSetorAssoc'
.head 6 -  Set _sListaDestino = 'lbSetor'
.head 6 -  Call SalSendClassMessage( SAM_Create, wParam, lParam )
...
.head 4 +  Message Actions
.head 5 +  On SAM_Create
.head 6 -  Set _sTextoStatusBar = 'Setores associados ao município'
.head 6 -  Set _sComandoPesquisa = 'exec SetorPermiteEntregaDocS @SetorEmissao = :frmSetorPermiteEntregaDoc.nSetorEmissao'
.head 6 -  Set _sComandoInclusao = 'exec SetorPermiteEntregaDocI @SetorEmissao = :frmSetorPermiteEntregaDoc.nSetorEmissao, @SetorEntrega = ^'
.head 6 -  Set _sComandoRemocao = 'exec SetorPermiteEntregaDocE @SetorEmissao = :frmSetorPermiteEntregaDoc.nSetorEmissao, @SetorEntrega = ^'
.head 6 -  !
.head 6 -  Set _sNroCamposIgnorados = 'NENHUM'
.head 6 -  !
.head 6 -  Set _bPermiteNulos = TRUE
...
.head 4 -  Message Actions
.head 3 -  ! - Backgrounds
.head 3 -  Background Text: Setores não associados
.head 4 -  Resource Id: 9645
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
...
.head 4 -  Text Color: Class Default
.head 4 -  Background Color: Class Default
.head 3 -  Background Text: Setores Associadas Setor
.head 4 -  Resource Id: 9646
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class: cQCK1BackgroundText
.head 4 -  Window Location and Size
...
.head 4 -  Text Color: Class Default
.head 4 -  Background Color: Class Default
.head 3 -  Background Text: Setor Emissão:
.data CLASSPROPSSIZE
0000: 1B00
.enddata
.data CLASSPROPS
...
.head 3 -  Number: nSetorEmissao
.head 3 -  String: sSetorEmissao
.head 2 -  Window Variables
.head 2 +  Message Actions
.head 3 +  On SAM_Create
.head 4 -  Set _sTextoStatusBar = 'Cadastro de Associação de Setores permitidos a entregar documentos de outro Setor'
...
.head 4 -  Set dfsNomeSetor = SalNumberToStrX(nSetorEmissao, 0) || ' - ' || sSetorEmissao
.head 4 +  If frmSetorPermiteEntregaDoc.fObtemPermissao('frmSetorPermiteEntregaDoc') = 1
.head 5 -  Call SalDisableWindow( pbArquivar )
.head 4 +  Else If frmSetorPermiteEntregaDoc.fObtemPermissao('frmSetorPermiteEntregaDoc') = 15
.head 5 -  Call SalEnableWindow( pbArquivar )
.head 3 +  On SAM_Destroy
.head 4 -  Call SalSendMsg( hWndBotao, MSG_Habilita1, 0, lParam )
.head 4 -  Set hWndBotao = hWndNULL
.head 4 -  !
